...
```
cd existing_repo
git remote add origin https://gitlab.signetcenter.systems/signetpro/be/ops/sigpro-doctor-manager-web.git
git branch -M main
...
- [ ] [Set up project integrations](https://gitlab.signetcenter.systems/signetpro/be/ops/sigpro-doctor-manager-web/-/settings/integrations)
