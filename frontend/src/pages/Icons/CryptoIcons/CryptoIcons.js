...
const CryptoIcons = () => {
    document.title = "Crypto Icons | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                        ...
                        <Col lg={12}>
                            <Card>
                                <CardHeader>
                                    ...
                                    <p className="text-muted mb-0">Use <code>&lt;img src="
                                        assets/images/svg/crypto-icons/**.svg"&gt;</code> class.</p>
                                </CardHeader>
                                <CardBody>
