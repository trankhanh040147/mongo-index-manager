...
const IconBoxicons = () => {
    document.title = "Box Icons | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                        ...
                        <Col className="col-12">
                            <Card>
                                <CardHeader>
                                    ...
                                    <p className="text-muted mb-0">Use <code>&lt;i className="bx
                                        bx-**"{'>'}&lt;/i{'>'}</code> class.</p>
                                </CardHeader>
                                <CardBody>
                                    ...
                                    <p className="text-muted mb-0">Use class <code>&lt;i className="bx
                                        bxs-**"{'>'}&lt;/i{'>'}</code></p>
