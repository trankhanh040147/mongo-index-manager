                            ...
                            <CardBody>
                                ...
                                <div className="d-flex align-items-end justify-content-between mt-4">
                                    ...
                                    <div className="avatar-sm flex-shrink-0">
                                        <span className={"avatar-title rounded fs-3 bg-" + item.iconClass + "-subtle"}>
                        ...
                        <CardBody>
                            <div className="d-flex justify-content-between">
                                ...
                                <div>
                                    <div className="avatar-sm flex-shrink-0">
                                        <span
                                            className={"avatar-title rounded-circle fs-2 bg-" + item.iconClass + "-subtle"}>
                                            <FeatherIcon
                                                icon={item.feaIcon}
                    ...
                    <Card className={"card-height-100 " + item.bgColor}>
                        <CardBody>
                            <div className="d-flex align-items-center">
                                <div className="avatar-sm flex-shrink-0">
                                    <span
                                        className={"avatar-title rounded-2 fs-2 bg-" + item.iconClass + "-subtle text-" + item.iconClass}>
