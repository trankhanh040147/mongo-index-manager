...
const UiCards = () => {
    document.title = "Cards | DRManager - React Admin & Dashboard Template";
                ...
                <Container fluid>
                    ...
                    <Row>
                        <Col sm={6} xl={3}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="card-text">At missed advice my it no sister. Miss told ham dull knew
                                        see she spot near can. Spirit her entire her called.</p>
                        ...
                        <Col sm={6} xl={3}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="card-text mb-0">Whether article spirits new her covered hastily
                                        sitting her. Money witty books nor son add. Chicken age had evening believe but
                                        proceed pretend mrs.</p>
                                </CardBody>
                                <div className="card-footer">
                                    <Link to="#" className="card-link link-secondary">Read More <i
                                        className="ri-arrow-right-s-line ms-1 align-middle lh-1"></i></Link>
                                    <Link to="#" className="card-link link-success">Bookmark <i
                                        className="ri-bookmark-line align-middle ms-1 lh-1"></i></Link>
                                </div>
                            </Card>
                        </Col>
                        <Col sm={6} xl={3}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="card-text">We quickly learn to fear and thus automatically avoid
                        ...
                        <Col sm={6} xl={3}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="card-text">Objectively pursue diverse catalysts for change for
                            ...
                            <Row>
                                <Col lg={6} xxl={4}>
                                    <Card className="card-body">
                                        ...
                                        <p className="card-text text-muted">Send a link to apply on mobile device.
                                            Appropriately communicate one-to-one technology.</p>
                                ...
                                <Col lg={6} xxl={4}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            ...
                                            <p className="card-text text-muted mb-0">A business consulting agency is
                                                involved in the planning, implementation, and education of businesses.
                                                Miss told ham dull knew see she spot near can. Spirit her entire her
                                                called.</p>
                                        </CardBody>
                                        <div className="card-footer">
                                            <Link to="#" className="link-success float-end">Read More <i
                                                className="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></Link>
                                ...
                                <Col lg={6} xxl={4}>
                                    <Card>
                                        <CardHeader>
                                            <button type="button" className="btn-close float-end fs-11"
                                                    aria-label="Close"></button>
                                            <h6 className="card-title mb-0">Invoice<span
                                                className="text-secondary">#45155468</span></h6>
                                        </CardHeader>
                                        <CardBody>
                                            <h6 className="card-title">What planning process needs ?</h6>
                                            <p className="card-text text-muted mb-0">Intrinsically incubate intuitive
                                                opportunities and real-time potentialities for change for interoperable
                                                meta-services itself or distract the viewer's attention from the
                                                layout.</p>
                                        </CardBody>
                                        <div className="card-footer">
                                            <Link to="#" className="link-success float-end">Payment Now <i
                                                className="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></Link>
                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            <blockquote className="card-blockquote mb-0">
                                                <p className="text-muted mb-2">There are many variations of passages of
                                                    Lorem Ipsum available.</p>
                                                <figure className="mb-0">
                                                    <blockquote className="blockquote">
                                                        <p className="lead">"A business consulting agency is involved in
                                                    ...
                                                    <figcaption className="blockquote-footer fs-13 text-end mb-0">
                                                        Creative Agency<cite title="Source Title"
                                                                             className="text-primary fw-semibold"> Alice
                                                        Mellor</cite>
                                                    </figcaption>
                                                </figure>
                                            </blockquote>
                    ...
                    <Row>
                        <Col xl={4}>
                            <Card>
                                <CardBody>
                                    <h4 className="card-title mb-3"><i
                                        className="ri-user-3-fill align-middle me-1 text-muted"></i> Natasha Carey</h4>
                                    <p className="text-muted">Too much or too little spacing, as in the example below,
                                        can make things unpleasant for the reader. The goal is to make your text as
                                        comfortable to read as possible.</p>
                                    <p className="text-muted mb-0">This response is important for our ability to learn
                                        from mistakes, but it alsogives rise to self-criticism.</p>
                                </CardBody>
                                <div className="card-footer text-center">
                                    <Link to="#" className="link-secondary">View All Notification (2) <i
                                        className="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></Link>
                                </div>
                            </Card>
                        </Col>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        create a <Link to="#" className="text-decoration-underline"><b>Fantastic
                                        Design</b></Link> by using complicated 3D elements. Flat design is your friend.
                                        Remember that. And the great thing about flat design is that it has become more
                                        and more popular over the years.
                                    </p>
                                    <p className="text-muted mb-0">In some designs, you might adjust your tracking to
                                        create a certain artistic effect.</p>
                                </CardBody>
                            </Card>
                        </Col>
                        <Col xl={4}>
                            <Card>
                                <CardHeader>
                                    <h6 className="card-title mb-0"><i
                                        className="ri-gift-line align-middle me-1 lh-1"></i> You've made it!</h6>
                                </CardHeader>
                                <CardBody>
                                    <p className="text-muted">After gathering lots of different opinions and graphic
                                        design basics, I came up with a list of 30 graphic design tips that you can
                                        start implementing. Each design is a new, unique piece of art birthed into this
                                        world.</p>
                                    <p className="text-muted mb-0">Art party locavore wolf cliche high life echo park
                                        Austin.</p>
                                </CardBody>
                                <div className="card-footer">
                                    <div className="hstack gap-2 justify-content-end">
                                        <Link to="#" className="btn btn-link btn-sm link-success"><i
                                            className="ri-close-line align-middle lh-1"></i> Close</Link>
                                ...
                                <div className="card-footer text-center">
                                    <ul className="list-inline mb-0">
                                        <li className="list-inline-item">
                                            <Link to="#" className="lh-1 align-middle link-secondary"><i
                                                className="ri-facebook-fill"></i></Link>
                                        </li>
                                        <li className="list-inline-item">
                                            <Link to="#" className="lh-1 align-middle link-success"><i
                                                className="ri-whatsapp-line"></i></Link>
                                        </li>
                                        <li className="list-inline-item">
                                            <Link to="#" className="lh-1 align-middle link-primary"><i
                                                className="ri-linkedin-fill"></i></Link>
                                        </li>
                                        <li className="list-inline-item">
                                            <Link to="#" className="lh-1 align-middle link-danger"><i
                                                className="ri-slack-fill"></i></Link>
                                        </li>
                                    </ul>
                                </div>
                            </Card>
                                ...
                                <CardHeader>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                                <li className="list-inline-item">
                                                    <Link to="#" className="align-middle" role="button"
                                                          onClick={() => spinner('spinner1')}>
                                                        <i className="mdi mdi-refresh align-middle"></i>
                                                    </Link>
                                                </li>
                                                <li className="list-inline-item">
                                                    <Link to="#" className="align-middle minimize-card"
                                                          onClick={t_coll1} role="button">
                                                ...
                                                <li className="list-inline-item">
                                                    <button type="button" onClick={() => delthis("card-none1")}
                                                            className="btn-close fs-10 align-middle"></button>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div className="card-preloader d-none" id='spinner1'>
                                        <div className="card-status">
                                            <div className="spinner-border text-success"><span
                                ...
                                <Collapse isOpen={coll1} className="card-body" id="collapseexample1">
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1 ms-2 text-muted">
                                            ...
                                            default but revealed when the user activates.
                                        </div>
                                    </div>
                                    <div className="d-flex mt-2">
                                        ...
                                        <div className="flex-grow-1 ms-2 text-muted">
                                            ...
                                            unpleasant for the reader. The goal is to make your text as comfortable to
                                            read as possible.
                                        </div>
                                    </div>
                                    <div className="d-flex mt-2">
                                    ...
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-shrink-0">
                                            <ul className="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                                ...
                                                <li className="list-inline-item">
                                                    <Link to="#" className="align-middle minimize-card" role="button"
                                                          onClick={t_coll2}>
                                    ...
                                    <Card className="card-overlay">
                                        ...
                                        <div className="card-img-overlay p-0 d-flex flex-column">
                                            <CardHeader className="bg-transparent">
                                                <h4 className="card-title text-white mb-0">Design your apps in your own
                                                    way</h4>
                                            </CardHeader>
                                            <CardBody>
                                                <p className="card-text text-white mb-2">Each design is a new, unique
                                                    piece of art birthed into this world, and while you have the
                                                    opportunity to be creative and make your unpleasant for the
                                                    reader. </p>
                                            ...
                                            <div className="card-footer bg-transparent text-center">
                                                <Link to="#" className="link-light">Read More <i
                                                    className="ri-arrow-right-s-line align-middle ms-1 lh-1"></i></Link>
                                            </div>
                                        </div>
                                    </Card>
                            ...
                            <Row>
                                <Col lg={6} xxl={4}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <h4 className="card-title mb-2">A day in the of a professional fashion
                                                designer</h4>
                                            <p className="card-text text-muted"> Exercitation +1 labore velit, blog
                                ...
                                <Col lg={6} xxl={4}>
                                    <Card>
                                        <CardHeader>
                                            <h4 className="card-title mb-0">A day in the of a professional fashion
                                                designer</h4>
                                        </CardHeader>
                                        <CardBody>
                                            <p className="card-text text-muted"> Exercitation +1 labore velit, blog
                                ...
                                <Col lg={6} xxl={4}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="card-text text-muted"> Exercitation +1 labore velit, blog
                                                sartorial PBR leggings next level wes anderson artisan four loko
                                                farm-to-table craft beer twee. ommodo enim craft beer mlkshk aliquip
                                                jean shorts ullamco.</p>
                                            <p className="card-text mb-0">
                                                Last updated 3 mins ago
                                            </p>
                            ...
                            <Row>
                                <Col xxl={6}>
                                    <Card>
                                        <Row className="g-0">
                                            <Col md={4}>
                                                <img className="rounded-start img-fluid h-100 object-fit-cover"
                                                     src={img12} alt="Card"/>
                                            </Col>
                                            <Col md={8}>
                                                <CardHeader>
                                                ...
                                                <CardBody>
                                                    <p className="card-text mb-2">For that very reason, I went on a
                                                        quest and spoke to many different professional graphic designers
                                                        and asked them what graphic design tips they live.</p>
                                                    <p className="card-text"><small className="text-muted">Last updated
                                                        3 mins ago</small></p>
                                                </CardBody>
                                            </Col>
                                        </Row>
                                ...
                                <Col xxl={6}>
                                    <Card>
                                        <Row className="g-0">
                                            <Col md={8}>
                                                <CardHeader>
                                                    <h5 className="card-title mb-0">Manage white space in responsive
                                                        layouts ?</h5>
                                                </CardHeader>
                                                <CardBody>
                                                    <p className="card-text mb-2">For that very reason, I went on a
                                            ...
                                            <div className="col-md-4">
                                                <img className="rounded-end img-fluid h-100 object-fit-cover" src={img4}
                                                     alt="Card"/>
                                            </div>
                                        </Row>
                                    </Card>
                                        ...
                                        <Row className="g-0">
                                            ...
                                            <Col md={8}>
                                                <CardBody>
                                                    ...
                                                    <p className="card-text text-muted mb-0">For that very reason, I
                                                        went on a quest and spoke to many different professional graphic
                                                        designers and asked them what graphic design tips they live.</p>
                                                </CardBody>
                                                <div className="card-footer">
                                                    <p className="card-text"><small className="text-muted">Last updated
                                                        3 mins ago</small></p>
                                ...
                                <Col xxl={6}>
                                    <Card>
                                        <Row className="g-0">
                                            <Col md={8}>
                                                <CardBody>
                                                    <h5 className="card-title mb-2">Manage white space in responsive
                                                        layouts ?</h5>
                                                    <p className="card-text text-muted mb-0">For that very reason, I
                                                        went on a quest and spoke to many different professional graphic
                                                        designers and asked them what graphic design tips they live.</p>
                                            ...
                                            <Col md={4}>
                                                <img className="rounded-end img-fluid h-100 object-fit-cover" src={img2}
                                                     alt="Card"/>
                                            </Col>
                                        </Row>
                                    </Card>
                                    ...
                                    <Card className="card-primary">
                                        <CardBody>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <p className="card-text"><span className="fw-medium">Jeffrey Montgomery</span> (Graphic
                                        ...
                                        <div className="card-footer">
                                            <div className="text-center">
                                                <Link to="#" className="link-light">Connect Now <i
                                                    className="ri-arrow-right-s-line align-middle lh-1"></i></Link>
                                            </div>
                                        </div>
                                    </Card>
                                </Col>
                                            ...
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <p className="card-text"><span
                                                        className="fw-medium">Charles Dickens</span> (Financial Analyst)
                                    ...
                                    <Card className="card-info">
                                        <CardBody>
                                            <div className="d-flex align-items-center">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    <p className="card-text"><span
                                                        className="fw-medium">Oliver Phillips</span> (UI/UX Designer)
                                                        started a new conversation.</p>
                                                </div>
                                            </div>
                                        </CardBody>
                            ...
                            <Card className="card-warning">
                                <CardBody>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <p className="card-text"><span
                                                className="fw-medium">Rebecca Swartz</span> (Graphic Designer) started a
                                                new conversation.</p>
                                        </div>
                                    </div>
                                </CardBody>
                            ...
                            <Card className="card-danger">
                                <CardBody>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <p className="card-text"><span
                                                className="fw-medium">Betty Richards</span> (Back End Developer) started
                            ...
                            <Card className="card-dark">
                                <CardBody>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <p className="card-text"><span
                                                className="fw-medium">Brooke Hayes</span> (Founder & CEO) started a new
                                                conversation.</p>
                                        </div>
                                    </div>
                                </CardBody>
                            ...
                            <Card className="card-secondary">
                                <CardBody>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <p className="card-text"><span
                                                className="fw-medium">Bethany Johnson</span> (Team Leader) started a new
                                                conversation.</p>
                                        </div>
                                    </div>
                                </CardBody>
                            ...
                            <Card className="card-light">
                                <CardBody>
                                    <div className="d-flex align-items-center">
                                        ...
                                        <div className="flex-grow-1 ms-3">
                                            <p className="card-text"><span
                                                className="fw-medium">Amelie Townsend</span> (UI/UX Designer) started a
                                                new conversation.</p>
                                        </div>
                                    </div>
                                </CardBody>
                                <div className="card-footer">
                                    <div className="text-center">
                                        <Link to="#" className="text-body">Connect Now <i
                                            className="ri-arrow-right-s-line align-middle lh-1"></i></Link>
                                    </div>
                                </div>
                            </Card>
                            ...
                            <Row>
                                <Col xxl={4}>
                                    <Card className="border card-border-primary">
                                        <CardHeader>
                                            ...
                                            <h6 className="card-title mb-0">Handle to Forcast <span
                                                className="badge bg-danger align-middle fs-10">Poor</span></h6>
                                        </CardHeader>
                                        <CardBody>
                                            <p className="card-text">Whether article spirits new her covered hastily
                                                sitting her. Money witty books nor son add build on the card Chicken age
                                                had evening believe but proceed pretend mrs.</p>
                                            <div className="text-end">
                                                <Link to="#" className="link-primary fw-medium">Read More <i
                                                    className="ri-arrow-right-line align-middle"></i></Link>
                                            </div>
                                        </CardBody>
                                    </Card>
                                </Col>
                                <Col xxl={4}>
                                    <Card className="border card-border-success">
                                        <CardHeader>
                                            ...
                                            <h6 className="card-title mb-0">Quality Forcast <span
                                                className="badge bg-success align-middle fs-10">Excellent</span></h6>
                                        </CardHeader>
                                        <CardBody>
                                            <p className="card-text">They all have something to say beyond the words on
                                            ...
                                            <div className="text-end">
                                                <Link to="#" className="link-success fw-medium">Read More <i
                                                    className="ri-arrow-right-line align-middle"></i></Link>
                                            </div>
                                        </CardBody>
                                    </Card>
                                ...
                                <Col xxl={4}>
                                    <Card className="border card-border-info">
                                        <CardHeader>
                                            <h6 className="card-title mb-0">Check your E-mails <span
                                                className="badge bg-info align-middle fs-10">In Process</span></h6>
                                        </CardHeader>
                                        <CardBody>
                                            <p className="card-text">They all have something to say beyond the words on
                                                the page. They can come across as casual or neutral, exotic or graphic.
                                                Cosby sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                            <div className="text-end">
                                                <Link to="#" className="link-info fw-medium">Read More <i
                                                    className="ri-arrow-right-line align-middle"></i></Link>
                                            </div>
                                        </CardBody>
                                    </Card>
                    ...
                    <Row>
                        <Col xxl={4}>
                            <Card className="border card-border-warning">
                                <CardHeader>
                                    <h6 className="card-title mb-0">Check your Payment <span
                                        className="badge bg-warning align-middle fs-10">Pending</span></h6>
                                </CardHeader>
                                <CardBody>
                                    <p className="card-text">They all have something to say beyond the words on the
                                        page. They can come across as casual or neutral, exotic or graphic. Cosby
                                        sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                    <div className="text-end">
                                        <Link to="#" className="link-warning fw-medium">Read More <i
                                            className="ri-arrow-right-line align-middle"></i></Link>
                                    </div>
                                </CardBody>
                            </Card>
                        ...
                        <Col xxl={4}>
                            <Card className="border card-border-danger">
                                <CardHeader>
                                    <h6 className="card-title mb-0">Your Ordered Cancel <span
                                        className="badge bg-danger align-middle fs-10">Cancel</span></h6>
                                </CardHeader>
                                <CardBody>
                                    <p className="card-text">They all have something to say beyond the words on the
                                        page. They can come across as casual or neutral, exotic or graphic. Cosby
                                        sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                    <div className="text-end">
                                        <Link to="#" className="link-danger fw-medium">Read More <i
                                            className="ri-arrow-right-line align-middle"></i></Link>
                                    </div>
                                </CardBody>
                            </Card>
                            ...
                            <Card className="border card-border-dark">
                                ...
                                <CardBody>
                                    <p className="card-text">They all have something to say beyond the words on the
                                        ...
                                        sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                    <div className="text-end">
                                        <Link to="#" className="text-body fw-medium">Read More <i
                                            className="ri-arrow-right-line align-middle"></i></Link>
                                    </div>
                                </CardBody>
                            </Card>
                            ...
                            <Card className="border card-border-secondary">
                                ...
                                <CardBody>
                                    <p className="card-text">They all have something to say beyond the words on the
                                        ...
                                        sweater eu banh mi, qui irure terry richardson ex squid.</p>
                                    <div className="text-end">
                                        <Link to="#" className="link-secondary fw-medium">Read More <i
                                            className="ri-arrow-right-line align-middle"></i></Link>
                                    </div>
                                </CardBody>
                            </Card>
                    ...
                    <Row className="g-3">
                        ...
                        <Col className="col-xxl col-6">
                            <Card className="h-100">
                                ...
                                <CardBody>
                                    <p className="card-text">This may be the most commonly encountered tip I received
                                        from the designers I spoke with. They highly encourage that you use different
                                        fonts in one design, but do not over-exaggerate and go overboard.</p>
                                </CardBody>
                                <div className="card-footer">
                                    <p className="card-text">
                                        <small className="text-muted">Last updated 3 mins ago</small>
                        ...
                        <Col className="col-xxl col-6">
                            <Card className="h-100">
                                ...
                                <CardBody>
                                    <h4 className="card-title">Manage white space in responsive layouts ?</h4>
                                    <p className="card-text">Exercitation +1 labore velit, blog sartorial PBR leggings
                                        next level wes anderson artisan four loko farm-to-table craft beer twee. ommodo
                                        enim craft beer mlkshk aliquip jean shorts ullamco.</p>
                                </CardBody>
                                <div className="card-footer">
                                    <p className="card-text">
                                        <small className="text-muted">Last updated 3 mins ago</small>
                            ...
                            <Row>
                                ...
                                >
                                    ...
                                    <Card className="p-3">
                                        <figure className="mb-0">
                                            <blockquote className="blockquote">
                                                <p className="lead">"A business consulting agency is involved in the
                                                    planning, implementation, and education of businesses."</p>
                                            </blockquote>
                                            <figcaption className="blockquote-footer fs-13 text-end mb-0">
                                                Creative Agency<cite title="Source Title"
                                                                     className="text-primary fw-semibold"> Alice
                                    ...
                                    <div><Card>
                                        <CardBody>
                                            ...
                                            <p className="card-text">This is another card with title and supporting text
                                        ...
                                        <Card className="card-success">
                                            <CardBody>
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="flex-grow-1 ms-3">
                                                        <p className="card-text"><span className="fw-medium">Charles Dickens</span> (Financial
                                    ...
                                    <div><Card className="text-center">
                                        <CardBody>
                                            <h5 className="card-title mb-1">Card title</h5>
                                            <p className="card-text">This card has a regular title and short paragraphy
                                                of text below it.</p>
                                            <p className="card-text"><small className="text-muted">Last updated 3 mins
                                                ago</small></p>
                                        </CardBody>
                                    ...
                                    <Card>
                                        <CardBody>
                                            <div className="d-flex position-relative">
                                                <img src={avatar3} className="flex-shrink-0 me-3 avatar-xl rounded"
                                                     alt="..."/>
                                                <div>
                                                    <h5 className="mt-0">Custom component with stretched link</h5>
                                                    <p>This is some placeholder content for the custom component. It is
