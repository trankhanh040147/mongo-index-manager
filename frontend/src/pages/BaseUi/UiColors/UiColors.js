...
const UiColors = () => {
    document.title = "Colors | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent/>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className="table-responsive">
                                        <table
                                            className="table table-bordered table-striped table-nowrap align-middle mb-0">
                                            <thead>
                                            <tr>
                                                <th scope="col">
                                                    Colors
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <div className="text-opacity-100 text-primary">text-opacity-100
                                                    </div>
                                                </td>
                                            </tr>
                                            ...
                                            <div className="table-responsive">
                                                <Table bordered className="align-middle mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style={{width: '100px'}}>
                                                            <div
                                                                className="text-primary-emphasis">text-primary-emphasis
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style={{width: '100px'}}>
                                                            <div
                                                                className="text-secondary-emphasis">text-secondary-emphasis
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style={{width: '100px'}}>
                                                            <div
                                                                className="text-success-emphasis">text-success-emphasis
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                            ...
                                            <div className="table-responsive">
                                                <Table bordered className="align-middle mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style={{width: '100px'}}>
                                                            <div
                                                                className="text-warning-emphasis">text-warning-emphasis
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        ...
                                                        <td style={{width: '100px'}}>
                                                            <div className="text-danger-emphasis">text-danger-emphasis
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style={{width: '100px'}}>
                                                            <div className="text-light-emphasis">text-light-emphasis
                                                            </div>
                                                        </td>
                                                    </tr>
                                                    </tbody>
