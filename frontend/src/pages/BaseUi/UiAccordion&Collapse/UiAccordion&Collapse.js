...
const UiAccordions = () => {
    document.title = "Accordions | DRManager - React Admin & Dashboard Template";
    // Default Accordion
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>accordion</code> class to expand/collapse
                                        the accordion content.</p>
                                        ...
                                        <Accordion id="default-accordion-example">
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingOne">
                                                    <button
                                                        ...
                                                        type="button" onClick={t_col1} style={{cursor: "pointer"}}>
                                                ...
                                                <Collapse isOpen={col1} className="accordion-collapse" id="collapseOne">
                                                    <div className="accordion-body">
                                                        Although you probably won’t get into any legal trouble if you do
                                                        it just once, why risk it? If you made your subscribers a
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingTwo">
                                                    <button
                                                        ...
                                                        type="button" onClick={t_col2} style={{cursor: "pointer"}}>
                                                        Why do we use it ?
                                                    </button>
                                                </h2>
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingThree">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !col3})}
                                                        type="button" onClick={t_col3} style={{cursor: "pointer"}}>
                                                ...
                                                <Collapse isOpen={col3} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        ...
                                                        this allotment, plus some extra for growth. Don't worry, there
                                                        are no mistakes to be made here. You can always upgrade and
                                                        downgrade.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>accordion-flush</code> class to remove the
                                        default background-color, some borders, and some rounded corners to render
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Accordion id="default-accordion-example" flush>
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingOne">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !col4})}
                                                        type="button" onClick={t_col4} style={{cursor: "pointer"}}>
                                                ...
                                                <Collapse isOpen={col4} className="accordion-collapse" id="collapseOne">
                                                    <div className="accordion-body">
                                                        ...
                                                        does however force an immediate, pro-rated charge to take place
                                                        on your account.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingTwo">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !col5})}
                                                        type="button" onClick={t_col5} style={{cursor: "pointer"}}>
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingThree">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !col6})}
                                                        type="button" onClick={t_col6} style={{cursor: "pointer"}}>
                                                ...
                                                <Collapse isOpen={col6} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        ...
                                                        is an anonymous, private act. This prevents further harassment.
                                                        Providing this information is considered bad practice, and
                                                        further communication after they opt out would be considered
                                                        against compliance.
                                                    </div>
                                                </Collapse>
                                            </AccordionItem>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>custom-accordionwithicon</code> class to show
                                        custom icon at accordion.</p>
                                    <div className="live-preview">

                                        <Accordion className="custom-accordionwithicon accordion-secondary"
                                                   id="accordionWithicon">
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingOne">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !iconCol1})}
                                                        type="button" onClick={t_iconCol1} style={{cursor: "pointer"}}>
                                                        <i className="ri-global-line me-2"></i> How Does Age
                                                        Verification Work?
                                                    </button>
                                                </h2>

                                                <Collapse isOpen={iconCol1} className="accordion-collapse"
                                                          id="collapseOne">
                                                    <div className="accordion-body">
                                                        Increase or decrease the letter spacing depending on the
                                                        situation and try, try again until it looks right, and each
                                                        assumenda labore aes Homo nostrud organic, assumenda labore
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingTwo">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !iconCol2})}
                                                        type="button" onClick={t_iconCol2} style={{cursor: "pointer"}}>
                                                        <i className="ri-user-location-line me-2"></i> How Does Link
                                                        Tracking Work?
                                                    </button>
                                                </h2>
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingThree">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !iconCol3})}
                                                        type="button" onClick={t_iconCol3} style={{cursor: "pointer"}}>
                                                        <i className="ri-pen-nib-line me-2"></i> How Do I Set Up the
                                                        Drip Feature?
                                                    </button>
                                                </h2>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>accordion-icon-none</code> class to remove icon
                                        at accordion.</p>
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="accordion-icon-none" id="accordionWithouticon">
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionwithouticonExample1">
                                                    <button
                                                        ...
                                                        type="button" onClick={t_iconCol4} style={{cursor: "pointer"}}>
                                                        <i className="ri-global-line me-2"></i> How Does Age
                                                        Verification Work?
                                                    </button>
                                                </h2>

                                                <Collapse isOpen={iconCol4} className="accordion-collapse"
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionwithouticonExample2">
                                                    <button
                                                        ...
                                                        type="button" onClick={t_iconCol5} style={{cursor: "pointer"}}>
                                                        <i className="ri-user-location-line me-2"></i> How Does Link
                                                        Tracking Work?
                                                    </button>
                                                </h2>

                                                <Collapse isOpen={iconCol5} className="accordion-collapse"
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionwithouticonExample3">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !iconCol6})}
                                                        type="button" onClick={t_iconCol6} style={{cursor: "pointer"}}>
                                                        <i className="ri-pen-nib-line me-2"></i> How Do I Set Up the
                                                        Drip Feature?
                                                    </button>
                                                </h2>
                                                <Collapse isOpen={iconCol6} className="accordion-collapse"
                        ...
                        <Col xl={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>custom-accordionwithicon-plus</code> class to
                                        show plus icon at the accordion.</p>
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon-plus" id="accordionWithplusicon">
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionwithouticonExample1">
                                                    <button
                                                        ...
                                                        type="button" onClick={t_plusiconCol1}
                                                        style={{cursor: "pointer"}}>
                                                        What is User Interface Design?
                                                    </button>
                                                </h2>

                                                <Collapse isOpen={plusiconCol1} className="accordion-collapse"
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionwithplusExample2">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !plusiconCol2})}
                                                        type="button" onClick={t_plusiconCol2}
                                                        style={{cursor: "pointer"}}>
                                                        What is Digital Marketing?
                                                    </button>
                                                </h2>

                                                <Collapse isOpen={plusiconCol2} className="accordion-collapse"
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionwithplusExample3">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !plusiconCol3})}
                                                        type="button" onClick={t_plusiconCol3}
                                                        style={{cursor: "pointer"}}>
                                                        Where does it come from ?
                                                    </button>
                                                </h2>
                                                <Collapse isOpen={plusiconCol3} className="accordion-collapse"
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>lefticon-accordion</code> class to show the icon
                                        on the left side of the accordion.</p>
                                    <div className="live-preview">
                                        <Accordion
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionlefticonExample1">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !lefticonCol1})}
                                                        type="button" onClick={t_lefticonCol1}
                                                        style={{cursor: "pointer"}}>
                                                        What is User Interface Design?
                                                    </button>
                                                </h2>

                                                <Collapse isOpen={lefticonCol1} className="accordion-collapse"
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionlefticonExample2">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !lefticonCol2})}
                                                        type="button" onClick={t_lefticonCol2}
                                                        style={{cursor: "pointer"}}>
                                                        What is Digital Marketing?
                                                    </button>
                                                </h2>

                                                <Collapse isOpen={lefticonCol2} className="accordion-collapse"
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionlefticonExample3">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !lefticonCol3})}
                                                        type="button" onClick={t_lefticonCol3}
                                                        style={{cursor: "pointer"}}>
                                                        Where does it come from ?
                                                    </button>
                                                </h2>
                                                <Collapse isOpen={lefticonCol3} className="accordion-collapse"
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>custom-accordion-border</code> class to create
                                        the border at the accordion.</p>
                                    <div className="live-preview">
                                        ...
                                        <Accordion
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionborderedExample1">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !borderCol1})}
                                                        type="button" onClick={t_borderCol1}
                                                        style={{cursor: "pointer"}}>
                                                        What is User Interface Design?
                                                    </button>
                                                </h2>

                                                <Collapse isOpen={borderCol1} className="accordion-collapse"
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionborderedExample2">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !borderCol2})}
                                                        type="button" onClick={t_borderCol2}
                                                        style={{cursor: "pointer"}}>
                                                        What is Digital Marketing?
                                                    </button>
                                                </h2>

                                                <Collapse isOpen={borderCol2} className="accordion-collapse"
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionborderedExample3">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !borderCol3})}
                                                        type="button" onClick={t_borderCol3}
                                                        style={{cursor: "pointer"}}>
                                                        Where does it come from ?
                                                    </button>
                                                </h2>
                                                <Collapse isOpen={borderCol3} className="accordion-collapse"
                    ...
                    <Row>
                        <Col xl={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>nesting-accordion</code> class to create a
                                        nesting accordion.</p>
                                    <div className="live-preview">
                                        ...
                                        <Accordion className="custom-accordionwithicon accordion-border-box"
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="accordionnestingExample1">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !nestingCol1})}
                                                        type="button" onClick={t_nestingCol1}
                                                        style={{cursor: "pointer"}}>
                                                        How Do I Add Contacts/Subscribers?
                                                    </button>
                                                </h2>

                                                <Collapse isOpen={nestingCol1} className="accordion-collapse"
                                                    ...
                                                    <div className="accordion-body">
                                                        ...
                                                        example, upon cashing out online, a subscriber may submit to
                                                        have their mobile number to receive marketing messages. The API
                                                        will pass this information from said software over to Slicktext
                                                        via API integration.
                                                        <div
                                                            ...
                                                            <AccordionItem>
                                                                <h2 className="accordion-header"
                                                                    ...
                                                                    <button
                                                                        className={classnames("accordion-button", {collapsed: !anestingCol1})}
                                                                        type="button" onClick={t_anestingCol1}
                                                                        style={{cursor: "pointer"}}>
                                                                        How Do I Search For Contacts?
                                                                    </button>
                                                                </h2>

                                                                <Collapse isOpen={anestingCol1}
                                                                        ...
                                                                        <div
                                                                            ...
                                                                            <AccordionItem>
                                                                                <h2 className="accordion-header"
                                                                                    ...
                                                                                    <button
                                                                                        className={classnames("accordion-button", {collapsed: !bnestingCol1})}
                                                                                        type="button"
                                                                                        onClick={t_bnestingCol1}
                                                                                        style={{cursor: "pointer"}}>
                                                                                        How do I reset my digital tide
                                                                                        watch ?
                                                                                    </button>
                                                                                </h2>

                                                                                <Collapse isOpen={bnestingCol1}
                                                                                          className="accordion-collapse"
                                                                                          id="accor_nesting4Examplecollapse2">
                                                                                    <div className="accordion-body">
                                                                                        Opting out a subscriber will
                                                                                        allow SlickText to maintain the
                                                                                        history of the subscriber as it
                                                                                        pertains to the textword you are
                                                                                        opting them out of. If this user
                                                                                        was to text to join again, the
                                                                                        initial text they are met with
                                                                                        will be a "welcome back" message
                                                            ...
                                                            <AccordionItem>
                                                                <h2 className="accordion-header"
                                                                    ...
                                                                    <button
                                                                        className={classnames("accordion-button", {collapsed: !anestingCol2})}
                                                                        type="button" onClick={t_anestingCol2}
                                                                        style={{cursor: "pointer"}}>
                                                                        How Do I Delete a Contact From My List?
                                                                    </button>
                                                                </h2>

                                                                <Collapse isOpen={anestingCol2}
                                                                          className="accordion-collapse">
                                                                    <div className="accordion-body">
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingTwo">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !nestingCol2})}
                                                        type="button" onClick={t_nestingCol2}
                                                        style={{cursor: "pointer"}}>
                                                ...
                                                <Collapse isOpen={nestingCol2} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        ...
                                                        when a text message is sent. These merge tags may also be known
                                                        as personalization fields.
                                                        <div
                                                            ...
                                                            <div className="accordion-item mt-2">
                                                                <h2 className="accordion-header"
                                                                    id="accordionnesting4Example2">
                                                                    <button
                                                                        className={classnames("accordion-button", {collapsed: !a1nestingCol1})}
                                                                        type="button" onClick={t_a1nestingCol1}
                                                                        style={{cursor: "pointer"}}>
                                                                        Howe does temperature impact my watch?
                                                                    </button>
                                                                </h2>

                                                                <Collapse isOpen={a1nestingCol1}
                                                                          className="accordion-collapse"
                                            ...
                                            <AccordionItem>
                                                <h2 className="accordion-header" id="headingThree">
                                                    <button
                                                        className={classnames("accordion-button", {collapsed: !nestingCol3})}
                                                        type="button" onClick={t_nestingCol3}
                                                        style={{cursor: "pointer"}}>
                                                ...
                                                <Collapse isOpen={nestingCol3} className="accordion-collapse">
                                                    <div className="accordion-body">
                                                        ...
                                                        to deliver your auto-reply messages to allow your subscriber
                    ...
                    <Row>
                        <Col xl={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>accordion-fill-</code> class with modifier class
                                        to the color accordion.</p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xxl={6}>
                                                <Accordion className="custom-accordionwithicon accordion-fill-success"
                                                           id="accordionFill">
                                                    <AccordionItem>
                                                        <h2 className="accordion-header" id="accordionFillExample1">
                                                            <button
                                                                className={classnames("accordion-button", {collapsed: !fillCol1})}
                                                                type="button" onClick={t_fillCol1}
                                                                style={{cursor: "pointer"}}>
                                                                What are webhooks?
                                                            </button>
                                                        </h2>

                                                        <Collapse isOpen={fillCol1} className="accordion-collapse"
                                                                  id="accor_fill1">
                                                            <div className="accordion-body">
                                                    ...
                                                    <AccordionItem>
                                                        <h2 className="accordion-header" id="accordionFillExample2">
                                                            <button
                                                                className={classnames("accordion-button", {collapsed: !fillCol2})}
                                                                type="button" onClick={t_fillCol2}
                                                                style={{cursor: "pointer"}}>
                                                                Where can I find my Textword ID?
                                                            </button>
                                                        </h2>

                                                        <Collapse isOpen={fillCol2} className="accordion-collapse"
                                                                  id="accor_fill2">
                                                            <div className="accordion-body">
                                                    ...
                                                    <AccordionItem>
                                                        <h2 className="accordion-header" id="accordionFillExample3">
                                                            <button
                                                                className={classnames("accordion-button", {collapsed: !fillCol3})}
                                                                type="button" onClick={t_fillCol3}
                                                                style={{cursor: "pointer"}}>
                                                                Where is your API documentation?
                                                            </button>
                                                        </h2>
                                                        <Collapse isOpen={fillCol3} className="accordion-collapse"
                                                                  id="accor_fill3">
                                                            <div className="accordion-body">
                                                ...
                                                <Accordion
                                                    ...
                                                    <AccordionItem>
                                                        <h2 className="accordion-header" id="accordionFill2Example1">
                                                            <button
                                                                className={classnames("accordion-button", {collapsed: !fillCol4})}
                                                                type="button" onClick={t_fillCol4}
                                                                style={{cursor: "pointer"}}>
                                                                How Does Age Verification Work?
                                                            </button>
                                                        </h2>

                                                        <Collapse isOpen={fillCol4} className="accordion-collapse"
                                                                  id="accor_fill21">
                                                            <div className="accordion-body">
                                                    ...
                                                    <AccordionItem>
                                                        <h2 className="accordion-header" id="accordionFill2Example2">
                                                            <button
                                                                className={classnames("accordion-button", {collapsed: !fillCol5})}
                                                                type="button" onClick={t_fillCol5}
                                                                style={{cursor: "pointer"}}>
                                                                What Kind of List Growth Should I Expect?
                                                            </button>
                                                        </h2>

                                                        <Collapse isOpen={fillCol5} className="accordion-collapse"
                                                                  id="accor_fill22">
                                                            <div className="accordion-body">
                                                    ...
                                                    <AccordionItem>
                                                        <h2 className="accordion-header" id="accordionFill2Example3">
                                                            <button
                                                                className={classnames("accordion-button", {collapsed: !fillCol6})}
                                                                type="button" onClick={t_fillCol6}
                                                                style={{cursor: "pointer"}}>
                                                                How Do I Delete a Contact From My List?
                                                            </button>
                                                        </h2>
                                                        <Collapse isOpen={fillCol6} className="accordion-collapse"
                                                                  id="accor_fill23">
                                                            <div className="accordion-body">
                    ...
                    <Row>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Collapse isOpen={coll1} id="collapseExample">
                                            <div className="card mb-0">
                                                <CardBody>
                                                    When designing, the goal is to draw someone’s attention and portray
                                                    to them what you’re trying to say. You can make a big statement by
                                                    using little tricks, like this one. Use contrasting fonts. you can
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <p className="text-muted">Use the <code>collapse-horizontal</code> class to
                                            transition the <code>width</code> instead of <code>height</code> and set
                                            a <code>width</code> on the immediate child element for horizontal collapse.
                                        </p>
                                        <p>
                                            <Button onClick={t_coll2} color="primary"
                                                    style={{cursor: "pointer"}}> Toggle Width Collapse </Button>
                                        </p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Here is the example of collapse in which the icon is wrapped within the button
                                        collapse toggle.
                                    </p>
                                    <div className="live-preview">

                                        <div className="hstack gap-3 mb-3">
                                            <Link to="#" onClick={t_coll6} style={{cursor: "pointer"}}
                                        ...
                                        <Collapse isOpen={coll6} id="collapseWithicon">
                                            <div className="card mb-0">
                                                <CardBody>
                                                    If you enter text including symbols in the search criteria, the
                                                    search criteria is interpreted exactly as you entered it, and the
                                                    search is case sensitive as a case insensitive search that contains
                                                    certain text but does also provide a lot of search criteria options.
                                                </CardBody>
                                            </div>
                                        </Collapse>
                                        <Collapse isOpen={coll7} id="collapseWithicon2">
                                            <div className="card mb-0 mt-3">
                                                <CardBody>
                                                    When you want to search for data, such as customer names, addresses,
                                                    or product groups, you enter criteria. In search criteria you can
                                                    use all the numbers and letters that you normally use in the
                                                    specific field. In addition, you can use special symbols to further
                                                    filter the results.
                                                </CardBody>
                                            </div>
                                        </Collapse>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Inline element collapse takes all horizontal space hence
                                        you can activate the collapse within by clicking on
                                        full-width horizontal space. Block element collapse can be activated by clicking
                                        on collapse toggle only.</p>
                                    <div className="live-preview">
                                            ...
                                            <Col className="col-auto">
                                                <Collapse isOpen={coll8} id="collapseblock" horizontal>
                                                    <div className="card card-body mb-0" style={{width: "300px"}}>
                                                        ...
                                                        like these sweet mornings of spring heart.
                                                    </div>
                                                </Collapse>
                                            </Col>
                                            <Col className="col-auto">
                                                <Collapse isOpen={coll9} id="collapseinline" horizontal>
                                                    <div className="card card-body mb-0" style={{width: "300px"}}>
                                                        When you have created a new account schedule and set up the
                                                        rows, you must set up columns.
                                                    </div>
                                                </Collapse>
                                            </Col>
                                        </Row>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        A <code>&lt;button&gt;</code> or <code>&lt;a&gt;</code> can show and hide
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <div className="d-flex gap-2 flex-wrap mb-3">
                                            <Link to="#" onClick={t_coll3} style={{cursor: "pointer"}}
                                                  className="btn btn-primary"> Toggle First Element </Link>
                                            <Button onClick={t_coll4} color="primary"
                                                    style={{cursor: "pointer"}}> Toggle Second Element </Button>
                                            <Button onClick={t_coll5} color="primary"
                                                    style={{cursor: "pointer"}}> Toggle Both Elements </Button>
                                        </div>
                                        <Row>
                                            <Col>
