...
const UiPlaceholders = () => {
    document.title = "Placeholders | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent/>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">In the example below, we take a typical card component and
                                                        ...
                                                        <Card>
                                                            ...
                                                            <CardBody>
                                                                ...
                                                                <p className="card-text">Some quick example text to
                                                                    ...
                                                                    card's content.</p>
                                                                <Link to="#" className="btn btn-primary">Go
                                                                    somewhere</Link>
                                                            </CardBody>
                                                        </Card>
                                                    </Col>
                                                    <Col lg={5} sm={6}>
                                                        <Card>
                                                            ...
                                                            <CardBody>
                                                                ...
                                                                <Link to="#" tabIndex="-1"
                                                                      className="btn btn-primary disabled placeholder col-6"></Link>
                                                            </CardBody>
                                                        </Card>
                                                    </Col>
                                                </Row>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>w-25,w-50,w-75</code> or <code>w-100</code> class
                                        to placeholder class to set different widths to the placeholder.</p>
                                    <div className="live-preview">
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>placeholder-lg</code>, <code>placeholder-sm</code>,
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>bg-</code> class with the below-mentioned color
