...
const UiAlerts = () => {
    document.title = "Alerts | DRManager - React Admin & Dashboard Template";
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>Alert</code> tag to show a default alert.
                                    </p>
                                        ...
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <Alert color="secondary">
                                                    <strong> How are you! </strong> A simple <b>secondary
                                                    alert</b> —check it out!
                                                </Alert>

                                                <h6>Success Alert</h6>
                                                <Alert color="success">
                                                    <strong> Yey! Everything worked! </strong> A simple <b>success
                                                    alert</b> —check it out!
                                                </Alert>

                                                <h6>Danger Alert</h6>
                                                <Alert color="danger" className='mb-0'>
                                                    <strong> Something is very wrong! </strong> A simple <b>danger
                                                    alert</b> —check it out!
                                                </Alert>
                                            </Col>
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <h6>Info Alert</h6>
                                                <Alert color="info">
                                                    <strong>Don't forget' it !</strong> A simple <b>info
                                                    alert</b> —check it out!
                                                </Alert>

                                                <h6>Light Alert</h6>
                                                <Alert color="light">
                                                    <strong>Mind Your Step!</strong> A simple <b>light alert</b> —check
                                                    it out!
                                                </Alert>

                                                <h6>Dark Alert</h6>
                                                <Alert color="dark" className='mb-0'>
                                                    <strong>Did you know?</strong> A simple <b>dark alert</b> —check it
                                                    out!
                                                </Alert>
                                            </Col>
                                        </Row>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>border-0</code> class to set alert without
                                        border.</p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-dismissible</code> tag to add
                                        dismissing button to the alert.
                                    </p>
                                    <div className="live-preview">
                                        ...
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="success">
                                                    <strong>Right Way !</strong> A simple <b>Dismissible success
                                                    alert</b> —check it out!
                                                </UncontrolledAlert>
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="warning">
                                                    <strong>Welcome Back!</strong> A simple <b>Dismissible warning
                                                    alert</b> —check it out!
                                                </UncontrolledAlert>
                                                ...
                                                <UncontrolledAlert color="light">
                                                    <strong>Mind Your Step!</strong> A simple <b>Dismissible light
                                                    alert</b> —check it out!
                                                </UncontrolledAlert>

                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark" className="mb-0">
                                                    <strong>Did you know?</strong> A simple <b>Dismissible dark
                                                    alert</b> —check it out!
                                                </UncontrolledAlert>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-link</code> class at &lt;a&gt; tag to
                                        show matching colored links within the given alert.</p>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <Alert color="primary">
                                                    A simple Primary alert with <Link to="#" className="alert-link">an
                                                    example
                                                ...
                                                <h6>Secondary Alert</h6>
                                                <Alert color="secondary">
                                                    A simple Secondary alert with <Link to="#" className="alert-link">an
                                                    example
                                                    link</Link>. Give it a click if you like.
                                                </Alert>
                                                ...
                                                <h6>Success Alert</h6>
                                                <Alert color="success">
                                                    A simple Success alert with <Link to="#" className="alert-link">an
                                                    example
                                                    link</Link>. Give it a click if you like.
                                                </Alert>
                                                ...
                                                <Alert color="danger" className="mb-xl-0">
                                                    A simple Danger alert with <Link to="#" className="alert-link">an
                                                    example
                                                    link</Link>. Give it a click if you like.
                                                </Alert>
                                            </Col>
                                            ...
                                            <Col xl={6}>
                                                <h6>Warning Alert</h6>
                                                <Alert color="warning">
                                                    A simple Warning alert with <Link to="#" className="alert-link">an
                                                    example
                                                    link</Link>. Give it a click if you like.
                                                </Alert>
                                                ...
                                                <h6>Info Alert</h6>
                                                <Alert color="info">
                                                    A simple Info alert with <Link to="#" className="alert-link">an
                                                    example
                                                    link</Link>. Give it a click if you like.
                                                </Alert>
                                                ...
                                                <h6>Light Alert</h6>
                                                <Alert color="light">
                                                    A simple Light alert with <Link to="#" className="alert-link">an
                                                    example
                                                    link</Link>. Give it a click if you like.
                                                </Alert>
                                                ...
                                                <h6>Dark Alert</h6>
                                                <Alert color="dark" className="mb-0">
                                                    A simple Dark alert with <Link to="#" className="alert-link">an
                                                    example
                                                    link</Link>. Give it a click if you like.
                                                </Alert>
                                            </Col>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Click the Show live alert button to show an alert on
                                        button click.</p>
                                    <div className="live-preview">
                                        <div id="liveAlertPlaceholder">
                                            ...
                                            <button type="button" className="btn btn-primary" id="liveAlertBtn"
                                                    onClick={() => setShow(true)}>Show live alert
                                            </button>
                                        </div>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>border-2 bg-body-secondary</code> class to
                                        set an alert with outline.</p>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="primary"
                                                                   className="border-2 bg-body-secondary">
                                                ...
                                                <UncontrolledAlert color="secondary"
                                                                   className="border-2 bg-body-secondary">
                                                    <strong> How are you! </strong> - Outline <b>secondary
                                                    alert</b> example
                                                </UncontrolledAlert>
                                                ...
                                                <UncontrolledAlert color="danger"
                                                                   className="border-2 bg-body-secondary mb-xl-0">
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <UncontrolledAlert color="info" className="border-2 bg-body-secondary">
                                                    <strong>Don't forget' it !</strong> - Outline <b>info
                                                    alert</b> example
                                                </UncontrolledAlert>

                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark"
                                                                   className="border-2 bg-body-secondary mb-0">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-border-left </code> class to set an
                                        alert with the left border.</p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-label-icon</code> class to set an
                                        alert with a label icon.</p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                <h6>Primary Alert</h6>
                                                <UncontrolledAlert color="primary"
                                                                   className="alert alert-primary alert-dismissible bg-primary text-white alert-label-icon fade show"
                                                ...
                                                <h6>Secondary Alert</h6>
                                                <UncontrolledAlert color="secondary"
                                                                   className="alert alert-secondary alert-dismissible bg-secondary text-white alert-label-icon fade show"
                                                                   closeClassName="btn-close-white">
                                                ...
                                                <h6>Success Alert</h6>
                                                <UncontrolledAlert color="success"
                                                                   className="alert alert-success alert-dismissible bg-success text-white alert-label-icon fade show"
                                                                   closeClassName="btn-close-white">
                                                ...
                                                <h6>Danger Alert</h6>
                                                <UncontrolledAlert color="danger"
                                                                   className="alert alert-danger alert-dismissible bg-danger text-white alert-label-icon fade show mb-xl-0"
                                                                   closeClassName="btn-close-white">
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <h6>Info Alert</h6>
                                                <UncontrolledAlert color="info"
                                                                   className="alert alert-info alert-dismissible bg-info text-white alert-label-icon fade show"
                                                                   closeClassName="btn-close-white">
                                                ...
                                                <h6>Light Alert</h6>
                                                <UncontrolledAlert color="light"
                                                                   className="alert alert-light alert-dismissible bg-light text-body alert-label-icon fade show"
                                                                   closeClassName="btn-close-white">
                                                ...
                                                <h6>Dark Alert</h6>
                                                <UncontrolledAlert color="dark"
                                                                   className="alert alert-dark alert-dismissible bg-dark text-white alert-label-icon fade show mb-0"
                                                                   closeClassName="btn-close-white">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-additional</code> class and Use
                                        the <code>alert-</code> class to HTML elements like headings, paragraphs,
                                        dividers etc.</p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                    ...
                                                    <div className="alert-body">
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="flex-grow-1">
                                                                ...
                                                                <p className="mb-0">Aww yeah, you successfully read this
                                                ...
                                                <UncontrolledAlert color="danger" className="alert-additional mb-xl-0">
                                                    <div className="alert-body">
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="flex-grow-1">
                                                                <h5 className="alert-heading">Something is very
                                                                    wrong!</h5>
                                                                <p className="mb-0">Change a few things up and try
                                                                    submitting again.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                ...
                                                <UncontrolledAlert color="success" className="alert-additional">
                                                    <div className="alert-body">
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="flex-grow-1">
                                                                <h5 className="alert-heading">Yey! Everything
                                                                    worked!</h5>
                                                                <p className="mb-0">This alert needs your attention, but
                                                                    it"s not super important.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                                                    <div className="alert-content">
                                                ...
                                                <UncontrolledAlert color="warning" className="alert-additional mb-0">
                                                    <div className="alert-body">
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="flex-grow-1">
                                                                <h5 className="alert-heading">Uh oh, something went
                                                                    wrong!</h5>
                                                                <p className="mb-0">Better check yourself, you're not
                                                                    looking too good.</p>
                                                            </div>
                                                        </div>
                                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-top-border</code> class to set an
                                        alert with the top border and outline.</p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                <h6>Primary Alert</h6>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-label-icon label-arrow</code> class to
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-label-icon rounded-label</code> class
                                        to set an alert with a rounded label icon.</p>
                                    <div className="live-preview">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>alert-solid</code> class to set an alert
                                        with solid style.</p>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xl={6}>
                                                ...
                                                <Alert color="primary"
                                                       className="alert bg-primary border-primary text-white">
                                                    <strong>Hi!</strong> - Solid <b>primary alert</b> example
                                                </Alert>

                                                <h6>Secondary Solid Alert</h6>
                                                <Alert color="secondary"
                                                       className="alert bg-secondary border-secondary text-white">
                                                    <strong>How are you!</strong> - Solid <b>secondary alert</b> example
                                                </Alert>

                                                <h6>Success Solid Alert</h6>
                                                <Alert className="alert bg-success border-success text-white">
                                                    <strong>Yey! Everything worked! </strong> - Solid <b>success
                                                    alert</b> example
                                                </Alert>

                                                <h6>Danger Solid Alert</h6>
                                                <Alert color="danger"
                                                       className="alert bg-danger border-danger text-white mb-xl-0">
                                                    <strong>Something is very wrong!</strong> - Solid <b>danger
                                                    alert</b> example
                                                </Alert>
                                            ...
                                            <Col xl={6}>
                                                ...
                                                <Alert color="warning"
                                                       className="alert bg-warning border-warning text-white">
                                                    <strong>Uh oh, something went wrong!</strong> - Solid <b>warning
                                                    alert</b> example
                                                </Alert>

                                                <h6>Info Solid Alert</h6>
                                                <Alert color="info" className="alert bg-info border-info text-white">
                                                    <strong>Don't forget' it !</strong> - Solid <b>info
                                                    alert</b> example
                                                </Alert>

                                                <h6>Light Solid Alert</h6>
                                                <Alert color="light" className="alert bg-light border-light text-body">
                                                    <strong>Mind Your Step!</strong> - Solid <b>secondary
                                                    alert</b> example
                                                </Alert>

                                                <h6>Dark Solid Alert</h6>
                                                <Alert color="dark"
                                                       className="alert bg-dark border-dark text-white mb-0">
