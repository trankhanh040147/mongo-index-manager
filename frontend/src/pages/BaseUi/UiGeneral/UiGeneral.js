...
const UiGeneral = () => {
    document.title = "General | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent/>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Popovers example are available with follwing options ,
                                    ...
                                    <div className="live-preview">
                                        <div className="hstack flex-wrap gap-2">
                                            ...
                                            <UncontrolledPopover placement="top" target="PopoverTop">
                                                ...
                                                <PopoverBody> Vivamus sagittis lacus vel augue laoreet rutrum
                                                    faucibus. </PopoverBody>
                                            </UncontrolledPopover>
                                            ...
                                            <UncontrolledPopover placement="right" target="PopoverDismissible">
                                                ...
                                                <PopoverBody> And here's some amazing content. It's very engaging.
                                                    Right? </PopoverBody>
                                            </UncontrolledPopover>
                                        </div>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Tooltip example are available with follwing options,
                                        Directions are mirrored when using Bootstrap in RTL.</p>
                                    <div className="live-preview">
                                        <div className="hstack flex-wrap gap-2">
                                            ...
                                            <UncontrolledTooltip placement="top" target="tooltipTop"> Tooltip on
                                                top </UncontrolledTooltip>

                                            <Button color="light" id="tooltipRight">
                                                Tooltip on right
                                            </Button>
                                            <UncontrolledTooltip placement="right" target="tooltipRight"> Tooltip on
                                                right </UncontrolledTooltip>

                                            <Button color="light" id="tooltipBottom">
                                                Tooltip on bottom
                                            </Button>
                                            <UncontrolledTooltip placement="bottom" target="tooltipBottom"> Tooltip on
                                                bottom </UncontrolledTooltip>

                                            <Button color="light" id="tooltipLeft">
                                                Tooltip on left
                                            </Button>
                                            <UncontrolledTooltip placement="left" target="tooltipLeft"> Tooltip on
                                                left </UncontrolledTooltip>

                                            <Button color="primary" id="tooltipwithHtml">
                                                Tooltip with HTML
                                            </Button>
                                            <UncontrolledTooltip placement="top" target="tooltipwithHtml">
                                                <em>Tooltip</em> <u>with</u> <b>HTML</b> </UncontrolledTooltip>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Indicate the current page’s location within a navigational
                                        hierarchy</p>
                                    <div className="live-preview">
                                        ...
                                        <Breadcrumb listClassName='p-3 py-2 bg-light mb-0'>
                                            <BreadcrumbItem> <Link to="#"> <i className="ri-home-5-fill"/> </Link>
                                            </BreadcrumbItem>
                                            <BreadcrumbItem><Link to="#"> Base UI </Link> </BreadcrumbItem>
                                            <BreadcrumbItem active> General </BreadcrumbItem>
                                        </Breadcrumb>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col lg={6}>
                                                ...
                                                <p className="text-muted">Use <code>Pagination</code> attribute to ul
                                                    element to indicate a series of related content exists across
                                                    multiple pages.</p>
                                                <Pagination>
                                                    <PaginationItem> <PaginationLink to="#"> Previous </PaginationLink>
                                                    </PaginationItem>
                                                    <PaginationItem> <PaginationLink to="#"> 1 </PaginationLink>
                                                    </PaginationItem>
                                                    <PaginationItem> <PaginationLink to="#"> 2 </PaginationLink>
                                                    </PaginationItem>
                                                    <PaginationItem> <PaginationLink to="#"> 3 </PaginationLink>
                                                    </PaginationItem>
                                                    <PaginationItem> <PaginationLink to="#"> Next </PaginationLink>
                                                    </PaginationItem>
                                                </Pagination>

                                                <Pagination>
                                                    <PaginationItem> <PaginationLink
                                                        to="#"> ← &nbsp; Prev </PaginationLink> </PaginationItem>
                                                    <PaginationItem> <PaginationLink to="#"> 1 </PaginationLink>
                                                    </PaginationItem>
                                                    <PaginationItem> <PaginationLink to="#"> 2 </PaginationLink>
                                                    </PaginationItem>
                                                    ...
                                                    <PaginationItem> <PaginationLink
                                                        to="#"> Next &nbsp; → </PaginationLink> </PaginationItem>
                                                </Pagination>
                                            </Col>
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-4 mt-lg-0">
                                                    ...
                                                    <p className="text-muted">Use <code>disabled</code> attribute to
                                                        PaginationItem to links that appear
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="mt-4">
                                                    ...
                                                    <p className="text-muted">Use <code>pagination-lg</code> or <code>pagination-sm</code> to
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-4">
                                                    ...
                                                    <p className="text-muted">Use <code>justify-content-start</code>, <code>justify-content-start</code>,
                                                        or <code>justify-content-start</code>, class to pagination class
                                                        to
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="mt-4">
                                                    ...
                                                    <p className="text-muted">Use <code>pagination-separated</code> class
                                                        to pagination class to set custom separated pagination.</p>

                                                    {/* <!-- Custom Separated Pagination Large --> */}
                                                    <Pagination size="lg"
                                                                className="pagination-lg pagination-separated">
                                                        <PaginationItem disabled> <PaginationLink
                                                            to="#"> ← </PaginationLink> </PaginationItem>
                                                        <PaginationItem> <PaginationLink to="#"> 1 </PaginationLink>
                                                        </PaginationItem>
                                                        <PaginationItem active> <PaginationLink
                                                            to="#"> 2 </PaginationLink> </PaginationItem>
                                                        ...
                                                        <PaginationItem> <PaginationLink to="#"> → </PaginationLink>
                                                        </PaginationItem>
                                                    </Pagination>
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-4">
                                                    ...
                                                    <p className="text-muted">Use <code>pagination-rounded</code> class
                                                        to pagination class to set custom rounded pagination.</p>
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">Use <code>Spinner</code> attribute for a
                                            ...
                                            <Col lg={6}>
                                                <div>
                                                    ...
                                                    <p className="text-muted">Use <code>spinner-grow</code> class for a
