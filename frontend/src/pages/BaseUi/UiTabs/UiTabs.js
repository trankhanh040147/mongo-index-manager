...
const UiTabs = () => {
    document.title = "Tabs | DRManager - React Admin & Dashboard Template";
                ...
                <Container fluid>
                    ...
                    <Row>
                                    ...
                                    <TabContent activeTab={activeTab} className="text-muted">
                                        <TabPane tabId="1" id="home">
                                            ...
                                            <p className="mb-0">
                                                ...
                                                come across as casual or neutral, exotic or graphic. That's why it's
                                                important to think about your message, then choose a font that fits.
                                        ...
                                        <TabPane tabId="2" id="product">
                                            ...
                                            <p className="mb-0">
                                                ...
                                                fonts. Don't be afraid to combine font styles that are different but
                                                complementary, like sans serif with serif, short with tall, or
                                                decorative with simple. Qui photo booth letterpress, commodo enim craft
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>nav-justified</code> class to generate
                                        equal-width elements with all horizontal space will be occupied by nav links.
                                    </p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>nav-pills</code> class to generate particular
                                        selected nav links without borders.</p>

                                    <Nav pills className="nav-info mb-3">
                                        <NavItem>
                                            <NavLink style={{cursor: "pointer"}}
                                    ...
                                    <TabContent activeTab={pillsTab} className="text-muted">
                                        ...
                                        <TabPane tabId="2" id="profile-1">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    ...
                                                    artistic effect. It can also help you fix fonts that are poorly
                                        ...
                                        <TabPane tabId="4" id="settings-1">
                                            ...
                                            <div className="d-flex mt-2">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    After gathering lots of different opinions and graphic design
                                                    basics, I came up with a list of 30 graphic design tips that you can
                                                    start implementing.
                                                </div>
                                            </div>
                                        </TabPane>
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>nav-pills nav-justified</code> class to generate
                                        equal-width elements without borders, all horizontal space will be occupied by
                                        nav links.</p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>flex-column</code> class to create Vertical nav
                                        tabs.</p>
                                    <Row>
                                        <Col md={3}>
                                            ...
                                            >
                                                <TabPane tabId="1" id="v-pills-home">
                                                    <div className="d-flex mb-2">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            <p className="mb-0">You always want to make sure that your
                                                                fonts work well together and try to limit the number of
                                                                fonts you use to three or less. Experiment and play
                                                ...
                                                <TabPane tabId="2" id="v-pills-profile">
                                                    <div className="d-flex mb-2">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            <p className="mb-0"> I also decreased the transparency in
                                                                the text so that the mountains come through the text,
                                                                bringing the quote truly to life. Make sure that the
                                                                placement of your text is pleasing to look at, and you
                                                                try to achieve symmetry for this effect.</p>
                                                        </div>
                                                    </div>
                                                    <p className="mb-0">
                                                        You've probably heard that opposites attract. The same is true
                                                        for fonts. Don't be afraid to combine font styles that are
                                                        different but complementary. You can always play around with the
                                                        text that is overlaid on an image.
                                                    </p>
                                                ...
                                                <TabPane tabId="3" id="v-pills-messages">
                                                    <div className="d-flex mb-2">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            <p className="mb-0">In this image, you can see that the line
                                                                height has been reduced significantly, and the size was
                                                                brought up exponentially. Experiment and play around
                                                                with the fonts that you already have in the software
                                                                you’re working with reputable font websites.</p>
                                                        </div>
                                                    </div>
                                                    <p className="mb-0">
                                                        They highly encourage that you use different fonts in one
                                                        design, but do not over-exaggerate and go overboard This may be
                                                        the most commonly encountered tip I received from the designers
                                                        I spoke with.
                                                    </p>
                                                </TabPane>
                                                ...
                                                <TabPane tabId="4" id="v-pills-settings">
                                                    <div className="d-flex mb-2">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            <p className="mb-0">When designing, the goal is to draw
                                                                someone’s attention and portray to them what you’re
                                                                trying to say. You can make a big statement by using
                                                                little tricks, like this one. Use contrasting fonts. you
                                                                can use a bold sanserif font with a cursive.</p>
                                                        </div>
                                                    </div>
                                                    <p className="mb-0">
                                                        If you’re using multiple elements, make sure that your principal
                                                        object is larger than the others, as the eye of your viewer will
                                                        automatically be drawn to the larger of the two objects.
                                                    </p>
                                                </TabPane>
                                            </TabContent>
                                        </Col>
                            ...
                            <Card>
                                <div className="card-header align-items-center d-flex">
                                    <div className="flex-grow-1 oveflow-hidden">
                                        <p className="text-muted text-truncates mb-0">Use <code>card-header-tabs</code> class
                                            to create card header tabs.</p>
                                    </div>
                                ...
                                <CardBody>
                                    <TabContent activeTab={cardHeaderTab} className="text-muted">
                                        <TabPane tabId="1" id="home2">
                                            <p className="flex-grow-1 mb-0"><img src={avatar2} alt=""
                                                                                 className="avatar-lg rounded float-start me-3"/>
                                                Food truck fixie locavore, accusamus mcsweeney's marfa nulla
                                                single-origin coffee squid. Exercitation +1 labore velit, blog
                                                sartorial PBR leggings next level wes anderson artisan four loko
                                                farm-to-table craft beer twee. commodo enim craft beer mlkshk aliquip
                                                jean shorts ullamco ad
                                                vinyl cillum PBR. Homo nostrud organic, assumenda labore
                                                aesthetic magna delectus.commodo enim craft beer mlkshk aliquip jean
                                                shorts ullamco ad
                                                vinyl cillum PBR. Homo nostrud organic, assumenda labore
                                                aesthetic magna delectus. If you’re using multiple elements, make sure
                                                that your principal object is larger than assumenda.
                                            </p>
                                        </TabPane>
                                        ...
                                        <TabPane tabId="2" id="profile2">
                                            <p className="me-3 mb-0">
                                                <img src={avatar3} alt=""
                                                     className="avatar-lg rounded float-end ms-3"/> Experiment and play
                                                around with the fonts that you already have in the software you’re
                                                working with reputable font websites. commodo enim craft beer mlkshk
                                                aliquip jean shorts ullamco ad vinyl cillum PBR. Homo nostrud organic,
                                                assumenda labore aesthetic magna delectus.commodo enim craft beer mlkshk
                                                aliquip jean shorts ullamco ad vinyl cillum PBR. Homo nostrud organic,
                                                assumenda labore aesthetic magna delectus Scale all elements of your
                                                design: text, elements, buttons, everything. Increase or decrease the
                                                letter spacing depending on the situation and try, try again until it
                                        ...
                                        <TabPane tabId="3" id="messages2">
                                            <p className="ms-3 mb-0">
                                                <img src={avatar5} alt=""
                                                     className="avatar-lg rounded float-start me-3"/>Trust fund seitan
                                                letterpress, keytar raw denim keffiyeh etsy art party before they sold
                                                out master cleanse gluten-free squid scenester freegan cosby sweater.
                                                Fanny pack portland seitan DIY, art party locavore wolf cliche high life
                                                echo park Austin. Cred vinyl keffiyeh DIY salvia PBR, beer mlkshk
                                                aliquip jean shorts ullamco ad vinyl cillum PBR. Homo nostrud organic,
                                                assumenda labore aes Homo nostrud organic, assumenda labore aesthetic
                                                magna delectus Scale all elements of your design: text, elements,
                                                buttons, everything.Increase or decrease the letter spacing depending on
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>nav-tabs-custom</code> class to create custom
                                        tabs with borders.</p>
                                    <Nav tabs className="nav nav-tabs nav-tabs-custom nav-info nav-justified mb-3">
                                        <NavItem>
                                            <NavLink
                                                style={{cursor: "pointer"}}
                                                className={classnames({
                                        ...
                                        <TabPane tabId="1" id="home1">
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    ...
                                                    <div className="mt-2">
                                                        <Link to="#" className="btn btn-sm btn-soft-primary">Read
                                                            More <i
                                                                className="ri-arrow-right-line ms-1 align-middle"></i></Link>
                                                    </div>
                                                </div>
                                            </div>
                                        ...
                                        <TabPane tabId="4">
                                            ...
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    ...
                                                    dwell in my soul and absorb its power, like the form of a beloved
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>arrow-navtabs </code>class to create arrow nav
                                        tabs.</p>
                                    <Nav pills className="nav nav-pills arrow-navtabs nav-info bg-light mb-3">
                                        <NavItem>
                                            <NavLink
                                                style={{cursor: "pointer"}}
                                                className={classnames({
                                    ...
                                    >
                                        <TabPane tabId="1" id="arrow-overview">
                                            ...
                                            <p className="mb-0">
                                                Contrary to popular belief, you don’t have to work endless nights and
                                                hours to create a <Link to="#" className="text-decoration-underline"><b>Fantastic
                                                Design</b></Link> by using complicated 3D elements. Flat design is your
                                                friend. Remember that. And the great thing about flat design is that it
                                                has become more and more popular over the years, which is excellent news
                                                to the beginner and advanced designer.
                                            </p>
                                        ...
                                        <TabPane tabId="2" id="arrow-profile">
                                            ...
                                            <p className="mb-0">
                                                ...
                                                in <Link to="#" className="text-decoration-underline"><b>Graphic
                                                Design</b></Link> is a must. It’s eye-catching, it makes a statement,
                                                it’s impressive graphic design. Increase or decrease the letter spacing
                                                depending on the situation and try, try again until it looks right, and
                                        ...
                                        <TabPane tabId="3" id="arrow-contact">
                                            ...
                                            <h6>Contact</h6>
                                            <p className="mb-0">
                                                Consistency is the one thing that can take all of the different elements
                                                in your design, and tie them all together and make them work. In an
                                                awareness campaign, it is vital for people to begin put 2 and 2 together
                                                and begin to recognize your cause. Consistency piques people’s interest
                                                is that it has become more and more popular over the years, which is
                                                excellent news to the beginner and advanced <Link to="#"
                                                                                                  className="text-decoration-underline"><b>Contact
                                                Designer</b></Link>.
                                            </p>
                                        </TabPane>
                                    </TabContent>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <div className="card-header align-items-xl-center d-xl-flex">
                                    <p className="text-muted flex-grow-1 mb-xl-0">Use <code>card-header-pills</code> class
                                        to create header justify tab.</p>
                                    <div className="flex-shrink-0">

                                        <Nav pills className="card-header-pills">
                                            <NavItem>
                                                <NavLink style={{cursor: "pointer"}}
                                                         className={classnames({active: headerJustifyTab === "1",})}
                                                         onClick={() => {
                                            ...
                                            <NavItem>
                                                <NavLink style={{cursor: "pointer"}}
                                                         className={classnames({active: headerJustifyTab === "2",})}
                                                         onClick={() => {
                                            ...
                                            <NavItem>
                                                <NavLink style={{cursor: "pointer"}}
                                                         className={classnames({active: headerJustifyTab === "3",})}
                                                         onClick={() => {
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>card-footer-tabs</code> class to create the
                                        bottom card nav justify tab.</p>
                                    <TabContent activeTab={bottomCardTab} className="text-muted">
                                        <TabPane tabId="1" id="bottomtabs-home">
                                            ...
                                            <p className="mb-2">
                                                On the note of consistency, color consistency is a MUST. If you’re not
                                                trying to create crazy contrast in your design, then a great idea would
                                                be for you to use a color palette throughout your entire design. It will
                                                subconsciously interest viewers and also is very pleasing to look at.
                                            </p>
                                            <p className="mb-0">
                                                Any bypasser will stop to see what you have to see, even if your design
                                                has nothing to do with them, for the simple fact that it is beautiful to
                                                look at.
                                            </p>
                                        </TabPane>
                                        ...
                                        <TabPane tabId="2" id="bottomtabs-profile">
                                            ...
                                            <p className="mb-2">
                                                Just like in the image where we talked about using multiple fonts, you
                                                can see that the background in this graphic design is blurred. Whenever
                                                you put text on top of an image, it’s important that your viewers can
                                                understand the text, and sometimes that means applying a gaussian
                                                readable.
                                            </p>
                                            <p className="mb-0">
                                        ...
                                        <TabPane tabId="3" id="bottomtabs-messages">
                                            ...
                                            <p className="mb-2">
                                                Blowzy red vixens fight for a quick jump. Joaquin Phoenix was gazed by
                                                MTV for luck. A wizard’s job is to vex chumps quickly in fog. Watch
                                                "Jeopardy! ", Alex Trebek's fun TV quiz game. Woven silk pyjamas
                                                exchanged for blue quartz. Brawny gods just flocked up to quiz and vex
                                                him.
                                            </p>
                                            <p className="mb-0">
                                                Big July earthquakes confound zany experimental vow. My girl wove six
                                                dozen plaid jackets before she quit. Six big devils from Japan quickly
                                                forgot how to waltz.
                                            </p>
                                        </TabPane>
                                    </TabContent>
                                ...
                                <div className="card-footer bg-transparent border-top">
                                    ...
                                    <Nav pills className="nav-justified card-footer-tabs fs-17">
                                        <NavItem id="home">
                                            <NavLink style={{cursor: "pointer"}}
                                                     className={classnames({active: bottomCardTab === "1",})}
                                                     onClick={() => {
                                                         bottonCardToggle("1");
                                                     }}>
                                            ...
                                            <UncontrolledTooltip placement="top"
                                                                 target="home"> Home </UncontrolledTooltip>
                                        </NavItem>
                                        <NavItem id="profile">
                                            <NavLink style={{cursor: "pointer"}}
                                                     className={classnames({active: bottomCardTab === "2",})}
                                                     onClick={() => {
                                                         bottonCardToggle("2");
                                                     }}>
                                            ...
                                            <UncontrolledTooltip placement="top"
                                                                 target="profile"> Profile </UncontrolledTooltip>
                                        </NavItem>
                                        <NavItem id="messages">
                                            <NavLink style={{cursor: "pointer"}}
                                                     className={classnames({active: bottomCardTab === "3",})}
                                                     onClick={() => {
                                                         bottonCardToggle("3");
                                                     }}>
                                            ...
                                            <UncontrolledTooltip placement="top"
                                                                 target="messages"> Messages </UncontrolledTooltip>
                                        </NavItem>
                                    </Nav>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>custom-hover-nav-tabs</code> class to create
                                        custom hover tabs.</p>
                                </CardBody>
                                            ...
                                            <div className="table-responsive">
                                                <table className="table mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>$745</td>
                                                        <td>4.4 <i
                                                            className="ri-star-s-fill ms-1 text-warning align-middle"></i>
                                                        </td>
                                                    </tr>
                                                    <tr>
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>custom-verti-nav-pills</code> class to create
                                        custom vertical tabs.</p>
                                    <Row>
                                        <Col lg={3}>
                                            <Nav pills
                                            ...
                                            >
                                                <TabPane tabId="1" id="custom-v-pills-home">
                                                    <div className="d-flex mb-4">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            <p className="mb-0">Experiment and play around with the
                                                                fonts that you already have in the software you’re
                                                                working with reputable font websites. commodo enim craft
                                                    ...
                                                    <div className="d-flex">
                                                        <div className="flex-grow-1 me-3">
                                                            <p className="mb-0">Always want to make sure that your fonts
                                                                work well together and try to limit the number of fonts
                                                                you use to three or less. Experiment and play around
                                                                with the fonts that you already have in the software
                                                                you’re working with reputable font websites.</p>
                                                        </div>
                                                        <div className="flex-shrink-0">
                                                ...
                                                <TabPane tabId="2" id="custom-v-pills-profile">
                                                    <div className="d-flex mb-4">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            <p className="mb-0">In some designs, you might adjust your
                                                                tracking to create a certain artistic effect. It can
                                                                also help you fix fonts that are poorly spaced to begin
                                                                with. A wonderful serenity has taken possession of my
                                                    ...
                                                    <div className="d-flex">
                                                        <div className="flex-grow-1 me-3">
                                                            <p className="mb-0">Each design is a new, unique piece of
                                                                art birthed into this world, and while you have the
                                                                opportunity to be creative and make your own style
                                                                choices. For that very reason, I went on a quest and
                                                ...
                                                <TabPane tabId="3" id="custom-v-pills-messages">
                                                    <div className="d-flex mb-4">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            <p className="mb-0">Trust fund seitan letterpress, keytar
                                                                ...
                                                                vinyl keffiyeh DIY salvia PBR.</p>
                                                        </div>
                                                    </div>
                                                    <div className="d-flex">
                                                        <div className="flex-grow-1 me-3">
                                                            <p className="mb-0">They all have something to say beyond
                                                                the words on the page. They can come across as casual or
                                                                neutral, exotic or graphic. That's why it's important to
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>animation-nav</code> class to create animated
                                        tabs.</p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>nav-border-top</code> class to create nav tabs
                                        with border at top.</p>
                                    ...
                                    <Nav tabs className="nav nav-tabs nav-border-top nav-border-top-primary mb-3">
                                        ...
                                        <NavItem>
                                            <NavLink style={{cursor: "pointer"}}
                                                     className={classnames({active: topBorderjustifyTab === "3",})}
                                                     onClick={() => {
                                        ...
                                        <NavItem>
                                            <NavLink style={{cursor: "pointer"}}
                                                     className={classnames({active: topBorderjustifyTab === "4",})}
                                                     onClick={() => {
                                        ...
                                        <TabPane tabId="1" id="nav-border-top-home">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    ...
                                                    keffiyeh DIY salvia PBR.
                                                    <div className="mt-2">
                                                        <Link to="#" className="btn btn-link">Read More <i
                                                            className="ri-arrow-right-line ms-1 align-middle"></i></Link>
                                                    </div>
                                                </div>
                                            </div>
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>nav-border-top nav-justified</code> class to
                                        create nav tabs with border at top with justified tabs position.</p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">*Use <code>nav-custom-</code> class with modifier class to
                                        color tabs.</p>

                                    <Nav pills className="nav-custom-outline nav-primary mb-3">
                                        <NavItem>
                                            <NavLink style={{cursor: "pointer"}}
                                                     className={classnames({active: outlineBorderNav === "1",})}
                                                     onClick={() => {
                                        ...
                                        <NavItem>
                                            <NavLink style={{cursor: "pointer"}}
                                                     className={classnames({active: outlineBorderNav === "2",})}
                                                     onClick={() => {
                                        ...
                                        <NavItem>
                                            <NavLink style={{cursor: "pointer"}}
                                                     className={classnames({active: outlineBorderNav === "3",})}
                                                     onClick={() => {
                                        ...
                                        <NavItem>
                                            <NavLink style={{cursor: "pointer"}}
                                                     className={classnames({active: outlineBorderNav === "4",})}
                                                     onClick={() => {
                                    ...
                                    <TabContent activeTab={outlineBorderNav} className="text-muted">
                                        ...
                                        <TabPane tabId="2" id="border-nav-profile">
                                            <div className="d-flex">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    In some designs, you might adjust your tracking to create a certain
                                                    artistic effect. It can also help
                                        ...
                                        <TabPane tabId="4" id="border-nav-settings">
                                            ...
                                            <div className="d-flex mt-2">
                                                ...
                                                <div className="flex-grow-1 ms-2">
                                                    After gathering lots of different opinions and graphic design
                                                    basics, I came up with a list of 30
                                            ...
                                            <div className="tab-pane active" id="border-navs-home" role="tabpanel">
                                                ...
                                                <div className="d-flex mt-2">
                                                    ...
                                                    <div className="flex-grow-1 ms-2">
                                                        ...
                                                        make things unpleasant for the
                                                        reader. The
                                                        goal is to make your text as comfortable to read as possible.
                                                    </div>
                                                </div>
                    ...
                    <Row>
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    ...
                                    <Nav pills className="nav nav-pills nav-custom nav-custom-info mb-3">
                                        <NavItem>
                                            <NavLink style={{cursor: "pointer"}}
                                        ...
                                        <TabPane tabId="1" id="nav-colored-home">
                                            ...
                                            <div className="d-flex">
                                                <div className="flex-grow-1 me-3">
                                                    For that very reason, I went on a quest and spoke to many different
                                                    professional graphic designers and asked them what graphic design
                                                    tips they live. vinyl cillum PBR. Homo nostrud organic, assumenda
                                        ...
                                        <TabPane tabId="2" id="nav-colored-profile">
                                            <div className="d-flex mb-3">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    ...
                                                    and try, try again until it looks right, and each. next level wes
                                                    anderson artisan four loko farm-to-table craft beer twee. commodo
                                        ...
                                        <TabPane tabId="3" id="nav-colored-messages">
                                            <div className="d-flex mb-3">
                                                ...
                                                <div className="flex-grow-1 ms-3">
                                                    ...
                                                    party before they sold out master cleanse gluten-free squid
                                                    scenester freegan cosby sweater. Fanny pack portland seitan DIY, art
                                                    party locavore wolf cliche high life echo park Austin.
                                                </div>
                                            </div>
                                            <div className="d-flex">
                                                <div className="flex-grow-1 me-3">
                                                    ...
                                                    aes Homo nostrud organic, assumenda labore aesthetic magna elements,
                                                    buttons, everything..
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <img src={avatar1} alt="" className="avatar-md rounded"/>
                        ...
                        <Col xxl={6}>
                            ...
                            <Card>
                                <CardBody>
                                    <p className="text-muted">Use <code>nav-custom-light</code> class to lighten the nav
                                        tabs area.</p>
                                        ...
                                        <TabPane tabId="1" id="nav-light-home">
                                            <div className="d-flex mb-1">
                                                <div className="flex-grow-1 me-3">
                                                    ...
                                                    delectus. pposites attract, and that’s a fact. It’s in our nature to
                                                    be interested in the unusual, and that’s why using contrasting.
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <img src={img4} alt="" width="150" className="rounded"/>
                                                </div>
                                            </div>
                                            <p className="mb-0"> Food truck fixie locavore, accusamus mcsweeney's marfa
                                                nulla
                                                single-origin coffee squid. Exercitation +1 labore velit, blog
                                                sartorial PBR leggings next level wes anderson artisan four loko
                                                farm-to-table craft beer twee. commodo enim craft beer mlkshk aliquip
                                                jean shorts ullamco.</p>
                                        </TabPane>
                                        ...
                                        <TabPane tabId="2" id="nav-light-profile">
                                            <div className="d-flex mb-1">
                                                <div className="flex-grow-1 me-3">
                                                    ...
                                                    viewers can understand the text, and sometimes that means applying a
                                                    gaussian readable Any bypasser will stop to see what you have to
                                                    see, even if your design has nothing to do with them.
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <img src={img5} alt="" width="150" className="rounded"/>
                                                </div>
                                            </div>
                                            <p className="mb-0">It makes a statement, it’s impressive graphic design.
                                                Increase or decrease the letter spacing depending on the situation and
                                                try, try again until it looks right, and each letter has the perfect
                                                spot of its own. commodo enim craft beer mlkshk aliquip jean shorts
                                                ullamco.</p>
                                        </TabPane>
                                        ...
                                        <TabPane tabId="3" id="nav-colored-messages">
                                            <div className="d-flex mb-1">
                                                <div className="flex-grow-1 me-3">
                                                    ...
                                                    party before they sold out master cleanse gluten-free squid
                                                    scenester freegan cosby sweater. Fanny pack portland seitan DIY, art
                                                    party locavore wolf cliche high life echo park Austin On the note of
                                                    consistency, color consistency is a MUST. If you’re not trying to
                                                    create crazy contrast in your design.
                                                </div>
                                                <div className="flex-shrink-0">
                                                    <img src={img5} alt="" width="150" className="rounded"/>
                                                </div>
                                            </div>
                                            <p className="mb-0">Big July earthquakes confound zany experimental vow. My
                                                girl wove six dozen plaid jackets before she quit. Six big devils from
                                                Japan quickly forgot how to waltz. try again until it looks right, and
