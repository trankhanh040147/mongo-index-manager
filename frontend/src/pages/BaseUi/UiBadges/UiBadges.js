...
const UiBadges = () => {
    document.title = "Badges | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent/>
                    ...
                    <Row>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code> bg-*-subtle text-*</code> class with the
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>border, border-* text-*</code> class with
                                        the below-mentioned variation to create a badge with the outline.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <span className="badge border border-primary text-primary">Primary</span>
                                            <span
                                                className="badge border border-secondary text-secondary">Secondary</span>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>rounded-pill</code> class to make badges
                                        more rounded
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Use the <code> rounded-pill bg-*-subtle
                                        text-* </code> class with the below-mentioned variation
                                        to create a badge more rounded with a soft background.</p>
                                    <div className="live-preview">

                                        <div className="d-flex flex-wrap gap-2">
                                            <span
                                                className="badge rounded-pill bg-primary-subtle text-primary">Primary</span>
                                            <span
                                                className="badge rounded-pill bg-secondary-subtle text-secondary">Secondary</span>
                                            <span
                                                className="badge rounded-pill bg-success-subtle text-success">Success</span>
                                            <span className="badge rounded-pill bg-info-subtle text-info">Info</span>
                                            <span
                                                className="badge rounded-pill bg-warning-subtle text-warning">Warning</span>
                                            <span
                                                className="badge rounded-pill bg-danger-subtle text-danger">Danger</span>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <div className="d-flex flex-wrap gap-2">
                                            <span
                                                className="badge bg-primary-subtle text-primary badge-border">Primary</span>
                                            <span
                                                className="badge bg-secondary-subtle text-secondary badge-border">Secondary</span>
                                            <span
                                                className="badge bg-success-subtle text-success badge-border">Success</span>
                                            <span
                                                className="badge bg-danger-subtle text-danger badge-border">Danger</span>
                                            <span
                                                className="badge bg-warning-subtle text-warning badge-border">Warning</span>
                                            ...
                                            <span
                                                className="badge bg-light-subtle text-body badge-border text-body">Light</span>
                                        </div>
                                    </div>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        Use the <code> rounded-pill border, border-* text-* </code> class with the
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <span
                                                className="badge rounded-pill border border-primary text-primary">Primary</span>
                                            <span
                                                className="badge rounded-pill border border-secondary text-secondary">Secondary</span>
                                            <span
                                                className="badge rounded-pill border border-success text-success">Success</span>
                                            <span
                                                className="badge rounded-pill border border-info text-info">Info</span>
                                            <span
                                                className="badge rounded-pill border border-warning text-warning">Warning</span>
                                            <span
                                                className="badge rounded-pill border border-danger text-danger">Danger</span>
                                            <span
                                                className="badge rounded-pill border border-dark text-body">Dark</span>
                                            <span
                                                className="badge rounded-pill border border-light text-body text-body">Light</span>
                                        </div>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Badge color="primary" className="badge-label"> <i
                                                className="mdi mdi-circle-medium"></i> Primary </Badge>
                                            <Badge color="secondary" className="badge-label"> <i
                                                className="mdi mdi-circle-medium"></i> Secondary </Badge>
                                            <Badge color="success" className="badge-label"> <i
                                                className="mdi mdi-circle-medium"></i> Success </Badge>
                                            <Badge color="danger" className="badge-label"> <i
                                                className="mdi mdi-circle-medium"></i> Danger </Badge>
                                            <Badge color="warning" className="badge-label"> <i
                                                className="mdi mdi-circle-medium"></i> Warning </Badge>
                                            <Badge color="info" className="badge-label"> <i
                                                className="mdi mdi-circle-medium"></i> Info </Badge>
                                            <Badge color="dark" className="badge-label"> <i
                                                className="mdi mdi-circle-medium"></i> Dark </Badge>
                                            <Badge color="light" className="badge-label text-body"> <i
                                                className="mdi mdi-circle-medium"></i> Light </Badge>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                        <pre className="language-markup" style={{height: "200px"}}>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the below utilities to modify a badge and position it
                                        in the corner of a link or button.</p>
                                    <div className="live-preview">
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Badges can be used as part of buttons to provide a
                                        counter.</p>
