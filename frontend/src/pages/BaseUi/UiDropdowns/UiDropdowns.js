...
const UiDropdowns = () => {
    document.title = "Dropdowns | DRManager - React Admin & Dashboard Template";
    // Default Tabs
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-</code> class with below mentioned variation
                                        to color dropdown toggle.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonGroup>
                                                <UncontrolledDropdown>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>divider</code> attribute to DropdownItem to
                                        create split button dropdowns as a single button dropdown. </p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonGroup>
                                                <UncontrolledButtonDropdown>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-lg</code> class to create a large size
                                        dropdown button and <code>btn-sm</code> to create a small size dropdown button.
                                    </p>
                                    <div className="live-preview">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>dropdown-menu-dark</code> class onto an existing
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Dropdown demo with various <code>dropdown
                                        alignment</code> options.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonGroup>
                                                <UncontrolledDropdown>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>data-bs-offset</code> or <code>data-bs-reference</code> to
                                        change the position of the dropdown.</p>
                                        ...
                                        <div className="d-flex flex-wrap gap-3">
                                            ...
                                            <ButtonGroup>
                                                <UncontrolledButtonDropdown>
                                                    ...
                                                    <DropdownToggle tag="button" className="btn btn-secondary"
                                                                    id="dropdownMenuReference" split>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">By default, the dropdown menu is closed when clicking
                                        inside or outside the dropdown menu. You can use
                                        the <code>autoClose</code> option to change this behavior of the dropdown.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-3">
                                            <ButtonGroup>
                                                <UncontrolledDropdown>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            <Col xxl={3}>
                                                <div>
                                                    <h6 className="font-size-13 mb-3">Dropdown Menu Success link
                                                        example</h6>
                                                    <div className="clearfix">
                                                        <div
                                                            ...
                                                            <Link to="#" className="dropdown-item active">Something else
                                                                here</Link>
                                            ...
                                            <Col lg={9}>
                                                <div className="mt-lg-0 mt-3">
                                                    <h6 className="font-size-13 mb-0">Dropdown Menu link Color
                                                        example</h6>
                                                    <div>
                                                        <Row>
                                                            <Col lg={4} sm={6}>
                                                                <div className="mt-3">
                                                                    <p className="font-size-13 mb-2">Dropdown menu
                                                                        Primary link</p>
                                                                    <ButtonGroup>
                                                                        <UncontrolledDropdown>
                                                                            ...
                                                                            <DropdownMenu
                                                                                className="dropdownmenu-primary">
                                                                                <DropdownItem>Action</DropdownItem>
                                                                                <DropdownItem>Another
                                                                                    action</DropdownItem>
                                                                                <DropdownItem>Something else
                                                                                    here</DropdownItem>
                                                                                <DropdownItem divider/>
                                                                ...
                                                                <div className="mt-3">
                                                                    ...
                                                                    <ButtonGroup>
                                                                        <UncontrolledDropdown>
                                                                            ...
                                                                            <DropdownMenu
                                                                                className="dropdownmenu-secondary">
                                                                                <DropdownItem>Action</DropdownItem>
                                                                                <DropdownItem>Another
                                                                                    action</DropdownItem>
                                                                                <DropdownItem>Something else
                                                                ...
                                                                <div className="mt-3">
                                                                    ...
                                                                    <ButtonGroup>
                                                                        <UncontrolledDropdown>
                                                                            ...
                                                                            <DropdownMenu
                                                                                className="dropdownmenu-success">
                                                                                <DropdownItem>Action</DropdownItem>
                                                                                <DropdownItem>Another
                                                                                    action</DropdownItem>
                                                                                <DropdownItem>Something else
                                                                ...
                                                                <div className="mt-3">
                                                                    ...
                                                                    <ButtonGroup>
                                                                        <UncontrolledDropdown>
                                                                            ...
                                                                            <DropdownMenu
                                                                                className="dropdownmenu-warning">
                                                                                <DropdownItem>Action</DropdownItem>
                                                                                <DropdownItem>Another
                                                                                    action</DropdownItem>
                                                                                <DropdownItem>Something else
                                                            ...
                                                            <Col lg={4} sm={6}>
                                                                <div className="mt-3">
                                                                    <p className="font-size-13 mb-2">Dropdown menu Info
                                                                        link</p>
                                                                    <ButtonGroup>
                                                                        <UncontrolledDropdown>
                                                                            <DropdownToggle tag="button"
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Example of dropdown menu containing <code>Headers, Text
                                        and Forms</code> content.</p>
                                    <div className="live-preview">
                                                ...
                                                <UncontrolledDropdown>
                                                    ...
                                                    <DropdownMenu>
                                                        <div className="dropdown-header noti-title">
                                                            <h5 className="font-size-13 text-muted text-truncate mb-0">Welcome
                                                                Jessie!</h5>
                                                        </div>
                                                        <DropdownItem>Action</DropdownItem>
                                                        <DropdownItem>Another action</DropdownItem>
                                                        ...
                                                        <form>
                                                            <div className="mb-2">
                                                                <label className="form-label"
                                                                       htmlFor="exampleDropdownFormEmail">Email
                                                                    address</label>
                                                            ...
                                                            <div className="mb-2">
                                                                <div className="form-check custom-checkbox">
                                                                    ...
                                                                    <label className="form-check-label"
                                                                           htmlFor="rememberdropdownCheck">Remember
                                                                        me</label>
                                                                </div>
                                                            </div>
                                        ...
                                        <Row className="g-3">
                                                    ...
                                                    <TabContent activeTab={activeTab} id="notificationItemsTabContent4">
                                                            ...
                                                            <SimpleBar style={{maxHeight: "300px"}} className="pe-2">
                                                                    ...
                                                                    <div className="d-flex">
                                                                        ...
                                                                        <div className="flex-grow-1">
                                                                            ...
                                                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                                                <span><i
                                                                                    className="mdi mdi-clock-outline"></i> Just 30 sec ago</span>
                                                                            </p>
                                                                        </div>
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div className="d-flex">
                                                                        ...
                                                                        <div className="flex-grow-1">
                                                                            <Link to="#"><h6
                                                                                className="mt-0 mb-1 fs-13 fw-semibold">Angela
                                                                                Bernier</h6></Link>
                                                                            <div className="fs-13 text-muted">
                                                                                <p className="mb-1">Answered to your
                                                                                    comment on the cash flow forecast's
                                                                                    graph 🔔.</p>
                                                                            </div>
                                                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                                                <span><i
                                                                                    className="mdi mdi-clock-outline"></i> 48 min ago</span>
                                                                            </p>
                                                                        </div>
                                                                        <div className="px-2 fs-16">
                                                                            <Input className="form-check-input"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div className="d-flex">
                                                                        ...
                                                                        <div className="flex-grow-1">
                                                                            <h6 className="mt-0 mb-2 fs-13 lh-base">You
                                                                                have received <b
                                                                                    className="text-success">20</b> new
                                                                                messages in the conversation</h6>
                                                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                                                <span><i
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div className="d-flex">
                                                                        ...
                                                                        <div className="flex-grow-1">
                                                                            <Link to="#"><h6
                                                                                className="mt-0 mb-1 fs-13 fw-semibold">Maureen
                                                                                Gibson</h6></Link>
                                                                            <div className="fs-13 text-muted">
                                                                                <p className="mb-1">We talked about a
                                                                                    project on linkedin.</p>
                                                                            </div>
                                                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                                                <span><i
                                                                                    className="mdi mdi-clock-outline"></i> 4 hrs ago</span>
                                                                            </p>
                                                                        </div>
                                                                        <div className="px-2 fs-16">
                                                                            <Input className="form-check-input"
                                                            ...
                                                            <SimpleBar style={{maxHeight: "300px"}} className="pe-2">
                                                                <div
                                                                    ...
                                                                    <div className="d-flex">
                                                                        ...
                                                                        <div className="flex-grow-1">
                                                                            <Link to="#"><h6
                                                                                className="mt-0 mb-1 fs-13 fw-semibold">James
                                                                                Lemire</h6></Link>
                                                                            <div className="fs-13 text-muted">
                                                                                <p className="mb-1">We talked about a
                                                                                    project on linkedin.</p>
                                                                            ...
                                                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                                                <span><i
                                                                                    className="mdi mdi-clock-outline"></i> 30 min ago</span>
                                                                            </p>
                                                                        </div>
                                                                        <div className="px-2 fs-16">
                                                                            <Input className="form-check-input"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div className="d-flex">
                                                                        ...
                                                                        <div className="flex-grow-1">
                                                                            <Link to="#"><h6
                                                                                className="mt-0 mb-1 fs-13 fw-semibold">Kenneth
                                                                                Brown</h6></Link>
                                                                            <div className="fs-13 text-muted">
                                                                                <p className="mb-1">Mentionned you in
                                                                                    his comment on 📃 invoice #12501.</p>
                                                                            </div>
                                                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                                                <span><i
                                                                                    className="mdi mdi-clock-outline"></i> 10 hrs ago</span>
                                                                            </p>
                                                                        </div>
                                                                        <div className="px-2 fs-16">
                                                                            <Input className="form-check-input"
                                                                ...
                                                                <div
                                                                    ...
                                                                    <div className="d-flex">
                                                                        ...
                                                                        <div className="flex-grow-1">
                                                                            ...
                                                                            <p className="mb-0 fs-11 fw-medium text-uppercase text-muted">
                                                                                <span><i
                                                                                    className="mdi mdi-clock-outline"></i> 3 days ago</span>
                                                                            </p>
                                                                        </div>
                                                                        <div className="px-2 fs-16">
                                                                            <Input className="form-check-input"
                                                        ...
                                                        <TabPane tabId="3" id="alerts-tab1" className="p-4">
                                                            ...
                                                            <div className="text-center pb-5 mt-2">
                                                                <h6 className="fs-18 fw-semibold lh-base">Hey! You have
                                                                    no any notifications </h6>
                                                            </div>
                                                        </TabPane>
                                                    </TabContent>
                                                </div>
                                            ...
                                            <Col xxl={3} lg={5} md={6}>
                                                <div
                                                    ...
                                                    <div className="dropdown-head bg-success bg-pattern rounded-top">
                                                        ...
                                                        <div className="px-2 pt-2">
                                                            <Nav tabs className="dropdown-tabs nav-tabs-custom">
                                                                <NavItem>
                                                                    <NavLink style={{cursor: "pointer"}}
                                                                             className={classnames({active: NotificationTab === "1",})}
                                                                             onClick={() => {
                                                                ...
                                                                <NavItem>
                                                                    <NavLink style={{cursor: "pointer"}}
                                                                             className={classnames({active: NotificationTab === "2",})}
                                                                             onClick={() => {
                                                                ...
                                                                <NavItem>
                                                                    <NavLink style={{cursor: "pointer"}}
                                                                             className={classnames({active: NotificationTab === "3",})}
                                                                             onClick={() => {
                                                    ...
                                                    <TabContent activeTab={NotificationTab}
                                                            ...
                                                            <SimpleBar style={{maxHeight: "300px"}} className="pe-2">
                                                                ...
                                                                <div className="my-3 text-center">
                                                                    <Button color="success"
                                                                            className="btn btn-soft-success">View All
                                                                        Notifications <i
                                            ...
                                            <Col xxl={3} lg={5} md={6}>
                                                <div
                                                    ...
                                                    <div className="dropdown-head bg-secondary bg-pattern rounded-top">
                                                        ...
                                                        <div className="px-2 pt-2">
                                                            <Nav tabs className="dropdown-tabs nav-tabs-custom">
                                                                <NavItem>
                                                                    <NavLink style={{cursor: "pointer"}}
                                                                             className={classnames({active: Notification1Tab === "1",})}
                                                                             onClick={() => {
                                                                ...
                                                                <NavItem>
                                                                    <NavLink style={{cursor: "pointer"}}
                                                                             className={classnames({active: Notification1Tab === "2",})}
                                                                             onClick={() => {
                                                                ...
                                                                <NavItem>
                                                                    <NavLink style={{cursor: "pointer"}}
                                                                             className={classnames({active: Notification1Tab === "3",})}
                                                                             onClick={() => {
                                                    ...
                                                    <TabContent activeTab={Notification1Tab}
