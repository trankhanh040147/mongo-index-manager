...
const UiUtilities = () => {
    document.title = "Utilities | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent/>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Use border utilities to add or remove an element’s
                                        borders.
                                        ...
                                        <div>
                                            ...
                                            <div className="mt-4">
                                                ...
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    ...
                                                    <div className="text-center">
                                                        <div
                                                            className="border border-info avatar-md bg-light mx-auto mb-1">
                                                        </div>
                                                    ...
                                                    <div className="text-center">
                                                        <div
                                                            className="border border-dark avatar-md bg-light mx-auto mb-1">
                                                        </div>
                                            ...
                                            <div className="mt-4">
                                                ...
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    <div className="text-center">
                                                        <div
                                                            className="border border-success border-opacity-10 avatar-md bg-light mx-auto mb-1"></div>
                                                        <p><code>.border-opacity-10</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <div
                                                            className="border border-success border-opacity-25 avatar-md bg-light mx-auto mb-1"></div>
                                                        <p><code>.border-opacity-25</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <div
                                                            className="border border-success border-opacity-50 avatar-md bg-light mx-auto mb-1"></div>
                                                        <p><code>.border-opacity-50</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <div
                                                            className="border border-success border-opacity-75 avatar-md bg-light mx-auto mb-1"></div>
                                                        <p><code>.border-opacity-75</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <div
                                                            className="border border-success border-opacity-100 avatar-md bg-light mx-auto mb-1"></div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use below-mentioned class to an element to easily round
                                        its
                                        corners.</p>
                                    <div className="live-preview">
                                        <div>
                                            ...
                                            <div>
                                                ...
                                                <div className="d-flex align-items-start flex-wrap gap-4">
                                                    ...
                                                    <div className="text-center">
                                                        <img src={avatar1} className="avatar-md rounded-4"
                                                             alt="rounded-4"/>
                                                        <p><code>.rounded-4</code></p>
                                                    </div>
                                                    <div className="text-center">
                                                        <img src={avatar1} className="avatar-md rounded-5"
                                                             alt="rounded-5"/>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use below-mentioned class to an element to display the
                                        value
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the below-mentioned class to an element to custom
                                        display
                                        ...
                                        <div>
                                            <div className="table-responsive">
                                                <table className="table table-bordered mb-0">
                                                    ...
                                                    <tbody>
                                                    <tr>
                                                        <td>font-family: 'Outfit', sans-serif;</td>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted mb-3">Use <code>vstack</code> class to create vertical
                                        layouts.
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            ...
                                            <p className="user-select-auto">This paragraph has default select
                                                behavior.</p>
                                            <p className="user-select-none mb-0">This paragraph will not be selectable
                                                when
                                                clicked by the user.</p>
                                        </div>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            <p><Link to="#" className="text-success pe-none" tabIndex="-1">This
                                                link</Link> can
                                                not be clicked.</p>
                                            <p><Link to="#" className="text-success pe-auto">This link</Link> can be
                                                clicked
                                                (this is default behavior).</p>
                                            <p className="pe-none mb-0"><Link to="#" className="text-success"
                                                                              tabIndex="-1">This
                                                link</Link> can not be clicked because the <code>pointer-events</code>
                                                property is inherited from its parent. However, <Link to="#"
                                                                                                      className="pe-auto">this
                                                    link</Link> has a <code>pe-auto</code> class and
                                                can be clicked.</p>
                                        </div>
                                    </div>
