...
const UiButtons = () => {
    document.title = "Buttons | DRManager - React Admin & Dashboard Template";
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>Button</code> tag to show the default button
                                        style.</p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>outline</code> atrribute with the
                                        below-mentioned variation to create a button with the outline.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use the <code>rounded-pill </code>class to make a rounded
                                        button.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-soft-</code> class with the below-mentioned
                                        variation to create a button with the soft background.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <button className="btn btn-soft-primary waves-effect waves-light"> Primary
                                            </button>
                                            <button
                                                className="btn btn-soft-secondary waves-effect waves-light"> Secondary
                                            </button>
                                            <button className="btn btn-soft-success waves-effect waves-light"> Success
                                            </button>
                                            <button className="btn btn-soft-info waves-effect waves-light"> Info
                                            </button>
                                            <button className="btn btn-soft-warning waves-effect waves-light"> Warning
                                            </button>
                                            <button className="btn btn-soft-danger waves-effect waves-light"> Danger
                                            </button>
                                            <button className="btn btn-soft-dark waves-effect waves-light"> Dark
                                            </button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-ghost-</code> class with the below-mentioned
                                        variation to create a button with the transparent background.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Button color="primary" outline
                                                    className="btn btn-ghost-primary">Primary</Button>
                                            <Button color="secondary" outline
                                                    className="btn btn-ghost-secondary">Secondary</Button>
                                            <Button color="success" outline
                                                    className="btn btn-ghost-success">Success</Button>
                                            <Button color="info" outline className="btn btn-ghost-info">Info</Button>
                                            <Button color="warning" outline
                                                    className="btn btn-ghost-warning">Warning</Button>
                                            <Button color="danger" outline
                                                    className="btn btn-ghost-danger">Danger</Button>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>bg-gradient </code>class to create a gradient
                                        button.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>bg-animation </code>class to create an animated
                                        button.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                                            <Button color="primary" className="btn-animation" data-text="Primary">
                                                <span>Primary</span> </Button>
                                            <Button color="secondary" className="btn-animation" data-text="Secondary">
                                                <span>Secondary</span> </Button>
                                            <Button color="success" className="btn-animation" data-text="Success">
                                                <span>Success</span> </Button>
                                            <Button color="info" className="btn-animation" data-text="Info">
                                                <span>Info</span> </Button>
                                            <Button color="warning" className="btn-animation" data-text="Warning">
                                                <span>Warning</span> </Button>
                                            <Button color="danger" className="btn-animation" data-text="Danger">
                                                <span>Danger</span> </Button>
                                            <Button color="dark" className="btn-animation" data-text="Dark">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-label </code>class to create a button with
                                        the label.</p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col lg={4}>
                                                <div className="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                                    <Button color="primary" className="btn-label"> <i
                                                        className="ri-user-smile-line label-icon align-middle fs-16 me-2"></i> Primary
                                                    </Button>
                                                    <Button color="success" className="btn-label"> <i
                                                        className="ri-check-double-line label-icon align-middle fs-16 me-2"></i> Success
                                                    </Button>
                                                    <Button color="warning" className="btn-label"> <i
                                                        className="ri-error-warning-line label-icon align-middle fs-16 me-2"></i> Warning
                                                    </Button>
                                                </div>
                                            </Col>
                                            <Col lg={4}>
                                                <div className="d-flex flex-wrap gap-2 mb-3 mb-lg-0">
                                                    <Button color="primary" className="btn-label rounded-pill"> <i
                                                        className="ri-user-smile-line label-icon align-middle rounded-pill fs-16 me-2"></i> Primary
                                                    </Button>
                                                    <Button color="success" className="btn-label rounded-pill"> <i
                                                        className="ri-check-double-line label-icon align-middle rounded-pill fs-16 me-2"></i> Success
                                                    </Button>
                                                    <Button color="warning" className="btn-label rounded-pill"> <i
                                                        className="ri-error-warning-line label-icon align-middle rounded-pill fs-16 me-2"></i> Warning
                                                    </Button>
                                                </div>
                                            </Col>
                                            <Col lg={4}>
                                                <div className="d-flex flex-wrap gap-2">
                                                    <Button color="primary" className="btn-label right"> <i
                                                        className="ri-user-smile-line label-icon align-middle fs-16 ms-2"></i> Primary
                                                    </Button>
                                                    <Button color="success" className="btn-label right rounded-pill"> <i
                                                        className="ri-check-double-line label-icon align-middle rounded-pill fs-16 ms-2"></i> Success
                                                    </Button>
                                                </div>
                                            </Col>
                                        </Row>
                                    ...
                                    <div className="live-preview">
                                        <Row>
                                            ...
                                            <Col lg={6}>
                                                <div className="hstack flex-wrap gap-2 mb-3 mb-lg-0">
                                                    <Button color="primary" outline
                                                            className="btn-border">Primary</Button>
                                                    <Button color="secondary" outline
                                                            className="btn-border">Secondary</Button>
                                                    <Button color="success" outline
                                                            className="btn-border">Success</Button>
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="d-flex flex-wrap align-items-center gap-2">
                                                    <Button color='primary' className="custom-toggle active"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on"><i
                                                            className="ri-alarm-line align-bottom"></i> Active</span>
                                                        <span className="icon-off">Unactive</span>
                                                    </Button>
                                                    <Button color='secondary' className="custom-toggle active"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on"><i
                                                            className="ri-user-add-line align-bottom me-1"></i> Connect</span>
                                                        <span className="icon-off"><i
                                                            className="ri-check-fill align-bottom me-1"></i> Unconnect</span>
                                                    </Button>
                                                    <Button color='success' className="custom-toggle"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on"><i
                                                            className="ri-thumb-up-line align-bottom me-1"></i> Yes</span>
                                                        <span className="icon-off"><i
                                                            className="ri-thumb-down-line align-bottom me-1"></i> No</span>
                                                    </Button>
                                                    <Button color='warning' className="custom-toggle active"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on"><i
                                                            className="ri-add-line align-bottom me-1"></i> Follow</span>
                                                        <span className="icon-off"><i
                                                            className="ri-user-unfollow-line align-bottom me-1"></i> Unfollow</span>
                                                    </Button>
                                                    <Button color='danger' className="custom-toggle"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on">On</span>
                                                        <span className="icon-off">Off</span>
                                                    </Button>
                                                    <Button color='dark' className="custom-toggle"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on"><i
                                                            className="ri-bookmark-line align-bottom me-1"></i> Bookmark</span>
                                                        <span className="icon-off"><i
                                                            className="ri-bookmark-3-fill align-bottom me-1"></i> Unbookmark</span>
                                                    </Button>
                                                </div>
                                            </Col>
                                            <Col lg={6}>
                                                <div className="d-flex flex-wrap align-items-center gap-2">
                                                    <Button color="primary" outline className="custom-toggle"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on">Active</span>
                                                        <span className="icon-off">Unactive</span>
                                                    </Button>
                                                    <Button color="secondary" outline className="custom-toggle"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on"><i
                                                            className="ri-add-line align-bottom me-1"></i> Follow</span>
                                                        <span className="icon-off"><i
                                                    ...
                                                    <Button color="success" outline className="custom-toggle active"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on">On</span>
                                                        <span className="icon-off">Off</span>
                                                    </Button>
                                                    <Button color="warning" outline className="custom-toggle active"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                    ...
                                                    <Button color="dark" outline className="custom-toggle active"
                                                            onClick={(e) => favouriteBtn(e.target)}>
                                                        <span className="icon-on"><i
                                                            className="ri-bookmark-line align-bottom"></i></span>
                                                        <span className="icon-off"><i
                                                            className="ri-bookmark-3-fill align-bottom"></i></span>
                                                    </Button>
                                                </div>
                                            </Col>
                                        </Row>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-lg</code> class to create a large size
                                        button and <code>btn-sm</code> class to create a small size button.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap align-items-center gap-2">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>w-xs,w-sm,w-md,w-lg</code> class to make
                                        different sized buttons respectively.</p>
                                    <div className="live-preview">
                                        <div className="d-flex flex-wrap gap-2">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn</code> class with different HTML elements.
                                        ...
                                        <div className="d-flex flex-wrap align-items-center gap-2">
                                            <ButtonGroup>
                                                <Input type="checkbox" className="btn-check" id="btncheck1"
                                                       defaultChecked=""/>
                                                <Button color="primary" className="mb-0" id="btncheck1"> Checkbox
                                                    1 </Button>

                                                <Input type="checkbox" className="btn-check" id="btncheck2"/>
                                                <Button color="primary" className="mb-0" id="btncheck2"> Checkbox
                                                    2 </Button>

                                                <Input type="checkbox" className="btn-check" id="btncheck3"/>
                                                <Button color="primary" className="mb-0" id="btncheck3"> Checkbox
                                                    3 </Button>
                                            </ButtonGroup>
                                            ...
                                            <ButtonGroup>
                                                <Input type="radio" className="btn-check" name="btnradio" id="btnradio1"
                                                       defaultChecked=""/>
                                                <Button color="secondary" className="mb-0" id="btnradio1" outline> Radio
                                                    1 </Button>

                                                <Input type="radio" className="btn-check" name="btnradio"
                                                       id="btnradio2"/>
                                                <Button color="secondary" className="mb-0" id="btnradio2" outline> Radio
                                                    2 </Button>

                                                <Input type="radio" className="btn-check" name="btnradio"
                                                       id="btnradio3"/>
                                                <Button color="secondary" className="mb-0" id="btnradio3" outline> Radio
                                                    3 </Button>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Use the <code>btn-group </code> class in the parent class
                                        to wrap a series of buttons.</p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col sm={6}>
                                                <ButtonGroup>
                                            ...
                                            <Col sm={6}>
                                                <ButtonGroup className="mt-4 mt-sm-0">
                                                    <Button color="light" className="btn-icon"> <i
                                                        className="ri-align-right"/> </Button>
                                                    <Button color="light" className="btn-icon"> <i
                                                        className="ri-align-center"/> </Button>
                                                    <Button color="light" className="btn-icon"> <i
                                                        className="ri-align-left"/> </Button>
                                                </ButtonGroup>
                                            </Col>
                                        </Row>
                                    </div>
                                        ...
                                        <Row>
                                            <Col sm={6}>
                                                <div className="hstack gap-2 ">
                                                    <Button color="primary" className="btn-icon"> <i
                                                        className="ri-map-pin-line"/> </Button>
                                                    <Button color="danger" className="btn-icon"> <i
                                                        className="ri-delete-bin-5-line"/> </Button>
                                                    <Button color="success" className="btn-icon"> <i
                                                        className="ri-check-double-line"/> </Button>
                                                    <Button color="light" className="btn-icon"> <i
                                                        className="ri-brush-2-fill"/> </Button>
                                                </div>
                                            </Col>
                                            <Col sm={6}>
                                                <div className="hstack gap-2 mt-4 mt-sm-0">
                                                    <Button color="primary" className="btn-icon" outline> <i
                                                        className="ri-24-hours-fill"/> </Button>
                                                    <Button color="danger" className="btn-icon" outline> <i
                                                        className="ri-customer-service-2-line"/> </Button>
                                                    <Button color="success" className="btn-icon" outline> <i
                                                        className="ri-mail-send-line"/> </Button>
                                                    <Button color="warning" className="btn-icon" outline> <i
                                                        className="ri-menu-2-line"/> </Button>
                                                </div>
                                            </Col>
                                        </Row>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-toolbar</code> class to combine sets of
                                        button groups into more complex components.</p>
                                    <div className="live-preview">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>btn-group-</code> class with the below-mentioned
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Make a set of buttons
                                        appear <code>vertically</code> stacked .Split button dropdowns are not supported
                                        here.</p>
                                    <div className="live-preview">
                                        <Row>
                                            ...
                                            <div className="col-auto">
                                                <ButtonGroup vertical>
                                                    <Input type="radio" className="btn-check" name="vbtn"
                                                           id="vbtn-radio1" defaultChecked=""/>
                                                    <Button color="secondary" htmlFor="vbtn-radio1" outline>Radio
                                                        1</Button>
                                                    <Input type="radio" className="btn-check" name="vbtn"
                                                           id="vbtn-radio2"/>
                                                    <Button color="secondary" htmlFor="vbtn-radio2" outline>Radio
                                                        2</Button>
                                                    <Input type="radio" className="btn-check" name="vbtn"
                                                           id="vbtn-radio3"/>
                                                    <Button color="secondary" htmlFor="vbtn-radio3" outline>Radio
                                                        3</Button>
                                                </ButtonGroup>
                                            </div>
                                        </Row>
                                ...
                                <CardBody>
                                    ...
                                    <div className="d-flex gap-3">
                                        ...
                                        <Link href="#!"
                                              className="d-inline-flex focus-ring py-1 px-2 text-decoration-none border rounded-2"
                                              style={{
                                                  '--vz-focus-ring-x': '10px',
                                                  '--vz-focus-ring-y': '10px',
                                                  '--vz-focus-ring-blur': '4px',
                                              }}>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">In addition to <code>.focus-ring</code>, we have
                                        ...
                                        defaults. Modify the color with any of our <Link href="/ui-colors">theme
                                            colors</Link>. Note that the light and dark variants may not be visible on
                                        all background colors given current color mode support.</p>
                                    <div className="live-preview">
                                        <Row>
                                            <Col lg={6}>
                                                <p><Link href="#!"
                                                         className="d-inline-flex focus-ring focus-ring-primary py-1 px-2 text-decoration-none border rounded-2">Primary
                                                    focus</Link></p>
                                                <p><Link href="#!"
                                                         className="d-inline-flex focus-ring focus-ring-secondary py-1 px-2 text-decoration-none border rounded-2">Secondary
                                                    focus</Link></p>
                                                <p><Link href="#!"
