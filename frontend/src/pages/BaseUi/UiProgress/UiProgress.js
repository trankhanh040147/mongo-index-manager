...
const UiProgress = () => {
    document.title = "Progress | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent/>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Use <code>color="Required Color"</code> attribute to
                                        progress bar class with the below-mentioned color variation to set the
                                        background color progress bar.</p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Add labels to your progress bars by placing text within
                                        the progress-bar.</p>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Multiple bar color to change the appearance of individual
                                        progress bars.</p>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Use <code>progress-sm</code>, <code>progress-lg</code>,
                                        or <code>progress-xl</code> class to set the different heights of progress.</p>
                                    <div className="live-preview">
                                        <div className="mb-4">
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Use <code>striped</code> attribute to add strip to the
                                        progress.</p>
                                    <div className="live-preview">
                                        <div className="mb-4">
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Use <code>striped animated</code> attribute to add strip
                                        with animation to the progress.</p>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">Use <code>bg-gradient</code> class to show gradient
                                        progress bar.</p>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>animated-progess</code> class to show progress
                                        with animation.</p>
                                    <div className="live-preview">
                                        <div className="mb-4">
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>animated-progress custom-progess </code> class
                                        to show custom progress with animation.</p>
                                    <div className="live-preview">
                                        <div className="mb-4">
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>animated-progress custom-progess
                                        progress-label</code> class to show custom progress with animation and label.
                                    </p>
                                    <div className="live-preview">
                                        <div className="d-flex align-items-center pb-2 mt-4">
                                            <div className="flex-shrink-0 me-3">
                                                <div className="avatar-xs">
                                                    <div
                                                        className="avatar-title bg-light rounded-circle text-muted fs-16">
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted pb-2">Example of progress with content wrapped in
                                        progress.</p>
                                    ...
                                    <div className="live-preview">
                                        ...
                                        <Card className="bg-light overflow-hidden shadow-none">
                                            <CardBody>
                                                <div className="d-flex">
                                                    <div className="flex-grow-1">
                                                        <h6 className="mb-0"><b
                                                            className="text-secondary">30%</b> Update in
                                                            progress...</h6>
                                                    </div>
                                            ...
                                            <div>
                                                <Progress value={30} color="info"
                                                          className="bg-secondary-subtle rounded-0"/>
                                            </div>
                                        </Card>
                                        ...
                                        <Card className="bg-light overflow-hidden shadow-none">
                                            <CardBody>
                                                <div className="d-flex">
                                                    <div className="flex-grow-1">
                                                        <h6 className="mb-0"><b className="text-success">60%</b> Update
                                                            in
                                                            progress...</h6>
                                                    </div>
                                                    <div className="flex-shrink-0">
                                        ...
                                        <Card className="bg-light overflow-hidden shadow-none">
                                            <CardBody>
                                                <div className="d-flex">
                                                    <div className="flex-grow-1">
                                                        <h6 className="mb-0"><b className="text-danger">82%</b> Update
                                                            in
                                                            progress...</h6>
                                                    </div>
                                                    <div className="flex-shrink-0">
                                            ...
                                            <div>
                                                <Progress value={82} color="danger"
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted pb-2">Here is the example of progress which is represented
                                        by steps completion.</p>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted pb-2">Use <code>progress-step-arrow </code>class to create
                                        step progress with an arrow.</p>
                                    ...
                                    <div className="live-preview">
                                        <Progress multi className='progress-step-arrow progress-info'>
                                            ...
                                            <Progress bar value="35" color="light" className="text-body"> Step
                                                3 </Progress>
                                        </Progress>
                                    </div>
