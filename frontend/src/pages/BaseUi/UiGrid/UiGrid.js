...
const UiGrid = () => {
    document.title = "Grid | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent/>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>align-items-start</code> class to vertically
                                        align-items at the start.</p>
                                    <div className="live-preview">
                                        ...
                                        <div className="bg-light p-3 text-center">
                                            <Row className="align-items-start" style={{minHeight: "6rem"}}>
                                                ...
                                                <Col sm={4}>
                                                    <div
                                                        className="bg-primary-subtle text-primary rounded p-2 mt-2 mt-sm-0">
                                                        col-sm-4
                                                    </div>
                                                </Col>
                                                <Col sm={4}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>align-items-center</code> class to vertically
                                        align-items at the center.</p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>align-items-end</code> class to vertically
                                        align-items at the end.</p>
                                    <div className="live-preview">
                                        <div className="bg-light p-3 text-center">
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use
                                        the <code>align-self-start</code>,<code>align-self-center</code>,
                                        or <code>align-self-end</code> class respectively to vertically align items with
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use
                                        the <code>justify-content-start</code>,<code>justify-content-center</code>,
                                        or <code>justify-content-end</code> class respectively to horizontally align
                                        items with a different position.</p>
                                    <div className="live-preview">
                                        <div className="bg-light p-3 text-center">
