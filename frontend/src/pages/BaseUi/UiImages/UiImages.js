...
const UiImages = () => {
    document.title = "Images | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent/>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted mb-4">Use <code>avatar-xxs</code>, <code>avatar-xs</code>, <code>avatar-sm</code>, <code>avatar-md</code>, <code>avatar-lg</code>, <code>avatar-xl</code> class
                                        for different image sizes.</p>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>avatar-xxs,
                                        avatar-xs,avatar-sm,avatar-md,avatar-lg,avatar-xl</code> class to set different
                                        avatar content.</p>
                                        ...
                                        <Row className="g-3">
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-xxs mt-3">
                                                    <div
                                                        className="avatar-title rounded bg-primary-subtle text-primary fs-10">
                                                        XXS
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-xs mt-3">
                                                    <div
                                                        className="avatar-title rounded bg-secondary-subtle text-secondary">
                                                        XS
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-sm mt-3">
                                                    <div
                                                        className="avatar-title rounded bg-success-subtle text-success fs-14">
                                                        SM
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-md mt-3">
                                                    <div
                                                        className="avatar-title rounded bg-info-subtle text-info fs-16">
                                                        MD
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-lg mt-3">
                                                    <div
                                                        className="avatar-title rounded bg-warning-subtle text-warning fs-20">
                                                        LG
                                                    </div>
                                                </div>
                                            </Col>
                                            <Col xxl={2} md={4} className="col-6">
                                                <div className="avatar-xl mt-3">
                                                    <div
                                                        className="avatar-title rounded bg-danger-subtle text-danger fs-22">
                                                        XL
                                                    </div>
                                                </div>
                                            </Col>
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="mt-lg-0 mt-3">
                                                    <p className="text-muted">Use <code>avatar-group</code> class to
                                                        show avatar images with the group.</p>
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-lg-0 mt-3">
                                                    <p className="text-muted">Use <code>avatar-group</code> class
                                                        with <code>data-bs-toggle="tooltip"</code> to show avatar group
                                                        images with tooltip.</p>
                                                    <div className="avatar-group">
                                                        ...
                                                        <UncontrolledTooltip placement="top"
                                                                             target="img1"> Christi </UncontrolledTooltip>
                                                        <Link to="#" className="avatar-group-item" id="img2">
                                                            <img src={avatar3} alt=""
                                                                 className="rounded-circle avatar-sm"/>
                                                        </Link>
                                                        <UncontrolledTooltip placement="top" target="img2"> Frank
                                                        ...
                                                        <UncontrolledTooltip placement="top"
                                                                             target="img3"> Christi </UncontrolledTooltip>
                                                        ...
                                                        <UncontrolledTooltip placement="top"
                                                                             target="img4"> More </UncontrolledTooltip>
                                                    </div>
                                                </div>
                                            </Col>
                                        </Row>
                    ...
                    <Row>
                        <Col xl={8}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="card-title-desc text-muted">Use the
                                        included <code>figure</code>, <code>figure-img</code> and <code>figure-caption</code> classes
                                        to provide some baseline styles for the
                                        HTML5 <code>&lt;figure&gt;</code> and <code>&lt;figcaption&gt;</code> elements.
                                    </p>
                                        ...
                                        <Row className="g-3">
                                            <Col sm={6}>
                                                <figure className="figure mb-0">
                                                    ...
                                                    <figcaption className="figure-caption">A caption for the above
                                                        image.
                                                    </figcaption>
                                                </figure>
                                            </Col>
                                            <Col sm={6}>
                                                <figure className="figure mb-0">
                                                    ...
                                                    <figcaption className="figure-caption text-end">A caption for the
                                                        above image.
                                                    </figcaption>
                                                </figure>
                                            </Col>
                        ...
                        <Col xl={4}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="card-title-desc text-muted">Responsive Images with <code>img-fluid,max-width:
                                        100%; and height: auto;</code> to the image so that it scales with the parent
                                        width.</p>
