...
const UiRibbons = () => {
    document.title = "Ribbons | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent/>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            <p className="text-muted">Use <code>round-shape</code> class to show
                                                round-shaped ribbon.</p>
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border shadow-none mb-lg-0">
                                                    <CardBody>
                                                        ...
                                                        <div className="ribbon-content mt-4 text-muted">
                                                            <p className="mb-0">Quisque nec turpis at urna dictum
                                                                luctus. Suspendisse convallis dignissim eros at
                                                                volutpat. In egestas
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            <p className="text-muted">Use <code>ribbon-shape</code> class to show ribbon
                                                shaped ribbon.</p>
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border shadow-none mb-lg-0">
                                                    <CardBody>
                                                        <div className="ribbon ribbon-primary ribbon-shape">Primary
                                                        </div>
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border shadow-none mb-lg-0">
                                                    <CardBody>
                                                        <div className="ribbon ribbon-success ribbon-shape">Success
                                                        </div>
                                                        <h5 className="fs-14 text-end">Ribbon Shape</h5>
                                                        <div className="ribbon-content text-muted mt-4">
                                                            <p className="mb-0">Quisque nec turpis at urna dictum
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            <p className="text-muted">Use <code>ribbon-fill</code> class to show
                                                fill-shaped ribbon.</p>
                                            <Col xxl={4}>
                                            ...
                                            <Col xxl={4}>
                                                ...
                                                {/* <!-- Right Ribbon --> */}
                                                <div
                                                    className="card ribbon-box border ribbon-fill shadow-none right mb-lg-0">
                                                    <CardBody>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            <p className="text-muted">Use <code>ribbon-box</code> class
                                                with <code>ribbon-two</code> class at child element to show
                                                below-mentioned shaped ribbon.</p>
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border shadow-none mb-lg-0">
                                                    <div className="card-body text-muted">
                                                        ...
                                                        <p className="mb-0">Quisque nec turpis at urna dictum luctus.
                                                            Suspendisse convallis dignissim eros at volutpat. In egestas
                                                            mattis dui. Aliquam mattis dictum aliquet. Nulla sapien
                                                            mauris, eleifend et sem ac, commodo dapibus odio. Vivamus
                                            ...
                                            <Col xxl={4}>
                                                ...
                                                <div className="card ribbon-box border shadow-none mb-lg-0 right">
                                                    <div className="card-body text-muted">
                                                        <div className="ribbon-two ribbon-two-info"><span>Premium</span>
                                                        </div>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            <p className="text-muted">Use <code>ribbon-box</code> class
                                                with <code>ribbon-three</code> class at child element to show
                                                below-mentioned shaped ribbon.</p>
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border shadow-none mb-lg-0">
                                                    <div className="card-body text-muted">
                                                        <span
                                                            className="ribbon-three ribbon-three-primary"><span>Featured</span></span>
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border shadow-none mb-lg-0">
                                                    <div className="card-body text-muted">
                                                        <span
                                                            className="ribbon-three ribbon-three-success"><span>Featured</span></span>
                                                        <h5 className="fs-14 text-end mb-3">Ribbon Shape</h5>
                                                        <p className="mb-0">Quisque nec turpis at urna dictum luctus.
                                                            Suspendisse convallis dignissim eros at volutpat. In egestas
                                                            mattis dui. Aliquam mattis dictum aliquet. Nulla sapien
                                            ...
                                            <Col xxl={4}>
                                                <div className="card ribbon-box border shadow-none mb-lg-0 right">
                                                    <div className="card-body text-muted">
                                                        <span
                                                            className="ribbon-three ribbon-three-info"><span>Featured</span></span>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            <p className="text-muted">Use <code>trending-ribbon</code> class to show
                                                ribbon with hovering effect.</p>
                                            <Col xxl={4}>
                                                <div
                                                    className="card ribbon-box border shadow-none overflow-hidden mb-lg-0">
                                                    <div className="card-body text-muted">
                                                        <div
                                                            className="ribbon ribbon-info ribbon-shape trending-ribbon">
                                                            <span className="trending-ribbon-text">Trending</span> <i
                                                            className="ri-flashlight-fill text-white align-bottom float-end ms-1"></i>
                                                        </div>
                                                        <h5 className="fs-14 text-end mb-3">Ribbon Shape</h5>
                                                        <p className="mb-0">Quisque nec turpis at urna dictum luctus.
                                                            Suspendisse convallis dignissim eros at volutpat. In egestas
                                            ...
                                            <Col xxl={4}>
                                                <div
                                                    className="card ribbon-box right border shadow-none overflow-hidden mb-lg-0">
                                                    <div className="card-body text-muted">
                                                        <div
                                                            className="ribbon ribbon-info ribbon-shape trending-ribbon">
