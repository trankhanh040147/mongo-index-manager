...
const UiModals = () => {
    document.title = "Modals | DRManager - React Admin & Dashboard Template";
        ...
        <React.Fragment>
                    ...
                    <Row>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            <Button color="primary" onClick={() => tog_standard()}>Standard
                                                Modal</Button>
                                        </div>
                                    </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>modal-dialog-centered</code> class to show
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <div>
                                            <Button color="primary" onClick={() => tog_togFirst()}>Open First
                                                Modal</Button>
                                        </div>
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <div>
                                            <Button color="primary" onClick={() => tog_scroll()}>Scrollable
                                                Modal</Button>
                                        </div>
                                    </div>
                                    <div className="d-none code-view">
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            <div className="hstack gap-2 flex-wrap">
                                                <Button color="primary" onClick={() => tog_varying1()}>Open Modal for
                                                    Mary</Button>
                                                <Button color="primary" onClick={() => tog_varying2()}>Open Modal for
                                                    Jennifer</Button>
                                                <Button color="primary" onClick={() => tog_varying3()}>Open Modal for
                                                    Roderick</Button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>modal-fullscreen</code>, <code>modal-xl</code>, <code>modal-lg</code>,
                                        or <code>modal-sm</code> class to modal-dialog class to set different size modal
                                        respectively.</p>
                                    <div className="live-preview">
                                        <div>
                                            <div className="hstack flex-wrap gap-2">
                                                ...
                                                {/* <!-- Fullscreen modal --> */}
                                                <Button color="primary" onClick={() => tog_fullscreen(true)}>Fullscreen
                                                    Modal</Button>


                                                {/* <!-- Extra Large modal --> */}
                                                <Button color="info" onClick={() => tog_xlarge(true)}>Extra large
                                                    Modal</Button>


                                                {/* <!-- Large modal --> */}
                                                <Button color="success" onClick={() => tog_large(true)}>Large
                                                    Modal</Button>


                                                {/* <!-- Small modal --> */}
                                                <Button color="danger" onClick={() => tog_small(true)}>Small
                                                    Modal</Button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted text-muted">Below mentioned modifier classes are used to
                                        show fullscreen modal as per minimum screen requirement.</p>
                                    <div className="live-preview">
                                        <div>
                                            <div className="hstack gap-2 flex-wrap">
                                                <Button color="primary" onClick={() => tog_fullscreen1()}> Fullscreen
                                                    modal </Button>
                                                <Button color="primary" onClick={() => tog_fullscreen_sm()}>Full Screen
                                                    Below sm</Button>
                                                <Button color="primary" onClick={() => tog_fullscreen_md()}>Full Screen
                                                    Below md</Button>
                                                <Button color="primary" onClick={() => tog_fullscreen_lg()}>Full Screen
                                                    Below lg</Button>
                                                <Button color="primary" onClick={() => tog_fullscreen_xl()}>Full Screen
                                                    Below xl</Button>
                                                <Button color="primary" onClick={() => tog_fullscreen_xxl()}>Full Screen
                                                    Below xxl</Button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>fadeInRight</code>, <code>fadeInLeft</code>, <code>fadeInUp</code>, <code>flip</code>,
                                        or <code>zoomIn</code> class to modal class to set different modal with
                                        animation effect respectively.</p>
                                    <div className="live-preview">
                                        <div>
                                            <div className="hstack gap-2 flex-wrap">
                                                <Button color="primary" onClick={() => tog_animationRight()}>Fade In
                                                    Right Modal</Button>
                                                <Button color="primary" onClick={() => tog_animationLeft()}>Fade In Left
                                                    Modal</Button>
                                                <Button color="primary" onClick={() => tog_animationUp()}>Fade In Up
                                                    Modal</Button>
                                                <Button color="primary" onClick={() => tog_animationFlip()}>Flip
                                                    Modal</Button>
                                                <Button color="primary" onClick={() => tog_animationZoom()}>Zoom In
                                                    Modal</Button>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted text-muted">Use <code>modal-dialog-right</code>, <code>modal-dialog-bottom</code>,
                                        or <code>modal-dialog-bottom-right</code> class to modal-dialog class to set
                                        modal at different positions respectively.</p>
                                    <div className="live-preview">
                                        <div>
                                            <div className="hstack gap-2 flex-wrap">
                                                <Button color="primary" onClick={() => tog_positionTop()}>Top
                                                    Modal</Button>
                                                <Button color="secondary" onClick={() => tog_positionTopRight()}>Top
                                                    Right Modal</Button>
                                                <Button color="success" onClick={() => tog_positionBottom()}>Bottom
                                                    Modal</Button>
                                                <Button color="danger" onClick={() => tog_positionBottomRight()}>Bottom
                                                    Right Modal</Button>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <Col xl={4} md={6}>
                                    <Card className="text-center border">
                                        <CardBody className="p-4 pb-0">
                                            ...
                                            <p className="text-muted">Here is an example of a sweet alert with a success
                                                message.</p>
                                            <div>
                                                <Button color="primary" data-bs-toggle="modal"
                                                        data-bs-target="#success-Payment"
                                                        onClick={() => tog_successMessage()}>Click me</Button>
                                            </div>
                                ...
                                <Col xl={4} md={6}>
                                    <Card className="text-center border">
                                        <CardBody className="p-4 pb-0">
                                            ...
                                            <p className="text-muted">Here is an example of a sweet alert with a error
                                                message.</p>
                                            <div>
                                                <Button color='primary' onClick={() => tog_loginModals()}
                                                        data-bs-toggle="modal" data-bs-target="#loginModals">Click
                                                    me</Button>
                                            </div>
                                ...
                                <Col xl={4} md={6}>
                                    <Card className="text-center border">
                                        <CardBody className="p-4 pb-0">
                                            ...
                                            <p className="text-muted">Here is an example of a sweet alert with a warning
                                                message.</p>
                                            <div>
                                                <Button color='primary' onClick={() => tog_subscribeModals()}
                                ...
                                <Col xl={4} md={6}>
                                    <Card className="text-center border">
                                        <CardBody className="p-4 pb-0">
                                            ...
                                            <p className="text-muted">Here is an example of a sweet alert with a
                                                community registration field. </p>

                                            <div>
                                                <Button color='primary' onClick={() => tog_signUpModals()}
                                                        data-bs-toggle="modal" data-bs-target="#signupModals">Click
                                                    me</Button>
                                            </div>
            ...
            >
                ...
                <ModalBody>
                    ...
                    <p className="text-muted">One morning, when Gregor Samsa woke from troubled dreams, he found himself
                        ...
                        sections.</p>
                    <p className="text-muted">The bedding was hardly able to cover it and seemed ready to slide off any
                        moment. His many legs, pitifully thin compared with the size of the rest of him, waved about
                        helplessly as he looked. "What's happened to me?" he thought.</p>
                    <p className="text-muted">It wasn't a dream. His room, a proper human room although a little too
            ...
            >
                ...
                <ModalBody className="modal-body text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4"> The transfer was not successfully received by us. the email of
                            the recipient wasn't correct.</p>
                ...
                <ModalBody className="modal-body text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <p className="text-muted mb-4"> The transfer was not successfully received by us. the email of
                            the recipient wasn't correct.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-success fw-medium"
                                  onClick={() => setmodal_backdrop(false)}><i
                                className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link to="#" className="btn btn-success"
                                  onClick={() => setmodal_backdrop(false)}>Completed</Link>
                        </div>
                    </div>
                </ModalBody>
            </Modal>
            ...
            >
                ...
                <ModalBody className="modal-body text-center p-5">
                    <lord-icon
                        ...
                        trigger="loop"
                        colors="primary:#ffc061,secondary:#695eef"
                        style={{width: "130px", height: "130px"}}>
                    </lord-icon>
                    <div className="mt-4 pt-4">
                        <h4>Uh oh, something went wrong!</h4>
                        <p className="text-muted"> The transfer was not successfully received by us. the email of the
            ...
            >
                ...
                <ModalBody className="modal-body text-center p-5">
                    ...
                    <div className="mt-4 pt-3">
                        ...
                        <p className="text-muted mb-4">Hide this modal and show the first with the button below
                            Automatically Send your invitees a follow -Up email.</p>
                        <div className="hstack gap-2 justify-content-center">
            ...
            >
                ...
                <ModalBody>
                    ...
                    <p className="text-muted">You only need to know a little to make a big
                        {" "}<Link to="#" className="popover-test fw-medium text-decoration-underline link-success"
                                   id="UncontrolledPopover">
                            Popover on Click
                        </Link>{" "}
                        you do every day. So let's get started. First, some common types of fonts and what you need to
                        know about them triggers a popover on click.</p>
                    ...
                    <p className="text-muted">Opposites attract, and that’s a fact. It’s in our
                        {" "}<Link to="#" className="tooltip-test text-decoration-underline fw-medium"
                    ...
                    <UncontrolledTooltip placement="top" target="UncontrolledTooltip1"> Morton
                        Bayer </UncontrolledTooltip>
                    <UncontrolledTooltip placement="top" target="UncontrolledTooltip2"> Web
                        Developers </UncontrolledTooltip>
                </ModalBody>
                <div className="modal-footer">
                    <div className="mx-auto">
                        <Link to="#" className="btn btn-link fw-medium">Read More <i
                ...
                <ModalBody>
                    ...
                    <div className="d-flex">
                        ...
                        <div className="flex-grow-1 ms-2">
                            <p className="text-muted mb-0">Raw denim you probably haven't heard of them jean shorts
                                Austin.
                    ...
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">Too much or too little spacing, as in the example below, can
                                make things unpleasant for the reader. The goal is to make your text as comfortable to
                                read as possible. </p>
                        </div>
                    </div>
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">In some designs, you might adjust your tracking to create a
                                certain artistic effect. It can also help you fix fonts that are poorly spaced to begin
                                with.</p>
                        </div>
                    </div>
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">For that very reason, I went on a quest and spoke to many
                                different professional graphic designers and asked them what graphic design tips they
                                live.</p>
                        </div>
                    </div>
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">You've probably heard that opposites attract. The same is
                                true for fonts. Don't be afraid to combine font styles that are different but
                                complementary, like sans serif with serif, short with tall, or decorative with simple.
                                Qui photo booth letterpress, commodo enim craft beer mlkshk aliquip jean shorts ullamco
                    ...
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">Opposites attract, and that’s a fact. It’s in our nature to
                                be interested in the unusual, and that’s why using contrasting colors in Graphic Design
                                is a must. It’s eye-catching, it makes a statement, it’s impressive graphic design.
                                Increase or decrease the letter spacing depending.</p>
                        </div>
                    </div>
                    <div className="d-flex mt-2">
                        <div className="flex-shrink-0">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">Trust fund seitan letterpress, keytar raw denim keffiyeh etsy
                                art party before they sold out master cleanse gluten-free squid scenester freegan cosby
                                sweater.</p>
                        </div>
                    </div>
                    <div className="d-flex mt-2">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">Just like in the image where we talked about using multiple
                                fonts, you can see that the background in this graphic design is blurred. Whenever you
                                put text on top of an image, it’s important that your viewers can understand.</p>
                        </div>
                    </div>
                    <div className="d-flex mt-2">
                        <div className="flex-shrink-0">
                        ...
                        <div className="flex-grow-1 ms-2 ">
                            <p className="text-muted mb-0">Keytar raw denim keffiyeh etsy art party before they sold out
            ...
            >
                ...
                <div className="modal-footer">
                    <Link to="#" className="btn btn-link link-success fw-medium" onClick={() => setmodal_xlarge(false)}><i
                        className="ri-close-line me-1 align-middle"></i> Close</Link>
            ...
            >
                ...
                <div className="modal-footer">
                    <Link to="#" className="btn btn-link link-success fw-medium"
                          onClick={() => setmodal_large(false)}><i
                        className="ri-close-line me-1 align-middle"></i> Close</Link>
                    <Button color="primary">Save changes</Button>
                </div>
            </Modal>
            ...
            >
                ...
                <div className="modal-footer">
                    <Link to="#" className="btn btn-link link-success fw-medium"
                          onClick={() => setmodal_small(false)}><i
                        className="ri-close-line me-1 align-middle"></i> Close</Link>
                    <Button color="primary">Save changes</Button>
                </div>
            </Modal>
            ...
            <Modal id="bottomModal" isOpen={modal_positionBottom} toggle={() => {
                ...
                <ModalBody className="modal-body text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-success fw-medium"
                                  onClick={() => setmodal_positionBottom(false)}><i
                                className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link to="#" className="btn btn-success">Completed</Link>
                        </div>
                    </div>
            ...
            <Modal id="bottom-rightModal" isOpen={modal_positionBottomRight} toggle={() => {
                ...
                <ModalBody className="modal-body text-center p-5">
                    ...
                    <div className="mt-4">
                        ...
                        <div className="hstack gap-2 justify-content-center">
                            <Link to="#" className="btn btn-link link-success fw-medium"
                                  onClick={() => setmodal_positionBottomRight(false)}><i
                                className="ri-close-line me-1 align-middle"></i> Close</Link>
                            <Link to="#" className="btn btn-success">Completed</Link>
                        </div>
                    </div>
            ...
            <Modal id="success-Payment" tabIndex="-1" isOpen={modal_successMessage} toggle={() => {
                ...
                <ModalBody className='text-center p-5'>
                    ...
                    <div className="mt-2">
                        ...
                        <p className="text-muted fs-15 mb-4">Successful transaction is the status of operation whose
                            result is the payment of the amount paid by the customer in favor of the merchant.</p>
                        <div className="hstack gap-2 justify-content-center">
                            <button className="btn btn-primary">New transaction</button>
                            <button className="btn btn-soft-success"><i className="ri-links-line align-bottom"></i> Copy
                                tracking link
                            </button>
                        </div>
                    </div>
                ...
                <div className="modal-footer bg-light p-3 justify-content-center">
                    <p className="mb-0 text-muted">You like our service? <Link to="#"
                                                                               className="link-secondary fw-semibold">Invite
                        Friends</Link></p>
                </div>
            </Modal>
            ...
            <Modal id="loginModals" tabIndex="-1" isOpen={modal_loginModals} toggle={() => {
                ...
                <div className="modal-content border-0 overflow-hidden">
                    <ModalBody className='login-modal p-5'>
                        ...
                        <p className="text-white-50 mb-4">Don't have an account? <Link to="/#" className="text-white">Sign
                            Up.</Link></p>
                        <div className="vstack gap-2 justify-content-center">
                            <button className="btn btn-light"><i
                                className="ri-google-fill align-bottom text-danger"></i> Google
                            </button>
                            <button className="btn btn-info"><i className="ri-facebook-fill align-bottom"></i> Facebook
                            </button>
                        </div>
                    </ModalBody>
                ...
                <Row className="g-0">
                    <Col lg={7}>
                        <div className="modal-body p-5">
                            <h2 className="lh-base">Subscribe now today to get <span
                                className="text-danger">20% off</span> experiences!</h2>
                            <p className="text-muted mb-4">A free bet is a bet which is provided by a betting
                                site for a customer to place and then benefit from the winnings. Free bets are commonly
                                used as welcome offers.</p>
                            <div className="input-group mb-3">

                                <input type="text" className="form-control" placeholder="Enter your email"
                                       aria-label="Example text with button addon" aria-describedby="button-addon1"/>
                                <button className="btn btn-primary" type="button" id="button-addon1">Subscript Now
                                </button>
                            </div>

                            <div className="form-check">
                                <input type="checkbox" className="form-check-input" id="exampleCheck1"/>
                                <label className="form-check-label" htmlFor="exampleCheck1">By subscribing to a
                                    particular channel or user on YouTube, you can receive instant updates.</label>
                            </div>
                        </div>
                    </Col>
                    <Col lg={5}>
                        <div className="subscribe-modals-cover h-100">
                            <img src={authbg} alt="" className="h-100 w-100 object-fit-cover"
                                 style={{clipPath: "polygon(100% 0%, 100% 100%, 100% 100%, 0% 100%, 25% 50%, 0% 0%)"}}/>
                        </div>
                    </Col>
                </Row>
            </Modal>
            ...
            <Modal id="signupModals" tabIndex="-1" isOpen={modal_signUpModals} toggle={() => {
                ...
                <Alert color="success" className="rounded-0 mb-0">
                    <p className="mb-0">Up to <span className="fw-semibold">50% OFF</span>, Hurry up before the stock
                        ends</p>
                </Alert>
                <ModalBody>
                    <form>
                        ...
                        <div className="mb-3 form-check">
                            ...
                            <label className="form-check-label" htmlFor="checkTerms">I agree to the <span
                                className="fw-semibold">Terms of Service</span> and Privacy Policy</label>
                        </div>
                        <div className="text-end">
