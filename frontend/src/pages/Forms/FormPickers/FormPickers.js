...
const FormPickers = () => {
    document.title = "Pickers | DRManager - React Admin & Dashboard Template";
                                        ...
                                        <Row className="gy-3">
                                            <Col lg={6}>
                                                <div>
                                                    ...
                                                    <p className='text-uted'>Set <code>data-provider="flatpickr"
                                        ...
                                        <Row>
                                            <Col lg={6}>
                                                <div className="mt-3">
                                                    ...
                                                    <p className='text-uted'>Set <code>data-provider="flatpickr"
                                                        data-date-format="d M, Y" data-multiple-date="true"</code>attribute
                                                    </p>
                                                    <Flatpickr
                                                        className="form-control"
                                                        options={{
                                            ...
                                            <Col lg={6}>
                                                <div className="mt-3">
                                                    ...
                                                    <p className='text-uted'>Set <code>data-provider="flatpickr"
                                                        data-date-format="d M, Y" data-range-date="true"</code>attribute
                                                    </p>
                                                    <Flatpickr
                                                        className="form-control"
                                                        options={{
