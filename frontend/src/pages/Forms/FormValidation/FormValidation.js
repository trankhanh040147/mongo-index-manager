...
const FormValidations = () => {
    document.title = "Validation | DRManager - React Admin & Dashboard Template";
    // Form validation
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Not interested in custom validation feedback messages or
                                        writing JavaScript to change form behaviors? All good, you can use the browser
                                        defaults. Try submitting the form below. Depending on your browser and OS,
                                        you’ll see a slightly different style of feedback.While these feedback styles
                                    ...
                                    <div className="live-preview">
                                        <form className="row g-3">
                                            <Col md={4}>
                                                <Label for="validationDefault01" className="form-label">First
                                                    name</Label>
                                                <Input type="text" className="form-control" id="validationDefault01"
                                                       defaultValue="Mark" required/>
                                            </Col>
                                            <Col md={4}>
                                                <Label for="validationDefault02" className="form-label">Last
                                                    name</Label>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">
                                        ...
                                        attempting to submit, you’ll see
                                        the <code>:invalid</code> and <code>:valid</code> styles applied to your form
                                        controls.
                                    </p>
                                    <div className="live-preview">
                                        <Form
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Block-level or inline-level form text can be created
                                        using <code>.form-text</code>.</p>
                                    ...
                                    <div className="live-preview">
                                        <Form className="was-validated">
                                            ...
                                            <div className="form-check mb-3">
                                                ...
                                                <Label className="form-check-label" for="validationFormCheck3">Or toggle
                                            ...
                                            <div className="mb-0">
                                                <button className="btn btn-primary" type="submit" disabled>Submit form
                                                </button>
                                            </div>
                                        </Form>
                                    </div>
