...
const FormAdvanced = () => {
    ...
    document.title = "Form Advanced | DRManager - React Admin & Dashboard Template";
                                    ...
                                    <Row className="g-3">
                                        <Col lg={6}>
                                                        ...
                                                        <SimpleBar style={{maxHeight: "220px"}} className="px-3">
                                                            {
                                                                country.map((item, key) => (
                                                                    <DropdownItem as='li'
                                                                                  onClick={() => setseletedCountry(item.countryName)}
                                                                                  key={key}
                                            ...
                                            <div className="mt-3">
                                                ...
                                                <Dropdown isOpen={dropdownOpen2} toggle={toggle2}>
                                                    <DropdownToggle
                                                        tag="div"
                                                        caret={false} type="text"
                                                        style={{backgroundImage: `url(${seletedCountry1.flagImg && seletedCountry1.flagImg})`}}
                                                        className="w-100 form-control rounded-end flag-input form-select"
                                                        readOnly defaultValue={seletedCountry1.countryName}>
                                                        ...
                                                        <SimpleBar style={{maxHeight: "220px"}} className="px-3">
                                                            {(country || []).map((item, key) => (
                                                                <DropdownItem as='li'
                                                                    ...
                                                                    <div className="flex-shrink-0 me-2">
                                                                        <img src={item.flagImg} alt="country flag"
                                                                             className="options-flagimg" height="20"/>
                                                                    </div>
                                                                    <div className="flex-grow-1">
                                                                        <div className="d-flex">
                                                                            <div
                                                ...
                                                <Dropdown isOpen={dropdownOpen3} toggle={toggle3}>
                                                    ...
                                                    <DropdownMenu as='ul'
                                                        ...
                                                        <SimpleBar style={{maxHeight: "220px"}} className="px-3">
                                                            {(country || []).map((item, key) => (
                                                                <DropdownItem as='li'
                                                                              onClick={() => setseletedCountry2(item.countryName)}
                                                                              key={key}
                                                                              className="dropdown-item d-flex">
                                                                    <div className="flex-shrink-0 me-2">
                                                                        <img src={item.flagImg} alt="country flag"
                                        ...
                                        <Col lg={6}>
                                            <div>
                                                ...
                                                <Dropdown className='input-group' isOpen={dropdownOpen4}
                                                          toggle={toggle4}>
                                                    <DropdownToggle as="button"
                                                                    className="btn btn-light border arrow-none">
                                                        <img src={seletedCountry3.flagImg} alt="country flag"
                                                             className="options-flagimg" height="20"/>
                                                        <span
                                                            className="countrylist-codeno text-muted">{seletedCountry3.countryCode}</span>
                                                    </DropdownToggle>
                                                    <input type="number" className="form-control rounded-end flag-input"
                                            ...
                                            <div className="mt-3">
                                                ...
                                                <Dropdown className='input-group' isOpen={dropdownOpen5}
                                                          toggle={toggle5}>
                                                    <DropdownToggle as="button"
                                                                    className="btn btn-light border arrow-none">
                                                        <img src={seletedCountry4.flagImg} alt="country flag"
                                                             className="options-flagimg" height="20"/>
                                                    </DropdownToggle>
                                                    <input type="number" className="form-control rounded-end flag-input"
                                                           placeholder="Enter number"/>
                                        ...
                                        <Row className="g-3">
                                            <Col lg={6}>
                                                <div>
                                                    ...
                                                    <Input placeholder='Search for fruits...' id="autoCompleteFruit"
                                                           type="text" dir="ltr" spellCheck={false} autoComplete="off"
                                                           autoCapitalize="off"/>
                                                </div>
                                            </Col>
                                            <Col lg={6}>
                                                <div>
                                                    ...
                                                    <Input placeholder='Search for cars...' id="autoCompleteCars"
                                                           type="text" dir="ltr" spellCheck={false} autoComplete="off"
                                                           autoCapitalize="off"/>
                                                </div>
                                            </Col>
