...
const Formlayouts = () => {
    document.title = "Form Layouts | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <UiContent/>
                    ...
                    <Row>
                        <Col xxl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">More complex forms can be built using our grid classes.
                                        Use these for form layouts that require multiple columns, varied widths, and
                                        additional alignment options. <span
                                            className="fw-medium">Requires the <code>$enable-grid-classes</code> Sass variable to be enabled</span> (on
                                        by default).</p>
                                    <div className="live-preview">
                                        <Form>
                                            <Row>
                                                ...
                                                <Col md={12}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="compnayNameinput" className="form-label">Company
                                                            Name</Label>
                                                        <Input type="text" className="form-control"
                                                               placeholder="Enter company name" id="compnayNameinput"/>
                                                    </div>
                                                </Col>
                                                <Col md={6}>
                                                    <div className="mb-3">
                                                        ...
                                                        <Input type="tel" className="form-control"
                                                               placeholder="+(245) 451 45123" id="phonenumberInput"/>
                                                    </div>
                                                </Col>
                                                <Col md={6}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="emailidInput" className="form-label">Email
                                                            Address</Label>
                                                ...
                                                <Col md={12}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="address1ControlTextarea"
                                                               className="form-label">Address</Label>
                                                        <Input type="text" className="form-control"
                                                               placeholder="Address 1" id="address1ControlTextarea"/>
                                                    </div>
                                                </Col>
                                                <Col md={6}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="citynameInput"
                                                               className="form-label">City</Label>
                                                        <Input type="email" className="form-control"
                                                               placeholder="Enter your city" id="citynameInput"/>
                                                    </div>
                                                </Col>
                                                <Col md={6}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="ForminputState"
                                                               className="form-label">State</Label>
                                                        <select id="ForminputState" className="form-select" data-choices
                        ...
                        <Col xxl={6}>
                            <Card>
                                ...
                                <div className="card-body">
                                    <p className="text-muted">By adding <Link to="/docs/5.1/layout/gutters/"
                                                                              className="text-decoration-underline">gutter
                                        modifier classes</Link>, you can have control over the gutter width in as well
                                        the inline as block direction. <span
                                            className="fw-medium">Also requires the <code>$enable-grid-classes</code> Sass variable to be enabled</span> (on
                                        by default).</p>
                                    <div className="live-preview">
                                        <form action="#" className="row g-3">
                                            ...
                                            <Col md={4}>
                                                ...
                                                <select id="inputState" className="form-select" data-choices
                                                        data-choices-sorting="true">
                                                    <option>Choose...</option>
                                                    <option>...</option>
                                                </select>
                            ...
                            <Card>
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <Form action="#">
                                            <div className="mb-3">
                                                <Label htmlFor="employeeName" className="form-label">Employee
                                                    Name</Label>
                                                <Input type="text" className="form-control" id="employeeName"
                                                       placeholder="Enter emploree name"/>
                                            </div>
                                            <div className="mb-3">
                                                <Label htmlFor="employeeUrl" className="form-label">Employee Department
                                                    URL</Label>
                                                <Input type="url" className="form-control" id="employeeUrl"
                                                       placeholder="Enter emploree url"/>
                                            </div>
                                            <div className="mb-3">
                                                <Label htmlFor="StartleaveDate" className="form-label">Start Leave
                                                    Date</Label>
                                                <Flatpickr
                                            ...
                                            <div className="mb-3">
                                                <Label htmlFor="EndleaveDate" className="form-label">End Leave
                                                    Date</Label>
                                                <Flatpickr
                                                    className="form-control"
                                                    options={{
                                            ...
                                            <div className="mb-3">
                                                <Label htmlFor="VertimeassageInput"
                                ...
                                <CardBody>
                                    <div className="live-preview">
                                        <form action="#">
                                            ...
                                            <Row className="mb-3">
                                                <Col lg={3}>
                                                    <Label htmlFor="websiteUrl" className="form-label">Website
                                                        URL</Label>
                                                </Col>
                                                <Col lg={9}>
                                            ...
                                            <Row className="mb-3">
                                                ...
                                                <Col lg={9}>
                                                    <Input type="email" className="form-control" id="leaveemails"
                                            ...
                                            <Row className="mb-3">
                                                <Col lg={3}>
                                                    <label htmlFor="meassageInput"
                                                           className="form-label">Message</label>
                                                </Col>
                                                <Col lg={9}>
                                                    <textarea className="form-control" id="meassageInput" rows="3"
                                                              placeholder="Enter your message"></textarea>
                                                </Col>
                                            </Row>
                                            <div className="text-end">
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>col-form-label-sm</code> class to set small size
                                        form label or <code>col-form-label-lg</code> class to set large size form label
                                        to &lt;label&gt;. No such class is required for the default size form label.</p>
                                    <div className="live-preview">
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <div className="card-body">
                                    <p className="text-muted">Use <code>sm={`required size`}</code> size value to set
                                        column size as per your requirement.</p>
                                    <div className="live-preview">
                                        <Row className="g-3">
                                            <Col sm={6}>
                                            ...
                                            <Row className="gy-2 gx-3 mb-3 align-items-center">
                                                <Col sm>
                                                    <Label className="visually-hidden"
                                                           htmlFor="autoSizingInput">Name</Label>
                                                ...
                                                <Col sm>
                                                    ...
                                                    <select className="form-select" data-choices
                                                            data-choices-sorting="true" id="autoSizingSelect">
                                                        <option>Choose...</option>
                                        ...
                                        <Form>
                                            <Row className="gx-3 gy-2 align-items-center">
                                                <Col sm={3}>
                                                    ...
                                                    <Input type="text" className="form-control"
                                                           id="specificSizeInputName" placeholder="Jane Doe"/>
                                                </Col>
                                                <Col sm={3}>
                                                    <Label className="visually-hidden"
                                                ...
                                                <Col sm={3}>
                                                    ...
                                                    <select className="form-select" data-choices
                                                            data-choices-sorting="true" id="specificSizeSelect">
                                                        <option>Choose...</option>
                                                        <option defaultValue="1">One</option>
                                                        <option defaultValue="2">Two</option>
                                                        <option defaultValue="3">Three</option>
                                        ...
                                        <Form action="#">
                                            <Row className="row-cols-lg-auto g-3 align-items-center">
                                                ...
                                                <Col xs={12}>
                                                    ...
                                                    <select className="form-select" data-choices
                                                            data-choices-sorting="true" id="inlineFormSelectPref">
                                                        <option>Choose...</option>
                                                        <option defaultValue="1">One</option>
                                                        <option defaultValue="2">Two</option>
                                                        <option defaultValue="3">Three</option>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>form-floating</code> class to enable floating
                                        labels with Bootstrap’s textual form fields.</p>
                                    <div className="live-preview">
                                        <Form action="#">
                                            <Row className="g-3">
                                                <Col lg={6}>
                                                ...
                                                <Col lg={4}>
                                                    <div className="form-floating">
                                                        <Input type="email" className="form-control"
                                                               id="emailfloatingInput" placeholder="Enter your email"/>
                                                ...
                                                <Col lg={4}>
                                                    <div className="form-floating">
                                                        <Input type="text" className="form-control"
                                                               id="cityfloatingInput" placeholder="Enter your city"/>
                                                ...
                                                <Col lg={4}>
                                                    <div className="form-floating">
                                                        <Input type="number" className="form-control"
                                                               id="zipfloatingInput" placeholder="Enter your zipcode"/>
