...
const FormSelect = () => {
    document.title = "Form Select | DRManager - React Admin & Dashboard Template";
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>form-select-sm</code> class to set small select
                                        size and <code>form-select-lg</code> class to form-select class to
                                    ...
                                    <div>
                                        <div>
                                            <Row>
                                                <Col lg={4} md={6}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="choices-single-default"
                                                               className="form-label text-muted">Default</Label>
                                                        <Select
                                                ...
                                                <Col lg={4} md={6}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="choices-single-no-search"
                                                               className="form-label text-muted">Options added
                                                ...
                                                <Col lg={4} md={6}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="choices-single-no-sorting"
                                                               className="form-label text-muted">Options added
                                                ...
                                                <Col lg={4} md={6}>
                                                    <div className="mb-3">
                                                        <Label htmlFor="choices-multiple-remove-button"
                                                               className="form-label text-muted">With
                                                            remove button</Label>
                                                        <Select
                                        ...
                                        <div className="mt-4">
                                            ...
                                            <div>
                                                <Label htmlFor="choices-text-disabled"
                                                       className="form-label text-muted">Disabled</Label>
                                                <Select id={'dropdown'}
                                                        options={options}
