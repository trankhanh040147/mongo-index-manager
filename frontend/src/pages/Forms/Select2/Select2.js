...
const Select2 = () => {
    document.title = "Select2 | DRManager - React Admin & Dashboard Template";
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>js-example-basic-single</code>, <code>js-example-basic-multiple</code>, <code>js-example-data-array</code>, <code>js-example-templating</code>, <code>select-flag-templating</code>,
                                        class to show select2 example.</p>
                                    <Row className="g-4">
                                        <Col lg={4}>
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Select2 will respond to the disabled attribute
                                        on <code>&lt;select&gt;</code> elements. You can also initialize Select2 with
                                        disabled: true to get the same effect.</p>
                                    <div className="vstack gap-3">
                                        ...
                                        <Select
                                            ...
                                            classNamePrefix="select2-selection__choice"
                                            isDisabled={disable}
                                        />
                                    </div>
                                    <div className="hstack gap-2 mt-3">
                                        <button type="button" className="js-programmatic-enable btn btn-primary"
                                                onClick={() => setdisable(false)}>
                                            Enable
                                        </button>
                                        <button type="button" className="js-programmatic-disable btn btn-success"
