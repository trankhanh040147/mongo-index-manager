...
const FileUpload = () => {
    document.title = "File Upload | DRManager - React Admin & Dashboard Template";
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    ...
                                    <p className="text-muted">DropzoneJS is an open source library that provides
                                        drag’n’drop file uploads with image previews.</p>
                                    <Dropzone
                                    ...
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">FilePond is a JavaScript library that
                                                optimizes multiple images for faster uploads and offers a great,
                                                accessible, silky
