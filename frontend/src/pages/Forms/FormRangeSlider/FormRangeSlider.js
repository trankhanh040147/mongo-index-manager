    ...
    return (
        <React.Fragment>
            ...
            <div className="page-content">
                ...
                <title>
                    Range Slider | DRManager - React Admin & Dashboard Template
                </title>
                                    ...
                                    <div className="live-preview">
                                        <div>
                                            <div>
                                                ...
                                                <p className="text-muted">Use <code>form-range</code> class to create a
                                                    default range.</p>
                                            ...
                                            <div className="mt-4">
                                                ...
                                                <p className="text-muted">Use <code>disabled</code> attribute on an
                                                    input to give it a grayed out appearance and remove pointer events.
                                                </p>
                                            ...
                                            <div className="mt-4">
                                                ...
                                                <p className="text-muted">Use <code>min</code> and <code>max</code> attribute
                                                    with specified range input respectively.</p>
                                            ...
                                            <div className="mt-4">
                                                ...
                                                <p className="text-muted">By default, range inputs "snap" to integer
                                                    values. To change this, you can specify a step value. In the example
                                                    below, we double the number of steps by
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted mb-4">noUiSlider is a lightweight JavaScript range
                                        slider</p>
                                    <div className="live-preview">
                                        <div>
                                            <div className="mb-3">
                                            ...
                                            <div className="my-4">
                                                <Row className="align-items-center">
                                                    ...
                                                    <Col lg={9}>
                                                        <div className="slider" id="slider-merging-tooltips"
                                            ...
                                            <div className="my-4">
                                                <Row>
                                                    <Col lg={3}>
                                                        <h5 className="fs-14">Only showing tooltips when sliding
                                                            handle</h5>
                                                    </Col>
                                                    <Col lg={9}>
                                    ...
                                    <Row>
                                        <Col xl={4} lg={6}>
                                            <div>
                                                ...
                                                <p className="text-muted mb-4">Use <code>data-rangeslider
                                                    data-slider-color=&quot;primary&quot;</code> attribute to set
                                        ...
                                        <Col xl={4} lg={6}>
                                            <div className="mt-4 mt-lg-0">
                                                ...
                                                <p className="text-muted mb-4">Use <code>data-rangeslider
                                                    data-slider-color=&quot;secondary&quot;</code> attribute to set
                                        ...
                                        <Col xl={4} lg={6}>
                                            <div className="mt-4 mt-xl-0">
                                                ...
                                                <p className="text-muted mb-4">Use <code>data-rangeslider
                                                    data-slider-color=&quot;success&quot;</code> attribute to set
                                    ...
                                    <Row className="mt-4">
                                        <Col xl={4} lg={6}>
                                            <div className="mt-4">
                                                ...
                                                <p className="text-muted mb-4">Use <code>data-rangeslider
                                                    data-slider-color=&quot;info&quot;</code> attribute to set info
                                                    color scheme.</p>
                                        ...
                                        <Col xl={4} lg={6}>
                                            <div className="mt-4">
                                                ...
                                                <p className="text-muted mb-4">Use <code>data-slider-color=&quot;warning&quot;</code> attribute
                                                    to set warning color scheme.</p>
                                        ...
                                        <Col xl={4} lg={6}>
                                            <div className="mt-4">
                                                ...
                                                <p className="text-muted mb-4">Use <code>data-rangeslider
                                                    data-slider-color=&quot;danger&quot;</code> attribute to set danger
                                                    color scheme.</p>
                                    ...
                                    <Row className="mt-4">
                                        <Col xl={4} lg={6}>
                                            <div className="mt-4">
                                                ...
                                                <p className="text-muted mb-4">Use <code>data-rangeslider
                                                    data-slider-color=&quot;dark&quot;</code> attribute to set dark
                                                    color scheme.</p>
