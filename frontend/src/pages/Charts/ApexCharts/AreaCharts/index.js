...
const AreaCharts = () => {
    document.title = "Area Charts | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <BasicAreaCharts dataColors='["--vz-info"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <SplineAreaChart dataColors='["--vz-primary", "--vz-info"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <div>
                                        <div
                                            className="toolbar d-flex align-items-start justify-content-center flex-wrap gap-2">
                                            <button type="button" className="btn btn-soft-info timeline-btn btn-sm"
                                                    id="one_month">
                                                1M
                                            </button>
                                            <button type="button" className="btn btn-soft-info timeline-btn btn-sm"
                                            ...
                                            <button type="button"
                                                    className="btn btn-soft-info timeline-btn btn-sm active"
                                                    id="one_year">
                                                1Y
                                            </button>
                                            <button type="button" className="btn btn-soft-info timeline-btn btn-sm"
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <NegativeAreaChart dataColors='["--vz-primary", "--vz-info"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                    ...
                    <Row>
                                ...
                                <CardBody>
                                    <div>
                                        <div className="bg-light">
                                            <GithubStyleCharts dataColors='["--vz-info"]'/>
                                        </div>

                                        <div className="github-style d-flex align-items-center my-2">
                                            <div className="flex-shrink-0 me-2">
                                                <img className="avatar-sm rounded" src={user}
                                        ...
                                        <div className="bg-light">
                                            <GithubStyleCharts1 dataColors='["--vz-primary"]'/>
                                        </div>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <StackedAreaChart dataColors='["--vz-primary", "--vz-info", "--vz-gray-300"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <IrregularAreaCharts dataColors='["--vz-primary", "--vz-info", "--vz-gray-300"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <AreaNullValueChart dataColors='["--vz-primary"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
