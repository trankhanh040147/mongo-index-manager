...
const Polarcharts = () => {
    document.title = "Polar Charts | DRManager - React Admin & Dashboard Template";
    return (
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <BasicPolar
                                    dataColors='["--vz-primary", "--vz-success", "--vz-warning","--vz-danger", "--vz-info", "--vz-success", "--vz-primary", "--vz-dark", "--vz-secondary"]'/>
                            </CardBody>
                        </Card>
                    </Col>
