...
const TimelineCharts = () => {
    document.title = "TimeLine Charts | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <MultiSeries dataColors='["--vz-primary","--vz-info"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <Advanced dataColors='["--vz-primary", "--vz-info", "--vz-gray-300"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <MultipleSeries
                                        dataColors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-danger", "--vz-info","--vz-gray","--vz-pink","--vz-purple","--vz-secondary", "--vz-dark"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                        <Col xl={6}>
