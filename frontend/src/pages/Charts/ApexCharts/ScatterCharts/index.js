...
const ScatterCharts = () => {
    document.title = "Scatter Charts | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <Basic dataColors='["--vz-primary", "--vz-info", "--vz-gray-300"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <Datetime
                                        dataColors='["--vz-primary", "--vz-success", "--vz-warning", "--vz-gray-300", "--vz-info"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
