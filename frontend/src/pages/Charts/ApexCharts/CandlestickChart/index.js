...
const CandlestickChart = () => {
    document.title = "Candlestick Charts | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                    ...
                    <Row>
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <Basic dataColors='["--vz-info", "--vz-primary"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                    ...
                    <Row>
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <CandlestickLine
                                        dataColors='["--vz-success", "--vz-danger", "--vz-info", "--vz-warning"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
