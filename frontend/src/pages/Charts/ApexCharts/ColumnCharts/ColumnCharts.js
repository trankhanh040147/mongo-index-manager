...
const StackedColumn = ({dataColors}) => {
    ...
    return <ReactApexChart dir="ltr" className="apex-charts" series={series} options={options} type="bar"
                           height={350}/>;
};
...
const DumbbellChartColors = ({dataColors}) => {
    ...
    return <ReactApexChart dir="ltr" className="apex-charts" series={series} options={options} type="rangeBar"
                           height={350}/>;
}
