...
const FunnelCharts = () => {
    document.title = "Apex Funnel Charts | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                    ...
                    <Row>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <PyramidChartCode
                                        dataColors='["--vz-info", "--vz-danger", "--vz-primary", "--vz-secondary", "--vz-success", "--vz-dark", "--vz-warning"]'/>
                                </CardBody>
                            </Card>
                        </Col>
                    </Row>
