...
const LineCharts = () => {
    document.title = "Line Charts | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                    ...
                    <Row>
                        ...
                        <Col lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <div>
                                        <ChartSyncingLine dataColors='["--vz-primary"]' className="apex-charts"
                                                          dir="ltr"/>
                                        <ChartSyncingLine2 dataColors='["--vz-warning"]' className="apex-charts"
                                                           dir="ltr"/>
                                        <ChartSyncingArea dataColors='["--vz-success"]' className="apex-charts"
                                                          dir="ltr"/>
                                    </div>
                                </CardBody>
                            </Card>
