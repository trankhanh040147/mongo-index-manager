...
const TreemapCharts = () => {
    document.title = "Treemap Charts | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                ...
                <Container fluid>
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                <CardHeader>
                                    <h4 className="card-title mb-0">Distributed Treemap Chart (Different Color for each
                                        Cell)</h4>
                                </CardHeader>

                                <CardBody>
                                    <DiffColorTreemap
                                        dataColors='["--vz-primary", "--vz-secondary", "--vz-success", "--vz-info","--vz-warning", "--vz-danger"]'/>
                                </CardBody>
                            </Card>
                        </Col>
