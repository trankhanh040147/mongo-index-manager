...
const Echarts = () => {
    document.title = "E Charts | DRManager - React Admin & Dashboard Template";
    return (
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <AreaChart dataColors='["--vz-primary"]'/>
                            </div>
                        </Card>
                    </Col>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <StepLineChart dataColors='["--vz-primary", "--vz-info", "--vz-gray-300"]'/>
                            </div>
                        </Card>
                    </Col>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <LineYChart dataColors='["--vz-primary"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <BasicBarChart dataColors='["--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <HorizontalBarChart dataColors='["--vz-primary", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                ...
                <Row>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <CandleStickChart dataColors='["--vz-primary", "--vz-success"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <TreemapChart dataColors='["--vz-primary", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <SunburstChart dataColors='["--vz-primary", "--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <ParallelChart dataColors='["--vz-info"]'/>
                            </div>
                        </Card>
                    </Col>
                </Row>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <div className="card-body">
                                <SankeyChart
                                    dataColors='["--vz-info", "--vz-success", "--vz-warning", "--vz-danger", "--vz-primary"]'/>
                            </div>
                        </Card>
                    </Col>
