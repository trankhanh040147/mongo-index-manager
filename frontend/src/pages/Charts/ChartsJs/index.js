...
const ChartsJs = () => {
    document.title = "Charts Js | DRManager - React Admin & Dashboard Template";
    return (
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <LineChart
                                    dataColors='["--vz-primary-rgb, 0.2", "--vz-primary", "--vz-info-rgb, 0.2", "--vz-info"]'/>
                            </CardBody>
                        </Card>
                    </Col>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <PieChart dataColors='["--vz-info", "--vz-light"]'/>
                            </CardBody>
                        </Card>
                    </Col>
                ...
                <Row>
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <PolarChart dataColors='["--vz-danger", "--vz-info", "--vz-warning", "--vz-primary"]'/>
                            </CardBody>
                        </Card>
                    </Col>
                    ...
                    <Col xl={6}>
                        <Card>
                            ...
                            <CardBody>
                                <RadarChart
                                    dataColors='["--vz-info-rgb, 0.2", "--vz-info", "--vz-primary-rgb, 0.2", "--vz-primary"]'/>
                            </CardBody>
                        </Card>
                    </Col>
                </Row>
