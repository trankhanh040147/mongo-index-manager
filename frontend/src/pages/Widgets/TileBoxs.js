...
import {tileBoxes5} from '../../common/data/widgets';
                            ...
                            <CardBody>
                                <div className="d-flex align-items-center">
                                    <div className="flex-grow-1">
                                        <p className={"text-uppercase fw-semibold mb-0 text-" + item.labelClass}>{item.label}</p>
                                    </div>
                                ...
                                <div className="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 className={"fs-22 fw-semibold ff-secondary mb-4 " + item.counterClass}><span
                                            className="counter-value" data-target="559.25">
                                            <CountUp
                                                start={0}
                                                prefix={item.prefix}
                                                suffix={item.suffix}
                                        ...
                                        <Link to="#"
                                              className={"text-decoration-underline " + item.captionClass}>{item.caption}</Link>
                                    </div>
                                ...
                                {(tileBoxs2 || []).map((item, key) => (
                                    <Col className={item.id === 4 ? "col-lg" : "col-lg border-end"} key={key}>
                                        <div className="mt-3 mt-md-0 py-4 px-3">
                                            <h5 className="text-muted text-uppercase fs-13">{item.label} <i
                                                className={"fs-18 float-end align-middle " + item.badge}></i></h5>
                                            <div className="d-flex align-items-center">
                                                <div className="flex-shrink-0">
                        ...
                        <CardBody>
                            <div className="d-flex justify-content-between">
                                <div>
                                    ...
                                    <p className={"mb-0 text-" + item.labelClass}><span
                    ...
                    <Card className={"card-height-100 " + item.bgColor}>
                        <CardBody>
                            <div className="d-flex align-items-center">
                                <div className="avatar-sm flex-shrink-0">
                                    <span
                                        className={"avatar-title rounded-2 fs-2 bg-" + item.iconClass + " text-" + item.color}>
                                        <i className={item.icon}></i>
                                    </span>
                                </div>
                                <div className="flex-grow-1 ms-3">
                                    <p className={"text-uppercase fw-semibold mb-3 text-" + item.labelClass}>{item.label}</p>
                                ...
                                <span
                                    className={"fs-12 badge bg-" + item.percentageClass + "-subtle text-" + item.percentageClass}><i
                                    className={"fs-13 align-middle me-1 " + item.badge}></i>{item.percentage}<span>
                                </span></span></div>
                            </div>
                        </CardBody>
                    </Card>
                            ...
                            <CardBody>
                                <UncontrolledDropdown className="float-end">
                                    <DropdownToggle tag="a" className="text-reset dropdown-btn" href="#">
                                        <span className="text-muted fs-18"><i
                                            className="mdi mdi-dots-vertical"></i></span>
                                    </DropdownToggle>
                                ...
                                <Link to="#!">
                                    <h6 className="fs-15 fw-bold">{item.title} <span
                                        className="text-muted fs-13">{item.year}</span></h6>
                                </Link>
                                <p className="text-muted mb-0"><i
                                    className="ri-building-line align-bottom"></i> Themesbrand <span className="ms-2"><i
                                    className="ri-map-pin-2-line align-bottom"></i> California</span></p>
                            </CardBody>
                        </Card>
                    </Col>
                ))}
