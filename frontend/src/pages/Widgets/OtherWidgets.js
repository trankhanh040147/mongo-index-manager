...
import {widgets} from "../../common/data/appsJobs";
                    ...
                    <Card>
                        <CardBody className="p-0">
                            ...
                            <Row className="align-items-end">
                                <Col sm={8}>
                                    <div className="p-3">
                                        <p className="fs-16 lh-base">Upgrade your plan from a <span
                                            className="fw-semibold">Free
                    ...
                    <Card className="bg-primary">
                        <CardBody className="p-0">
                            ...
                            <Row className="align-items-end">
                                <Col sm={8}>
                                    <div className="p-3">
                                        <p className="fs-16 lh-base text-white">Upgrade your plan from a <span
                                            className="fw-semibold">Free
                                            trial</span>, to ‘Premium Plan’ <i className="mdi mdi-arrow-right"></i></p>
                                        <div className="mt-3">
                                            <Link to="/pages-pricing" className="btn btn-info">Upgrade Account!</Link>
                    ...
                    <Card>
                        <CardBody className="p-0">
                            <Alert color="warning"
                                ...
                                <div className="flex-shrink-0">
                                    <Link to="/pages-pricing" className="text-reset text-decoration-underline"><b>Get
                                        Free Gift</b></Link>
                                </div>
                            </Alert>
                                ...
                                <div className="flex-shrink-0">
                                    <div className="avatar-md me-3">
                                        <span className="avatar-title bg-info-subtle rounded-circle fs-1">
                                            <i className="ri-gift-2-line text-info"></i>
                                        </span>
                                    </div>
                                </div>
                                <div>
                                    <p className="fs-16 lh-base">Personalized <span
                                        className="fw-semibold">Gift Boxes</span>, with attitude, Let's collect your
                                        Xmas box <i className="mdi mdi-arrow-right"></i></p>
                                    <div className="mt-3">
                                        <Link to="/pages-pricing" className="btn btn-primary">Get a Free Gift</Link>
                                    </div>
                                </div>
                            </div>
                        </CardBody>
                    ...
                    <Card>
                        <CardBody>
                            ...
                            <div className="d-flex flex-wrap justify-content-evenly">
                                {item.subItem.map((item, key) => (<p className="text-muted mb-0" key={key}><i
                                    className={"fs-18 align-middle me-2 " + item.icon + " text-" + item.iconClass}></i>{item.label}
                                </p>))}
                            </div>
                        </CardBody>
                        <div className="progress animated-progess rounded-bottom rounded-0" style={{height: "6px"}}>
                            {item.progressBar.map((item, key) => (
                                <div className={"progress-bar rounded-0 " + item.bgColor} role="progressbar"
                                     style={{width: item.width}} aria-valuenow="30" aria-valuemin="0"
                                     aria-valuemax="100" key={key}></div>))}
                        </div>
                    </Card>
                </Col>))}
            </Row>
