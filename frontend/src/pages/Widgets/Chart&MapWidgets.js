                            ...
                            <div>
                                <div id="countries_charts" className="apex-charts" dir="ltr">
                                    ...
                                    <SessionsByCountriesCharts
                                        dataColors='["--vz-info", "--vz-info", "--vz-info", "--vz-info", "--vz-primary", "--vz-info", "--vz-info", "--vz-info", "--vz-info", "--vz-info"]'/>
                                </div>
                            </div>
                        </CardBody>
                    </Card>
                            ...
                            <Alert color="warning"
                                ...
                                <div className="flex-shrink-0">
                                    <Link to="/pages-pricing"
                                          className="text-reset text-decoration-underline"><b>Upgrade</b></Link>
                                </div>
                            </Alert>
                        </CardHeader>
                                    ...
                                    <div className="p-3 border border-dashed border-start-0">
                                        <h5 className="mb-1">
                                            {item.subCounter.map((item, key) => (
                                                <span className="counter-value" data-target="3" key={key}>
                                                <CountUp
                                                    start={0}
                                                    prefix={item.prefix}
                                                    suffix={item.suffix}
                                            ...
                                            {item.percentage ?
                                                <span className="text-success ms-1 fs-12">{item.percentage}<i
                                                    className="ri-arrow-right-up-line ms-1 align-middle"></i></span> : null}
                                        </h5>
                    ...
                    <Card className="card-height-100">
                            ...
                            <div>
                                ...
                                <UncontrolledDropdown className="card-header-dropdown" direction='left'>
                                    <DropdownToggle tag="button" className="btn btn-soft-primary btn-sm">
                                        <span className="text-uppercase">Btc<i
                                            className="mdi mdi-chevron-down align-middle ms-1"></i></span>
                                    </DropdownToggle>
                        ...
                        <CardBody>
                            <div id="portfolio_donut_charts" dir="ltr">
                                {/* My Portfolio Chart */}
                                <MyPortfolioCharts
                                    dataColors='["--vz-primary", "--vz-primary-rgb, 0.80", "--vz-primary-rgb, 0.6", "--vz-primary-rgb, 0.4"]'/>
                            </div>
                                ...
                                {(widgetsPortfolio || []).map((item, key) => (<ListGroupItem className="px-0" key={key}>
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1 ms-2">
                                            ...
                                            <p className="fs-12 mb-0 text-muted"><i
                                                className={"mdi mdi-circle fs-10 align-middle me-1 text-" + item.coinNameClass}></i>{item.coinName}
                                            </p>
                                        </div>
                        ...
                        <CardBody>
                            <div id="color_heatmap" className="apex-charts mt-n3" dir="ltr">
                                ...
                                <TopReferralsPagesCharts
                                    dataColors='["--vz-success", "--vz-info", "--vz-primary", "--vz-warning", "--vz-secondary"]'/>
                            </div>
                            ...
                            <Row className="g-3">
                                <Col md={6}>
                                    <div className="d-flex mb-3">
                                        <div className="flex-grow-1">
                                            <p className="text-truncate text-muted fs-14 mb-0"><i
                                                className="mdi mdi-circle align-middle text-primary me-2"></i>www.google.com
                                            </p>
                                        </div>
                                        <div className="flex-shrink-0">
                                    ...
                                    <div className="d-flex mb-3">
                                        <div className="flex-grow-1">
                                            <p className="text-truncate text-muted fs-14 mb-0"><i
                                                className="mdi mdi-circle align-middle text-warning me-2"></i>www.medium.com
                                            </p>
                                        </div>
                                        <div className="flex-shrink-0">
                                    ...
                                    <div className="d-flex">
                                        <div className="flex-grow-1">
                                            <p className="text-truncate text-muted fs-14 mb-0"><i
                                                className="mdi mdi-circle align-middle text-secondary me-2"></i>Other
                                            </p>
                                        </div>
                                        <div className="flex-shrink-0">
                                ...
                                <Col md={6}>
                                    <div className="d-flex mb-3">
                                        <div className="flex-grow-1">
                                            <p className="text-truncate text-muted fs-14 mb-0"><i
                                                className="mdi mdi-circle align-middle text-info me-2"></i>www.youtube.com
                                            </p>
                                        </div>
                                        <div className="flex-shrink-0">
                                    ...
                                    <div className="d-flex mb-3">
                                        <div className="flex-grow-1">
                                            <p className="text-truncate text-muted fs-14 mb-0"><i
                                                className="mdi mdi-circle align-middle text-success me-2"></i>www.meta.com
                                            </p>
                                        </div>
                                        <div className="flex-shrink-0">
