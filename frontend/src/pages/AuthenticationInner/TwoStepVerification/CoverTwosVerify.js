...
const CoverTwosVerify = () => {
    document.title = "Two Step Verification | DRManager - React Admin & Dashboard Template";
                                            ...
                                            <div className="p-lg-5 p-4">
                                                ...
                                                <div className="text-muted text-center mx-lg-3">
                                                    ...
                                                    <p>Please enter the 4 digit code sent to <span
                                                        className="fw-semibold">example@abc.com</span></p>
                                                </div>
                                                ...
                                                <div className="mt-5 text-center">
                                                    <p className="mb-0">Didn't receive a code ? <Link
