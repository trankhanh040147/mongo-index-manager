...
const BasicSignIn = () => {
    ...
    document.title = "Basic SignIn | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <ParticlesAuth>
                    ...
                    <Container>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                            ...
                                            <form action="#">
                                                ...
                                                <div className="mb-3">
                                                    <div className="float-end">
                                                        <Link to="/auth-pass-reset-basic" className="text-muted">Forgot
                                                            password?</Link>
                                                    </div>
                                                ...
                                                <div className="mt-4">
                                                    <Button color="success" className="btn btn-info w-100"
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">Don't have an account ? <Link to="/auth-signup-basic"
