...
const CoverSignIn = () => {
    ...
    document.title = "Cover SignIn | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
            <div
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <p className="text-muted">Sign in to continue to DRManager.</p>
                                                </div>
                                                ...
                                                <div className="mt-4">
                                                    <form action="/">
                                                        ...
                                                        <div className="mb-3">
                                                            <div className="float-end">
                                                                <Link to="/auth-pass-reset-cover"
                                                                      className="text-muted">Forgot password?</Link>
                                                            </div>
                                                        ...
                                                        <div className="mt-4">
                                                            <Button color="info" className="w-100" type="submit">Sign
                                                                In</Button>
                                                        </div>
                                                        ...
                                                        <div className="mt-4 text-center">
                                                            ...
                                                            <div>
                                                                <Button color="primary" className="btn-icon me-1"><i
                                                                    className="ri-facebook-fill fs-16"></i></Button>
                                                                <Button color="danger" className="btn-icon me-1"><i
                                                                    className="ri-google-fill fs-16"></i></Button>
                                                                <Button color="dark" className="btn-icon me-1"><i
                                                ...
                                                <div className="mt-5 text-center">
                                                    <p className="mb-0">Don't have an account ? <a
                                                        ...
                                                        className="fw-semibold text-primary text-decoration-underline"> Signup</a>
                                                    </p>
                                                </div>
                                            </div>
                                        </Col>
                        ...
                        <Row>
                            <Col lg={12}>
                                <div className="text-center">
                                    <p className="mb-0">&copy; {new Date().getFullYear()} DRManager. Crafted with <i
                                        className="mdi mdi-heart text-danger"></i> by DRManager</p>
                                </div>
                            </Col>
                        </Row>
                    </Container>
