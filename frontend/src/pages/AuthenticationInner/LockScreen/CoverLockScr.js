...
const CoverLockScreen = () => {
    document.title = "Lock Screen | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <p className="text-muted">Enter your password to unlock the
                                                        screen!</p>
                                                </div>
                                                <div className="user-thumb text-center">
                                                    <img src={avatar1}
                                                         ...
                                                         alt="thumbnail"/>
                                                    <h5 className="fs-17 mt-3">Anna Adame</h5>
                                                </div>
                                                ...
                                                <div className="mt-5 text-center">
                                                    <p className="mb-0">Not you ? return <Link to="/auth-signin-cover"
