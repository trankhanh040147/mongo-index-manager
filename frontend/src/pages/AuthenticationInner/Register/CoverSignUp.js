...
const CoverSignUp = () => {
    document.title = "Cover SignUp | DRManager - React Admin & Dashboard Template";
                                        ...
                                        <div className="col-lg-6">
                                            <div className="p-lg-5 p-4">
                                                <div>
                                                    ...
                                                    <p className="text-muted">Get your Free DRManager account now.</p>
                                                </div>
                                                    ...
                                                    <form className="needs-validation" noValidate action="index">
                                                        ...
                                                        <div className="mb-3">
                                                            <label htmlFor="username"
                                                                   className="form-label">Username <span
                                                                className="text-danger">*</span></label>
                                                        ...
                                                        <div className="mb-4">
                                                            <p className="mb-0 fs-13 text-muted fst-italic">By
                                                                registering you agree to the DRManager <Link to="#"
                                                        ...
                                                        <div id="password-contain"
                                                            ...
                                                            <p id="pass-length"
                                                               className="invalid fs-12 mb-2">Minimum <b>8
                                                                characters</b></p>
                                                            <p id="pass-lower"
                                                               className="invalid fs-12 mb-2">At <b>lowercase</b> letter
                                                                (a-z)</p>
                                                        ...
                                                        <div className="mt-4">
                                                            <button className="btn btn-info w-100" type="submit">Sign
                                                                Up
                                                            </button>
                                                        </div>
                                                        ...
                                                        <div className="mt-4 text-center">
                                                            <div className="signin-other-title">
                                                                <h5 className="fs-13 mb-4 title text-muted">Create
                                                                    account with</h5>
                                                            </div>
                            ...
                            <div className="col-lg-12">
                                <div className="text-center">
                                    <p className="mb-0">&copy; {new Date().getFullYear()} DRManager. Crafted with <i
                                        className="mdi mdi-heart text-danger"></i> by Themesbrand</p>
                                </div>
                            </div>
                        </div>
                    </Container>
