...
const BasicSignUp = () => {
    document.title = "Basic SignUp | DRManager - React Admin & Dashboard Template";
                    ...
                    <Container>
                        ...
                        <Row className="justify-content-center">
                            <Col md={8} lg={6} xl={5}>
                                    ...
                                    <CardBody className="p-4">
                                        ...
                                        <div className="p-2 mt-4">
                                            <form className="needs-validation" action="#">
                                                ...
                                                <div className="mb-4">
                                                    <p className="mb-0 fs-13 text-muted fst-italic">By registering you
                                                        agree to the DRManager
                                                        <Link to="#"
                                                ...
                                                <div id="password-contain" className="p-3 bg-light mb-2 rounded">
                                                    ...
                                                    <p id="pass-length" className="invalid fs-12 mb-2">Minimum <b>8
                                                        characters</b></p>
                                                    <p id="pass-lower"
                                                       className="invalid fs-12 mb-2">At <b>lowercase</b> letter (a-z)
                                                    </p>
                                                ...
                                                <div className="mt-4">
                                                    <button className="btn btn-info w-100" type="submit">Sign Up
                                                    </button>
                                                </div>
                                ...
                                <div className="mt-4 text-center">
                                    <p className="mb-0">Already have an account ? <Link to="/auth-signin-basic"
