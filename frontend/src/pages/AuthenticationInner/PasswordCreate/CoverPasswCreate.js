...
const CoverPasswCreate = () => {
    document.title = "Create New Password | DRManager - React Admin & Dashboard Template";
                                    ...
                                    <Row className="justify-content-center g-0">
                                        ...
                                        <Col lg={6}>
                                            <div className="p-lg-5 p-4">
                                                ...
                                                <p className="text-muted">Your new password must be different from
                                                ...
                                                <div className="p-2">
                                                    <Form onSubmit={validation.handleSubmit}
                                                        ...
                                                        <div className="mb-3">
                                                            ...
                                                            <div id="passwordInput" className="form-text">Must be at
                                                                least 8 characters.
                                                            </div>
                                                        </div>
                                                        ...
                                                        <div className="mb-3">
                                                            <Label className="form-label"
                                                                   htmlFor="confirm-password-input">Confirm
                                                                Password</Label>
                                                            <div
                                                                ...
                                                                {validation.errors.confrim_password && validation.touched.confrim_password ? (
                                                                    <FormFeedback
                                                                        type="invalid">{validation.errors.confrim_password}</FormFeedback>
                                                                ) : null}
                                                                <Button color="link"
                                                ...
                                                <div className="mt-5 text-center">
                                                    <p className="mb-0">Wait, I remember my password... <Link
