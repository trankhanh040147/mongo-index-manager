...
const UiTour = () => {
    document.title = "Tour | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                            ...
                            <Col lg={12}>
                                <Card>
                                    ...
                                    <CardBody>
                                        ...
                                        <p className="text-muted mb-4">Use when you want to help users along getting
                                            accustomed to your user interface or
                                                ...
                                                <Col lg={5}>
                                                    <div className="text-center mt-4 mb-5">
                                                        <div className="py-3 px-2 d-inline-block" id="logo-tour">
                                                            <img src={logodark} className="card-logo card-logo-dark"
                                                                 alt="logo" height="17"/>
                                                            <img src={logolight} className="card-logo card-logo-light"
                                                                 alt="logo" height="17"/>
                                                        </div>
                                                        <h5 className="fs-16">Responsive Admin Dashboard Template</h5>
                                                        <p className="text-muted">Vestibulum auctor tincidunt semper.
                                                            Phasellus
                                                        ...
                                                        <Col lg={4}>
                                                            <Card className="border shadow-none">
                                                                <CardBody className="text-center">
                                                                    ...
                                                                    <h5>Free register</h5>
                                                                    <p className="text-muted mb-0">Get your Free DRManager
                                                                        account now.</p>
                                                                </CardBody>
                                                            </Card>
                                                        </Col>
                                                        ...
                                                        <Col lg={4}>
                                                            <Card className="border shadow-none">
                                                                <CardBody className="text-center">
                                                                    ...
                                                                    <p className="text-muted mb-0">Sign in to continue
                                                                        to DRManager.</p>
                                                                </CardBody>
                                                            </Card>
                                                        </Col>
