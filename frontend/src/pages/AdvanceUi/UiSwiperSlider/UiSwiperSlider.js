...
const UiSwiperSlider = () => {
    document.title = "Swiper Slider | DRManager - React Admin & Dashboard Template";
                    ...
                    <Row>
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>default-swiper</code> class to set a default
                                        swiper.</p>

                                    <Swiper className="mySwiper swiper default-swiper rounded" modules={[Autoplay]}
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>navigation-swiper</code> class to set a swiper
                                        with navigation and pagination.</p>

                                    <Swiper modules={[Navigation, Pagination, Autoplay]} pagination={{clickable: true}}
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>pagination-dynamic-swiper</code> class to set a
                                        dynamic swiper with pagination.</p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>pagination-fraction-swiper</code> class to set a
                                        fraction swiper with pagination.</p>


                                    <Swiper pagination={{type: "fraction", clickable: true}} navigation={true}
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>pagination-custom-swiper</code> class to set a
                                        swiper with custom pagination.</p>

                                    <Swiper pagination={{el: '.swiper-pagination', pagination}}
                                            modules={[Pagination, Autoplay]} loop={true}
                                            autoplay={{delay: 2500, disableOnInteraction: false}}
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>pagination-progress-swiper</code> class to set a
                                        swiper with progress pagination.</p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>pagination-scrollbar-swiper</code> class to set
                                        a swiper with scrollbar pagination.</p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>vertical-swiper</code> class to set a vertical
                                        swiper.</p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>mousewheel-control-swiper</code> class to set a
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>effect-fade-swiper</code> class to set a swiper
                                        with fade effect.</p>


                                    <Swiper spaceBetween={30} effect={"fade"} pagination={{clickable: true,}}
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>effect-creative-swiper</code> class to set a
                                        swiper with creative custom effect.</p>
                        ...
                        <Col xl={4} lg={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>effect-flip-swiper</code> class to set a swiper
                                        with flip effect.</p>
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>effect-coverflow-swiper</code> class to set a
                                        swiper with coverflow effect.</p>

                                    <Swiper effect={"coverflow"} grabCursor={true} centeredSlides={true}
                                            slidesPerView={"4"} loop={true} autoplay={{
                                        delay: 2500,
                        ...
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>responsive-swiper</code> class to set a
                                        responsive swiper.</p>
                                                ...
                                                <div className="gallery-box card">
                                                    <div className="gallery-container">
                                                        <Link className="image-popup" to={img1} title="">
                                                            <img className="gallery-img img-fluid mx-auto" src={img1}
                                                                 alt=""/>
                                                            <div className="gallery-overlay">
                                                                <h5 className="overlay-caption">Glasses and laptop from
                                                                    above</h5>
                                                            </div>
                                                        </Link>
                                                    </div>
                                                ...
                                                <div className="gallery-box card">
                                                    <div className="gallery-container">
                                                        <Link className="image-popup" to={img2} title="">
                                                            <img className="gallery-img img-fluid mx-auto" src={img2}
                                                                 alt=""/>
                                                            <div className="gallery-overlay">
                                                                <h5 className="overlay-caption">Working at a coffee
                                                                    shop</h5>
                                                            </div>
                                                        </Link>
                                                    </div>
                                                ...
                                                <div className="gallery-box card mb-0">
                                                    <div className="gallery-container">
                                                        <Link className="image-popup" to={img10} title="">
                                                            <img className="gallery-img img-fluid mx-auto" src={img10}
                                                                 alt=""/>
                                                            <div className="gallery-overlay">
                                                                <h5 className="overlay-caption">Fun day at the Hill
                                                                    Station</h5>
                                                            </div>
                                                        </Link>
                                                    </div>
                                                ...
                                                <div className="gallery-box card">
                                                    <div className="gallery-container">
                                                        <Link className="image-popup" to={img4} title="">
                                                            <img className="gallery-img img-fluid mx-auto" src={img4}
                                                                 alt=""/>
                                                            <div className="gallery-overlay">
                                                    ...
                                                    <div className="box-content">
                                                        <div className="d-flex align-items-center mt-1">
                                                            <div className="flex-grow-1 text-muted">by <Link to=""
                                                                                                             className="text-body text-truncate">Jason
                                                                McQuaid</Link></div>
                                                            <div className="flex-shrink-0">
                                                                <div className="d-flex gap-3">
                                                                    <button type="button"
                                                ...
                                                <div className="gallery-box card">
                                                    <div className="gallery-container">
                                                        <Link className="image-popup" to={img6} title="">
                                                            <img className="gallery-img img-fluid mx-auto" src={img6}
                                                                 alt=""/>
                                                            <div className="gallery-overlay">
                                                                <h5 className="overlay-caption">Project discussion with
                                                                    team</h5>
                                                            </div>
                                                        </Link>
                                                    </div>
