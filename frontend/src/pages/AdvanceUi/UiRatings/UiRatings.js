...
const UiRatings = () => {
    document.title = "Ratings | DRManager - React Admin & Dashboard Template";
                    ...
                    <Row>
                        <Col lg={12}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Rater-js is a star rating widget for the browser. here are
                                        the various examples of rating shown below with variation.</p>
                                    <div className="live-preview">
                                        <div className="table-responsive">
                                            <table className="table align-middle mb-0">
                                                ...
                                                <tr>
                                                    <th scope="row">Example with unlimited number of stars. readOnly
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div dir="ltr">
                                                            ...
                                                            <Badge color="info"
                                                                   className="ratingnum align-middle ms-2">{customize}</Badge>
                                                        </div>
                                                    </td>
                                                    <td>
                                                            <pre>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div dir="ltr">
                                                            ...
                                                            <Button id="raterreset-button" color="light" size="sm"
                                                                    className="ms-2"
                                                                    onClick={() => setreset("mdi mdi-star-outline text-muted ")}>Reset</Button>
                                                        </div>
                                                    </td>
                                                    <td>
                                                            <pre>
                                    ...
                                    <div className="d-none code-view">
                                        <pre>
                                            <code
                                                className="language-markup">&lt;div data-simplebar style=&quot;max-height: 220px;&quot;&gt;
                                                ...
                                                &lt;/div&gt;</code></pre>
                                    </div>
                                </CardBody>
