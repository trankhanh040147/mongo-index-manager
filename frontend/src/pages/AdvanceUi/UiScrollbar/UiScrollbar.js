...
const UiScrollbar = () => {
    document.title = "Scrollbar | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>SimpleBar</code> attribute and add <code>max-height:
                                        **px</code> to set default scrollbar.</p>
                                    ...
                                    <div className="mx-n3">
                                        <SimpleBar style={{maxHeight: "220px"}} className="px-3">
                                            <p>If several languages coalesce, the grammar of the resulting language is
                                                ...
                                                common language will be more simple and regular than the existing</p>
                                            <p>To an English person, it will seem like simplified English, as a
                                            ...
                                            <p>The languages only differ in their grammar, their pronunciation and their
                                                ...
                                                more common words.</p>
                                            <p>Their separate existence is a myth. For science, music, sport, etc,
                        ...
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>autoHide={false}</code> attribute and add <code>max-height:
                                        **px</code> to show simplebar as default.</p>
                                    ...
                                    <div className="mx-n3">
                                        <SimpleBar autoHide={false} style={{maxHeight: "220px"}} className="px-3">
                                            ...
                                            <p>The languages only differ in their grammar, their pronunciation and their
                                                ...
                                                this, it would be necessary to have uniform grammar, pronunciation and
                                                more common words.</p>
                                            <p className="mb-0">Their separate existence is a myth. For science, music,
                    ...
                    <Row>
                        <Col xl={6}>
                            <Card>
                                ...
                                <CardBody>
                                    <p className="text-muted">Use <code>data-simplebar-direction="rtl"</code> attribute
                                        and add <code>max-height: **px</code> to set simplebar at right side.</p>

                                    <div className="mx-n3">
                                        <SimpleBar data-simplebar-direction="rtl" style={{maxHeight: "220px"}}
                                                   className="px-3">
                                            <p>If several languages coalesce, the grammar of the resulting language is
                                                more simple and regular than that of the individual languages. The new
                                                common language will be more simple and regular than the existing</p>
                            ...
                            <Row>
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">Use <code>data-simplebar-track="primary"</code> attribute
                                                to set primary color simplebar track.</p>

                                            <div className="mx-n3">
                                                <SimpleBar autoHide={false} className="simplebar-track-primary"
                                                    ...
                                                    <Link to="#!"
                                                        ...
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="flex-grow-1 text-muted">
                                                                <p className="m-0">Your <span
                                                                    className="fw-semibold text-body">Elite</span> author
                                                    ...
                                                    <Link to="#!"
                                                        ...
                                                        <div className="d-flex">
                                                            <div className="flex-shrink-0 avatar-xs me-3">
                                                                <img src={avatar2} className="rounded-circle img-fluid"
                                                                     alt="user-pic"/>
                                                            </div>
                                                            <div className="flex-grow-1 text-muted">
                                                                <h6 className="mb-1 fs-14">Angela Bernier</h6>
                                                                <p className="mb-0">Answered to your comment on the cash
                                                    ...
                                                    <Link to="#!"
                                                        ...
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="flex-grow-1 text-muted">
                                                                <p className="m-0">You have received <span
                                                                    className="fw-semibold text-success">20</span> new
                                                    ...
                                                    <Link to="#!"
                                                        ...
                                                        <div className="d-flex">
                                                            <div className="flex-shrink-0 avatar-xs me-3">
                                                                <img src={avatar8} className="rounded-circle img-fluid"
                                                                     alt="user-pic"/>
                                                            </div>
                                                            <div className="flex-grow-1 text-muted">
                                                                <h6 className="mb-1 fs-14">Maureen Gibson</h6>
                                                                <p className="mb-0">We talked about a project on
                                                                    linkedin.</p>
                                                            </div>
                                                            <div className="flex-shrink-0 ms-2">
                                                                <div className="fs-11 text-muted">
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">Use <code>data-simplebar-track="secondary"</code> attribute
                                                to set secondary color simplebar track.</p>

                                            <div className="mx-n3">
                                                <SimpleBar autoHide={false} className="simplebar-track-secondary"
                                                           style={{maxHeight: "275px"}}>
                                                    <div className="list-group list-group-flush">
                                                        <Link to="#" className="list-group-item text-muted py-3">
                                                            <div className="d-flex align-items-start">
                                                                ...
                                                                <div className="flex-grow-1 overflow-hidden">
                                                                    <h5 className="text-truncate fs-14 mb-1">Michael
                                                                        Johnston</h5>
                                                                    <p className="text-truncate mb-0">New updates for
                                                                        ABC Theme</p>
                                                                </div>
                                                        ...
                                                        <Link to="#" className="list-group-item text-muted py-3">
                                                            <div className="d-flex align-items-start">
                                                                ...
                                                                <div className="flex-grow-1 overflow-hidden">
                                                                    <h5 className="text-truncate fs-14 mb-1">Darren
                                                                        James</h5>
                                                                    <p className="text-truncate mb-0">Bug Report - abc
                                                                        theme</p>
                                                                </div>
                                                        ...
                                                        <Link to="#" className="list-group-item text-muted py-3">
                                                            <div className="d-flex align-items-start">
                                                                ...
                                                                <div className="flex-grow-1 overflow-hidden">
                                                                    <h5 className="text-truncate fs-14 mb-1">Patricia
                                                                        Shelton</h5>
                                                                    <p className="text-truncate mb-0">Nice to meet
                                                                        you</p>
                                                                </div>
                                                        ...
                                                        <Link to="#" className="list-group-item text-muted py-3">
                                                            <div className="d-flex align-items-start">
                                                                ...
                                                                <div className="flex-grow-1 overflow-hidden">
                                                                    <h5 className="text-truncate fs-14 mb-1">Thomas
                                                                        McNeil</h5>
                                                                    <p className="text-truncate mb-0">This theme is
                                                                        awesome!</p>
                                                                </div>
                                                        ...
                                                        <Link to="#" className="list-group-item text-muted py-3">
                                                            <div className="d-flex align-items-start">
                                                                ...
                                                                <div className="flex-grow-1 overflow-hidden">
                                                                    <h5 className="text-truncate fs-14 mb-1">Carolyn
                                                                        Jones</h5>
                                                                    <p className="text-truncate mb-0">I've finished it!
                                                                        See you so</p>
                                                                </div>
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">Use <code>data-simplebar-track="success"</code> attribute
                                                to set success color simplebar track.</p>

                                            <div className="mx-n3">
                                                <SimpleBar autoHide={false} className="simplebar-track-success"
                                                           style={{maxHeight: "275px"}}>
                                                    <ul className="list-group list-group-flush">
                                                        <li className="list-group-item py-3">
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div className="flex-grow-1 text-muted overflow-hidden">
                                                                    <h5 className="text-truncate fs-14 mb-1">Lead
                                                        ...
                                                        <li className="list-group-item py-3">
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div className="flex-grow-1 text-muted overflow-hidden">
                                                                    <h5 className="text-truncate fs-14 mb-1">Senior
                                                                        Graphic Designer</h5>
                                                        ...
                                                        <li className="list-group-item py-3">
                                                            <div className="d-flex align-items-center">
                                                                ...
                                                                <div className="flex-grow-1 text-muted overflow-hidden">
                                                                    <h5 className="text-truncate fs-14 mb-1">Graphic
                                                                        Designer</h5>
                                                                    <div className="text-truncate">Xyz Company</div>
                                                                </div>
                                                            </div>
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">Use <code>data-simplebar-track="info"</code> attribute
                                                to set info color simplebar track.</p>

                                            <div className="mx-n3">
                                                <SimpleBar autoHide={false} className="simplebar-track-info"
                                                    ...
                                                    <ol className="list-group list-group-flush list-group-numbered">
                                                        ...
                                                        <li className="list-group-item d-flex align-items-center">
                                                            A Fifth list item
                                                            <Badge color="warning"
                                                                   className="ms-auto">Inprogress</Badge>
                                                        </li>
                                                        <li className="list-group-item d-flex align-items-center">
                                                            A Sixth list item
                                                            <Badge color="success" className="ms-auto">Paid</Badge>
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">Use <code>data-simplebar-track="warning"</code> attribute
                                                to set warning color simplebar track.</p>

                                            <div className="mx-n3">
                                                <SimpleBar autoHide={false} style={{maxHeight: "220px"}}
                                                    ...
                                                    <div className="d-flex align-items-center py-3">
                                                        ...
                                                        <div className="flex-shrink-0 ms-2">
                                                            <Button color="success" size="sm" outline><i
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">Use <code>data-simplebar-track="danger"</code> attribute
                                                to set danger color simplebar track.</p>
                                                ...
                                                <SimpleBar autoHide={false} style={{maxHeight: "220px"}}
                                                    ...
                                                    <Link to="#" className="d-flex align-items-center py-2">
                                                        ...
                                                        <div className="flex-shrink-0 align-self-start ms-2">
                                                            <div
                                                                className="badge bg-warning-subtle text-warning fs-10">Inprogress
                                                            </div>
                                                        </div>
                                                    </Link>
                                                    <Link to="#" className="d-flex align-items-center py-2">
                                                    ...
                                                    <Link to="#" className="d-flex align-items-center py-2">
                                                        ...
                                                        <div className="flex-shrink-0 align-self-start ms-2">
                                                            <div
                                                                className="badge bg-success-subtle text-success fs-10">Completed
                                                            </div>
                                                        </div>
                                                    </Link>
                                                    <Link to="#" className="d-flex align-items-center py-2">
                                ...
                                <Col xl={4} lg={6}>
                                    <Card>
                                        ...
                                        <CardBody>
                                            <p className="text-muted">Use <code>data-simplebar-track="dark"</code> attribute
                                                to set dark color simplebar track.</p>

                                            <div className="mx-n3">
                                                <SimpleBar autoHide={false} className="simplebar-track-dark"
                                                    ...
                                                    <ul className="list-group list-group-flush">
                                                        <li className="list-group-item">
                                                            <div>
                                                                <div className="d-flex align-items-start">
                                                                    <div className="flex-grow-1">
                                                                        <Badge color="success"
                                                                               className="bg-gradient mb-2"><i
                                                                            className="mdi mdi-star"></i> 4.1</Badge>
                                                                    </div>
                                                                    <div className="flex-shrink-0">
                                                                ...
                                                                <p className="text-muted mb-4">It will be as simple as
                                                                        ...
                                                                        <div className="hstack gap-3">
                                                                            <div data-bs-toggle="tooltip"
                                                                                ...
                                                                                <Link to="#" className="text-muted"><i
                                                                                    className="ri-thumb-up-line"></i></Link>
                                                                            </div>
                                                                            ...
                                                                            <div data-bs-toggle="tooltip"
                                                                                 ...
                                                                                 title="Comment">
                                                                                <Link to="#" className="text-muted"><i
                                                                                    className="ri-discuss-line"></i></Link>
                                                                            </div>
                                                                            <div className="vr"></div>
                                                            ...
                                                            <div>
                                                                <div className="d-flex align-items-start">
                                                                    <div className="flex-grow-1">
                                                                        <Badge color="success"
                                                                               className="bg-gradient mb-2"><i
                                                                            className="mdi mdi-star"></i> 4.0</Badge>
                                                                    </div>
                                                                    <div className="flex-shrink-0">
                                                                        <p className="text-muted fs-13">06 Jul, 21</p>
                                                                    </div>
                                                                </div>
                                                                <p className="text-muted mb-4">Sed ut perspiciatis iste
                                                                    error sit</p>
                                                                <div className="d-flex align-items-start">
                                                                    <div className="flex-grow-1">
                                                            ...
                                                            <div>
                                                                <div className="d-flex align-items-start">
                                                                    <div className="flex-grow-1">
                                                                        <Badge color="success"
                                                                               className="bg-gradient mb-2"><i
                                                                            className="mdi mdi-star"></i> 4.2</Badge>
                                                                    </div>
                                                                    <div className="flex-shrink-0">
                                                                        <p className="text-muted fs-13">26 Jun, 21</p>
                                                                    </div>
                                                                </div>
                                                                <p className="text-muted mb-4">Neque porro quisquam est,
                                                        ...
                                                        <li className="list-group-item">
                                                            <div>
                                                                ...
                                                                <p className="text-muted mb-4">Ut enim ad minima veniam,
                                                                    quis nostrum ullam corporis suscipit consequatur
                                                                    nisi ut</p>
                                                                <div className="d-flex align-items-start">
                                                                    <div className="flex-grow-1">
