...
const UiAnimation = () => {
    document.title = "Animation | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                                            ...
                                            <Row>
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><FadeRightExample/></code></pre>
                                            ...
                                            <Row>
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><FadeUpRightExample/></code></pre>
                                                        <Row className="justify-content-center">
                                                            <Col sm={10} md={8}>
                                                ...
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><FadeUpLeftExample/></code></pre>
                                            ...
                                            <Row>
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><FadeDownRightExample/></code></pre>
                                                        <Row className="justify-content-center">
                                                            <Col sm={10} md={8}>
                                                ...
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><FadeDownLeftExample/></code></pre>
                                                        <Row className="justify-content-center">
                                                            <Col sm={10} md={8}>
                                            ...
                                            <Row>
                                                ...
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><FlipRightExample/></code></pre>
                                            ...
                                            <Row>
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><FilpUpExample/></code></pre>
                                            ...
                                            <Row>
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><ZoomInExample/></code></pre>
                                                    ...
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><ZoomInDownExample/></code></pre>
                                                    ...
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><ZoomInRightExample/></code></pre>
                                                    ...
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><ZoomInLeftExample/></code></pre>
                                                ...
                                                <Col lg={6}>
                                                    ...
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><ZoomOutUpExample/></code></pre>
                                                    ...
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><ZoomOutDownExample/></code></pre>
                                                    ...
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><ZoomOutRightExample/></code></pre>
                                                    ...
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><ZoomOutLeftExample/></code></pre>
                                            ...
                                            <Row>
                                                ...
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><EasingLinearExample/></code></pre>
                                            ...
                                            <Row>
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><EaseInBackExample/></code></pre>
                                                        <Row className="justify-content-center">
                                                            <Col sm={10} md={8}>
                                                ...
                                                <Col lg={6}>
                                                    <div className="p-4 pb-0 border mt-4">
                                                        ...
                                                        <pre><code
                                                            className="language-markup"><EaseOutCubicExample/></code></pre>
                                                        <Row className="justify-content-center">
                                                            <Col sm={10} md={8}>
                                                                <div data-aos="flip-left"
