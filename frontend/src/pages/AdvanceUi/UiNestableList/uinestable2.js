        ...
        return (
            <Col lg={6}>
                <Card>
                    ...
                    <CardBody>
                        <p className="text-muted">Use <code>nested-list nested-sortable-handle</code> class to
                            list-group class to set a nested list with sortable items.</p>

                        <ListGroup className="col nested-list nested-sortable-handle">
                            <ListGroupItem className="nested-1"><i
                                className="ri-drag-move-fill align-bottom handle"></i>Item 1.1
                                        ...
                                        {this.state.data.map((item, key) => (
                                            <React.Fragment key={key}>
                                                {!(item.set1) ? <ListGroupItem className={item.class}><i
                                                        className="ri-drag-move-fill align-bottom handle"></i>{item.title}
                                                    </ListGroupItem> :
