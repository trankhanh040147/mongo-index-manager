                    ...
                    <Card>
                        ...
                        <CardBody>
                            <p className="text-muted">Use <code>nested-list nested-sortable</code> class to list-group
                                class to set a nested list with sortable items where images are attached within a
                                list-group-item div element.</p>
                                                            ...
                                                            <ListGroupItem className="nested-3">
                                                                ...
                                                                <ListGroup className="nested-list nested-sortable">
                                                                    {item.set1.map((item, key) => (
                                                                        <ListGroupItem className="nested-4" key={key}>
                                                                            <div className="d-flex align-items-center">
                                                                                <div
