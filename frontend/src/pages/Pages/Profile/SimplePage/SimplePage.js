                                                        ...
                                                        <div className="table-responsive">
                                                            <Table className="table-borderless mb-0">
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td className="text-muted">daveadame@DRManager.com</td>
                                                                </tr>
                                                                <tr>
                                                            ...
                                                            <div className="d-flex align-items-center py-3">
                                                                ...
                                                                <div className="flex-shrink-0 ms-2">
                                                                    <button type="button"
                                                                        ...
                                                                        className="ri-user-add-line align-middle"></i>
                                                                    </button>
                                                                </div>
                                                            </div>
                                                            <div className="d-flex align-items-center py-3">
                                                ...
                                                <Card>
                                                    <CardBody>
                                                        <div className="d-flex align-items-center mb-4">
                                                            ...
                                                            <div className="flex-shrink-0">
                                                                <UncontrolledDropdown direction='start'>
                                                                    <DropdownToggle tag="a" id="dropdownMenuLink1"
                                                                                    role="button">
                                                                        <i className="ri-more-2-fill fs-14"></i>
                                                                    </DropdownToggle>
                                                                    <DropdownMenu>
                                                        ...
                                                        <div className="d-flex mb-4">
                                                            ...
                                                            <div className="flex-grow-1 ms-3 overflow-hidden">
                                                                <Link to="#">
                                                                    <h6 className="text-truncate fs-14">Design your apps
                                                                        in
                                                                        your own way</h6>
                                                                </Link>
                                                        ...
                                                        <div className="d-flex">
                                                            ...
                                                            <div className="flex-grow-1 ms-3 overflow-hidden">
                                                                <Link to="#">
                                                                    <h6 className="text-truncate fs-14">How to get
                                                                        creative
                                                                        in your work</h6>
                                                                </Link>
                                                            ...
                                                            <Col xs={6} md={4}>
                                                                <div className="d-flex mt-4">
                                                                    ...
                                                                    <div className="flex-grow-1 overflow-hidden">
                                                                        ...
                                                                        <Link to="#"
                                                                              className="fw-semibold">www.DRManager.com</Link>
                                                                    </div>
                                                                </div>
                                                            </Col>
                                                        </Row>
                                                    ...
                                                    <Col lg={12}>
                                                        <Card>
                                                            <CardHeader className="align-items-center d-flex">
                                                                <h4 className="card-title mb-0  me-2">Recent
                                                                    Activity</h4>
                                                    ...
                                                    <CardBody>
                                                        ...
                                                        >
                                                            ...
                                                            <div className="swiper-wrapper">
                                                                            ...
                                                                            <div className="d-flex">
                                                                                <div
                                                                                    ...
                                                                                    <p className="text-muted text-truncate mb-0">
                                                                                        Last Update : <span
                                                                                        className="fw-semibold text-body">4 hr Ago</span>
                                                                                    </p>
                                                                                </div>
                                                                                <div className="flex-shrink-0 ms-2">
                                                                                    <div
                                                                ...
                                                                <SwiperSlide>
                                                                    <Card
                                                                        className="profile-project-card shadow-none profile-project-warning mb-0">
                                                                        <CardBody className="p-4">
                                                                            <div className="d-flex">
                                                                                <div
                                                                                    className="flex-grow-1 text-muted overflow-hidden">
                                                ...
                                                <div className="acitivity-timeline">
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        <div className="flex-shrink-0 avatar-xs acitivity-avatar">
                                                            <div
                                                                className="avatar-title bg-success-subtle text-success rounded-circle"> N
                                                            </div>
                                                        </div>
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <div className="avatar-group mb-2">
                                                                ...
                                                                <Link to="#" className="avatar-group-item"
                                                                    ...
                                                                    <div className="avatar-xs">
                                                                        <div
                                                                            className="avatar-title rounded-circle bg-light text-primary">R
                                                                        </div>
                                                                    </div>
                                                                </Link>
                                                                <Link to="#" className="avatar-group-item"
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <Row>
                                                                <Col xxl={4}>
                                                                    <div
                                                                        className="row border border-dashed gx-2 p-2 mb-2">
                                                                        <div className="col-4">
                                                                            <img src={smallImage2}
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <p className="text-muted mb-2">added a new member to DRManager
                                                                dashboard</p>
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            <h6 className="mb-1">Your order is placed <span
                                                                ...
                                                                of Delivery</span></h6>
                                                            <p className="text-muted mb-2">These customers can rest
                                                                assured
                                                    ...
                                                    <div className="acitivity-item py-3 d-flex">
                                                        ...
                                                        <div className="flex-grow-1 ms-3">
                                                            ...
                                                            <p className="text-muted mb-2">They all have something to
                                                                say
                                                ...
                                                <div className="d-flex align-items-center mb-4">
                                                    ...
                                                    <div className="flex-shrink-0">
                                                        <Input className="form-control d-none" type="file"
                                                               id="formFile"/>
                                                        <Label htmlFor="formFile" className="btn btn-primary"><i
