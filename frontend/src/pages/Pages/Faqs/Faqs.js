...
const Faqs = () => {
    ...
    document.title = "FAQs | DRManager - React Admin & Dashboard Template";
                            ...
                            <Row className="justify-content-evenly">
                                ...
                                <Col lg={4}>
                                    <div className="mt-3">
                                        <div className="d-flex align-items-center mb-2">
                                            <div className="flex-shrink-0 me-1">
                                                <i className="ri-user-settings-line fs-24 align-middle text-info me-1"></i>
                                            </div>
                                            <div className="flex-grow-1">
                                ...
                                <Col lg={4}>
                                    <div className="mt-3">
                                        <div className="d-flex align-items-center mb-2">
                                            <div className="flex-shrink-0 me-1">
                                                <i className="ri-shield-keyhole-line fs-24 align-middle text-info me-1"></i>
                                            </div>
                                            <div className="flex-grow-1">
