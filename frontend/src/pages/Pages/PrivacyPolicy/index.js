...
const PrivacyPolicy = () => {
    document.title = "Privacy Policy | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                                ...
                                <div className="bg-primary-subtle position-relative">
                                    ...
                                    <div className="shape">
                                        <svg xmlns="http://www.w3.org/2000/svg" version="1.1"
                                             xmlnsXlink="http://www.w3.org/1999/xlink" width="1440" height="60"
                                ...
                                <CardBody className="p-4">
                                    <div className="d-flex">
                                        ...
                                        <div className="flex-grow-1">
                                            <h5>Privacy Policy for DRManager</h5>
