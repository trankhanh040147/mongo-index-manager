...
const SiteMap = () => {
    document.title = "SiteMap | DRManager - React Admin & Dashboard Template";
    return (
        <div>
                                            ...
                                            <ul className="administration">
                                                <li>
                                                    <ul className="director">
                                                        <li>
                                                            <Link to="#"
                                                                  className="fw-semibold"><span>DRManager Admin</span></Link>
                                ...
                                <CardBody>
                                    <div className="hori-sitemap">
                                        <ul className="list-unstyled mb-0">
                                            <li className="p-0 parent-title"><Link to="#" className="fw-semibold fs-14">My
                                                Account</Link></li>
                                    ...
                                    <Row>
                                            ...
                                            <div className="verti-sitemap">
                                                <ul className="list-unstyled mb-0">
                                                    <li className="p-0 parent-title"><Link to="#"
                                                                                           className="fw-medium fs-14">Nancy
                                                        Martino - Project Director</Link>
                                                    </li>
                                                    <li>
                                                        ...
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#" className="fw-medium text-primary">Mary
                                                                    Jones - Project Manager</Link>
                                                            </div>
                                                            <ul className="second-list list-unstyled">
                                                                <li><Link to="#">Jordyn Jones - Designer</Link></li>
                                                                <li><Link to="#">Ashlee Haney - Developer</Link></li>
                                                                <li><Link to="#">Rashad Charles - BackEnd
                                                                    Developer</Link></li>
                                                                <li><Link to="#">Walter Newman - Frontend
                                                                    Developer</Link>
                                                                </li>
                                                        ...
                                                        <div className="first-list">
                                                            ...
                                                            <ul className="second-list list-unstyled">
                                                                ...
                                                                <li>
                                                                    <Link to="#">Alicia Thompson - Sales
                                                                        Executive</Link>
                                                                    <ul className="third-list list-unstyled">
                                                                        <li><Link to="#">Jack Coates - Member</Link>
                                                                        </li>
                                                                        <li><Link to="#">Owen Jarvis - Member</Link>
                                                                        </li>
                                                                        <li><Link to="#">Ashlee Haney - Member</Link>
                                                                        </li>
                                                                        <li><Link to="#">Archie Cook - Member</Link>
                                                                        </li>
                                                                    </ul>
                                                                </li>
                                                            </ul>
                                        ...
                                        <Col sm={6}>
                                            <div className="verti-sitemap">
                                                <ul className="list-unstyled mb-0">
                                                    <li className="p-0 parent-title"><Link to="#"
                                                                                           className="fw-medium fs-14">DRManager</Link>
                                                    </li>
                                                    <li>
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#" className="fw-medium text-primary"><i
                                                                    className="ri-airplay-line me-1 align-bottom"></i>
                                                                    Dashboards</Link>
                                                            </div>
                                                            <ul className="second-list list-unstyled">
                                                                <li>
                                                        ...
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#" className="fw-medium text-primary"><i
                                                                    className="ri-pencil-ruler-2-line me-1 align-bottom"></i>
                                                                    App Pages</Link>
                                                            </div>
                                                            <ul className="second-list list-unstyled">
                                                        ...
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#" className="fw-medium text-primary"><i
                                                                    className="ri-file-list-3-line me-1 align-bottom"></i>
                                                                    Pages</Link>
                                                            </div>
                                                        </div>
                                                        <div className="first-list">
                                                            <div className="list-wrap">
                                                                <Link to="#" className="fw-medium text-primary"><i
                                                                    className="ri-stack-line me-1 align-bottom"></i>
                                                                    Components</Link>
                                                            </div>
                                                            <ul className="second-list list-unstyled">
                                                                <li>
