...
const Pricing = () => {
    ...
    document.title = "Pricing | DRManager - React Admin & Dashboard Template";
    return (
        <React.Fragment>
                    ...
                    <Row className="justify-content-center mt-4">
                        <Col lg={5}>
                            <div className="text-center mb-4">
                                ...
                                <p className="text-muted mb-4 fs-15">Simple pricing. No hidden fees. Advanced features
                                    for you business.</p>

                                <div className="d-inline-flex">
                                    <Nav className="nav-pills arrow-navtabs plan-nav rounded mb-3 p-1" id="pills-tab"
                                         role="tablist">
                                        <NavItem>
                                            <NavLink
                                                href="#"
                                ...
                                <Card className="pricing-box ribbon-box right">
                                    ...
                                    <CardBody className="bg-light m-2 p-4">
                                        <div className="d-flex align-items-center mb-3">
                                            ...
                                            <div className="ms-auto">
                                                <TabContent activeTab={activeTab}>
                                                    <TabPane tabId="1">
                                                        <h2 className="month mb-0">${price1.rate} <small
                                                            className="fs-13 text-muted">/Month</small></h2>
                                                    </TabPane>
                                                    <TabPane tabId="2">
                                                        <h2 className="annual mb-0"><small className="fs-16">
                                                            <del>${price1.delrateYear}</del>
                                                        </small> ${price1.rateYear} <small
                                                            className="fs-13 text-muted">/Year</small></h2>
                                                    </TabPane>
                                                </TabContent>
                                            </div>
                                        </div>
                                        ...
                                        <div className="mt-3 pt-2">
                                            <Link to="#"
                                                  className={`btn btn-${price1.planButtonClassname} ${price1.btnstatus} w-100`}>{price1.btntxt}</Link>
                                        </div>
                                    </CardBody>
                                </Card>
                            </Col>
                            ...
                            <Row>
                                {(pricing2 || []).map((price2, key) => (
                                    <Col lg={4} key={key}>
                                        <Card className="pricing-box ribbon-box right">
                                            {price2.ribbon === true ?
                                                <div className="ribbon-two ribbon-two-danger"><span>Popular</span>
                                                </div> : ""}
                                            <CardBody className="p-4 m-2">
                                                <div className="d-flex align-items-center">
                                                    ...
                                                    <div className="avatar-sm">
                                                        <div
                                                            className="avatar-title bg-light rounded-circle text-primary">
                                                            <i className={"fs-20 " + price2.icon}></i>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div className="pt-4">
                                                    <h2><sup><small>$ </small></sup>{price2.rate}<span
                                                        className="fs-13 text-muted">/Month</span></h2>
                                                </div>
                                                ...
                                                <div>
                                                    ...
                                                    <div className="mt-4">
                                                        <Link to="#"
                                                              className={`btn btn-${price2.planButtonClassname} w-100 waves-effect waves-light`}>{price2.btntxt}</Link>
                                                    </div>
                                                </div>
                                            </CardBody>
                                        </Card>
                                    ...
                                    <Row className="g-0">
                                        <Col lg={6}>
                                            <CardBody className="h-100">
                                                ...
                                                <div className="py-4">
                                                    <h2><sup><small>$</small></sup>{price3.rate}<span
                                                        className="fs-13 text-muted"> /Per month</span></h2>
                                                </div>

                                                <div className="text-center plan-btn mt-2">
                                                    <Link to="#"
                                                          className="btn btn-success w-sm waves-effect waves-light">Sign
                                                        up</Link>
                                                </div>
                                            </CardBody>
                                        </Col>
                                            ...
                                            <CardBody className="border-start mt-4 mt-lg-0">
                                                ...
                                                <CardBody className="pb-0">
                                                    <ul className="list-unstyled vstack gap-3 mb-0">
                                                        <li>Users: <span
                                                            className="text-success fw-semibold">{price3.users}</span>
                                                        </li>
                                                        <li>Storage: <span
                                                            className="text-success fw-semibold">{price3.storage} GB</span>
                                                        </li>
                                                        <li>Domain: <span
                                                            className="text-success fw-semibold">{price3.domain}</span>
                                                        </li>
                                                        <li>Support: <span
                                                            className="text-success fw-semibold">{price3.support}</span>
                                                        </li>
                                                    </ul>
                                                </CardBody>
                                            </CardBody>
